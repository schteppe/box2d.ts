...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var b2Math_1 = __webpack_require__(2);
	var b2Settings_1 = __webpack_require__(3);
	var Test_1 = __webpack_require__(4);
	var TestEntries_1 = __webpack_require__(53);
	var Main = (function () {
	    function Main() {
	        this.m_time_last = 0;
	        this.m_fps_time = 0;
	        ...
	        this.m_fps = 0;
	        this.m_fps_div = null;
	        this.m_debug_div = null;
	        this.m_settings = null;
	        this.m_test = null;
	        this.m_test_index = 0;
	        this.m_test_entries = null;
	        this.m_shift = 0;
	        this.m_ctrl = 0;
	        this.m_rMouseDown = false;
	        this.m_projection0 = null;
	        this.m_viewCenter0 = null;
	        this.m_demo_mode = false;
	        this.m_demo_time = 0;
	        this.m_max_demo_time = 1000 * 10;
	        this.m_canvas_div = null;
	        this.m_canvas = null;
	        this.m_ctx = null;
	        this.m_demo_button = null;
	        var that = this; // for callbacks
	        var fps_div = this.m_fps_div = document.body.appendChild(document.createElement('div'));
	        ...
	        var debug_div = this.m_debug_div = document.body.appendChild(document.createElement('div'));
	        ...
	        this.m_test_entries = TestEntries_1.GetTestEntries(new Array());
	        this.m_projection0 = new b2Math_1.b2Vec2();
	        this.m_viewCenter0 = new b2Math_1.b2Vec2();
	        ...
	        resize_main_div();
	        var title_div = main_div.appendChild(document.createElement('div'));
	        title_div.style.textAlign = 'center';
	        title_div.style.color = 'grey';
	        title_div.innerHTML = "Box2D Testbed version " + b2Settings_1.b2_version + " (revision " + b2Settings_1.b2_changelist + ")";
	        ...
	        var canvas = this.m_canvas = canvas_div.appendChild(document.createElement('canvas'));
	        ...
	        var controls_div = view_div.appendChild(document.createElement('div'));
	    ...
	    Main.prototype.ConvertViewportToElement = function (viewport, out) {
	    ...
	    Main.prototype.ConvertElementToViewport = function (element, out) {
	        // 0,0 at center of canvas, x right and y up
	        var rect = this.m_canvas_div.getBoundingClientRect();
	    ...
	    Main.prototype.ConvertProjectionToViewport = function (projection, out) {
	        var viewport = out.Copy(projection);
	        b2Math_1.b2MulSV(this.m_settings.viewZoom, viewport, viewport);
	        b2Math_1.b2MulSV(this.m_settings.canvasScale, viewport, viewport);
	        return viewport;
	    };
	    Main.prototype.ConvertViewportToProjection = function (viewport, out) {
	        var projection = out.Copy(viewport);
	        b2Math_1.b2MulSV(1 / this.m_settings.canvasScale, projection, projection);
	        b2Math_1.b2MulSV(1 / this.m_settings.viewZoom, projection, projection);
	        return projection;
	    };
	    Main.prototype.ConvertWorldToProjection = function (world, out) {
	        var projection = out.Copy(world);
	        b2Math_1.b2SubVV(projection, this.m_settings.viewCenter, projection);
	        b2Math_1.b2MulTRV(this.m_settings.viewRotation, projection, projection);
	        return projection;
	    };
	    Main.prototype.ConvertProjectionToWorld = function (projection, out) {
	        var world = out.Copy(projection);
	        b2Math_1.b2MulRV(this.m_settings.viewRotation, world, world);
	        b2Math_1.b2AddVV(this.m_settings.viewCenter, world, world);
	        return world;
	    };
	    Main.prototype.ConvertElementToWorld = function (element, out) {
	    ...
	    Main.prototype.ConvertElementToProjection = function (element, out) {
	        var viewport = this.ConvertElementToViewport(element, out);
	        return this.ConvertViewportToProjection(viewport, out);
	    };
	    Main.prototype.MoveCamera = function (move) {
	    ...
	    Main.prototype.RollCamera = function (roll) {
	        var angle = this.m_settings.viewRotation.GetAngleRadians();
	        this.m_settings.viewRotation.SetAngleRadians(angle + roll);
	    };
	    Main.prototype.ZoomCamera = function (zoom) {
	        this.m_settings.viewZoom *= zoom;
	        this.m_settings.viewZoom = b2Math_1.b2Clamp(this.m_settings.viewZoom, 0.02, 200);
	    };
	    Main.prototype.HomeCamera = function () {
	        this.m_settings.viewCenter.SetXY(0, 20);
	        this.m_settings.viewRotation.SetAngleRadians(b2Math_1.b2DegToRad(0));
	        this.m_settings.viewZoom = 1;
	    };
	    Main.prototype.HandleMouseMove = function (e) {
	        var element = new b2Math_1.b2Vec2(e.clientX, e.clientY);
	        var world = this.ConvertElementToWorld(element, new b2Math_1.b2Vec2());
	        this.m_test.MouseMove(world);
	        if (this.m_rMouseDown) {
	            // viewCenter = viewCenter0 - (projection - projection0);
	            var projection = this.ConvertElementToProjection(element, new b2Math_1.b2Vec2());
	            var diff = b2Math_1.b2SubVV(projection, this.m_projection0, new b2Math_1.b2Vec2());
	            var viewCenter = b2Math_1.b2SubVV(this.m_viewCenter0, diff, new b2Math_1.b2Vec2());
	    ...
	    Main.prototype.HandleTouchMove = function (e) {
	        var element = new b2Math_1.b2Vec2(e.touches[0].clientX, e.touches[0].clientY);
	        var world = this.ConvertElementToWorld(element, new b2Math_1.b2Vec2());
	        this.m_test.MouseMove(world);
	        e.preventDefault();
	    };
	    ...
	    Main.prototype.HandleMouseWheel = function (e) {
	        if (e.wheelDelta > 0) {
	            this.ZoomCamera(1.1);
	        }
	    ...
	    Main.prototype.HandleKeyDown = function (e) {
	        switch (e.keyCode) {
	            case Test_1.KeyCode.CTRL:
	                this.m_ctrl = 1;
	                break;
	            case Test_1.KeyCode.SHIFT:
	                this.m_shift = 1;
	                break;
	            case Test_1.KeyCode.LEFT:
	                if (this.m_ctrl) {
	                    if (this.m_test) {
	                        this.m_test.ShiftOrigin(new b2Math_1.b2Vec2(2, 0));
	                    }
	                }
	                else {
	                    this.MoveCamera(new b2Math_1.b2Vec2(-0.5, 0));
	                }
	                break;
	            case Test_1.KeyCode.RIGHT:
	                if (this.m_ctrl) {
	                    if (this.m_test) {
	                        this.m_test.ShiftOrigin(new b2Math_1.b2Vec2(-2, 0));
	                    }
	                ...
	                break;
	            case Test_1.KeyCode.DOWN:
	                if (this.m_ctrl) {
	                    if (this.m_test) {
	                        this.m_test.ShiftOrigin(new b2Math_1.b2Vec2(0, 2));
	                    }
	                }
	                else {
	                    this.MoveCamera(new b2Math_1.b2Vec2(0, -0.5));
	                }
	                break;
	            case Test_1.KeyCode.UP:
	                if (this.m_ctrl) {
	                    if (this.m_test) {
	                        this.m_test.ShiftOrigin(new b2Math_1.b2Vec2(0, -2));
	                    }
	                ...
	                break;
	            case Test_1.KeyCode.PAGE_DOWN:
	                this.RollCamera(b2Math_1.b2DegToRad(-1));
	                break;
	            case Test_1.KeyCode.PAGE_UP:
	                this.RollCamera(b2Math_1.b2DegToRad(1));
	                break;
	            case Test_1.KeyCode.Z:
	                this.ZoomCamera(1.1);
	                break;
	            case Test_1.KeyCode.X:
	                this.ZoomCamera(1 / 1.1);
	                break;
	            case Test_1.KeyCode.HOME:
	                this.HomeCamera();
	                break;
	            case Test_1.KeyCode.R:
	                this.LoadTest();
	                break;
	            case Test_1.KeyCode.SPACE:
	                if (this.m_test) {
	                    this.m_test.LaunchBomb();
	                }
	                break;
	            case Test_1.KeyCode.P:
	                this.Pause();
	                break;
	            case Test_1.KeyCode.PERIOD:
	                this.SingleStep();
	                break;
	            case Test_1.KeyCode.OPEN_SQUARE_BRACKET:
	                this.DecrementTest();
	                break;
	            case Test_1.KeyCode.CLOSE_SQUARE_BRACKET:
	                this.IncrementTest();
	                break;
	            default:
	    ...
	    Main.prototype.UpdateTest = function (time_elapsed) {
	        if (this.m_demo_mode) {
	    ...
	    Main.prototype.DecrementTest = function () {
	    ...
	    Main.prototype.IncrementTest = function () {
	        this.m_test_index++;
	    ...
	    Main.prototype.SingleStep = function () {
	        this.m_settings.pause = true;
	        this.m_settings.singleStep = true;
	    };
	    Main.prototype.ToggleDemo = function () {
	        this.m_demo_mode = !this.m_demo_mode;
	    };
	    Main.prototype.SimulationLoop = function () {
	        ...
	        if (time_elapsed > 0) {
	            ...
	            this.m_settings.hz = b2Math_1.b2Max(1000 / time_elapsed, hz);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	function b2Swap(a, b) {
	    if (b2Settings_1.ENABLE_ASSERTS) {
	...
	exports.b2AbsV = b2AbsV;
	function b2MinV(a, b, out) {
	    out.x = b2Min(a.x, b.x);
	    out.y = b2Min(a.y, b.y);
	    return out;
	}
	exports.b2MinV = b2MinV;
	function b2MaxV(a, b, out) {
	    out.x = b2Max(a.x, b.x);
	    out.y = b2Max(a.y, b.y);
	    return out;
	}
	exports.b2MaxV = b2MaxV;
	function b2ClampV(v, lo, hi, out) {
	    out.x = b2Clamp(v.x, lo.x, hi.x);
	    out.y = b2Clamp(v.y, lo.y, hi.y);
	    return out;
	}
	exports.b2ClampV = b2ClampV;
	...
	exports.b2RotateV = b2RotateV;
	function b2DotVV(a, b) {
	    return a.x * b.x + a.y * b.y;
	}
	exports.b2DotVV = b2DotVV;
	function b2CrossVV(a, b) {
	    return a.x * b.y - a.y * b.x;
	}
	exports.b2CrossVV = b2CrossVV;
	...
	exports.b2CrossVOne = b2CrossVOne;
	...
	exports.b2CrossV3V3 = b2CrossV3V3;
	...
	exports.b2MulM33XYZ = b2MulM33XYZ;
	...
	exports.b2MulM33V2 = b2MulM33V2;
	function b2MulM33XY(A, x, y, out) {
	    out.x = A.ex.x * x + A.ey.x * y;
	    out.y = A.ex.y * x + A.ey.y * y;
	    return out;
	}
	exports.b2MulM33XY = b2MulM33XY;
	/// Rotation
	var b2Rot = (function () {
	...
	var b2Sweep = (function () {
	    ...
	    b2Sweep.prototype.Advance = function (alpha) {
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(this.alpha0 < 1);
	        }
...
/***/ function(module, exports) {
	...
	*/
	"use strict";
	exports.DEBUG = true;
	exports.ENABLE_ASSERTS = exports.DEBUG;
	...
	/// Current version.
	exports.b2_version = new b2Version(2, 3, 0);
	exports.b2_changelist = 251;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var b2Math_1 = __webpack_require__(2);
	var b2Settings_1 = __webpack_require__(3);
	var b2Draw_1 = __webpack_require__(5);
	var b2WorldCallbacks_1 = __webpack_require__(6);
	var b2MouseJoint_1 = __webpack_require__(7);
	var b2Fixture_1 = __webpack_require__(9);
	var b2World_1 = __webpack_require__(13);
	var b2Body_1 = __webpack_require__(29);
	var b2TimeStep_1 = __webpack_require__(31);
	var b2Collision_1 = __webpack_require__(10);
	var b2CircleShape_1 = __webpack_require__(39);
	var Render_1 = __webpack_require__(52);
	exports.DRAW_STRING_NEW_LINE = 25;
	(function (KeyCode) {
	...
	var Settings = (function () {
	    function Settings() {
	        this.canvasScale = 10;
	        this.viewZoom = 1;
	        this.viewCenter = new b2Math_1.b2Vec2(0, 20);
	        this.viewRotation = new b2Math_1.b2Rot(b2Math_1.b2DegToRad(0));
	        this.hz = 60;
	...
	var TestEntry = (function () {
	    function TestEntry(name, createFcn) {
	        this.name = "unknown";
	        this.createFcn = function (canvas, settings) { return null; };
	        this.name = name;
	...
	}(b2WorldCallbacks_1.b2DestructionListener));
	...
	var ContactPoint = (function () {
	    function ContactPoint() {
	        ...
	        this.state = b2Collision_1.b2PointState.b2_nullState;
	...
	var Test = (function (_super) {
	    ...
	    function Test(canvas, settings) {
	        ...
	        this.m_bombSpawnPoint = null;
	        this.m_bombSpawning = false;
	        this.m_mouseWorld = null;
	        this.m_stepCount = 0;
	        this.m_maxProfile = null;
	        this.m_totalProfile = null;
	        this.m_groundBody = null;
	        var gravity = new b2Math_1.b2Vec2(0, -10);
	        this.m_world = new b2World_1.b2World(gravity);
	        this.m_bomb = null;
	        this.m_textLine = 30;
	        this.m_mouseJoint = null;
	        this.m_points = new Array(Test.k_maxContactPoints);
	        for (var i = 0; i < Test.k_maxContactPoints; ++i) {
	        ...
	        this.m_debugDraw = new Render_1.DebugDraw(canvas, settings);
	        this.m_world.SetDebugDraw(this.m_debugDraw);
	        this.m_bombSpawnPoint = new b2Math_1.b2Vec2();
	        this.m_bombSpawning = false;
	        this.m_mouseWorld = new b2Math_1.b2Vec2();
	        this.m_stepCount = 0;
	        this.m_maxProfile = new b2TimeStep_1.b2Profile();
	        this.m_totalProfile = new b2TimeStep_1.b2Profile();
	        var bodyDef = new b2Body_1.b2BodyDef();
	    ...
	    Test.prototype.PreSolve = function (contact, oldManifold) {
	        ...
	        b2Collision_1.b2GetPointStates(state1, state2, oldManifold, manifold);
	    ...
	    Test.prototype.DrawTitle = function (title) {
	        this.m_debugDraw.DrawString(5, exports.DRAW_STRING_NEW_LINE, title);
	        this.m_textLine = 2 * exports.DRAW_STRING_NEW_LINE;
	    };
	    Test.prototype.MouseDown = function (p) {
	        ...
	        // Make a small box.
	        var aabb = new b2Collision_1.b2AABB();
	        var d = new b2Math_1.b2Vec2();
	        d.SetXY(0.001, 0.001);
	        b2Math_1.b2SubVV(p, d, aabb.lowerBound);
	        b2Math_1.b2AddVV(p, d, aabb.upperBound);
	        var that = this;
	        var hit_fixture = null;
	        // Query the world for overlapping shapes.
	        var callback = function (fixture) {
	            var body = fixture.GetBody();
	            if (body.GetType() == b2Body_1.b2BodyType.b2_dynamicBody) {
	        ...
	        if (hit_fixture) {
	            ...
	            var md = new b2MouseJoint_1.b2MouseJointDef();
	    ...
	    Test.prototype.CompleteBombSpawn = function (p) {
	        ...
	        var multiplier = 30;
	        var vel = b2Math_1.b2SubVV(this.m_bombSpawnPoint, p, new b2Math_1.b2Vec2());
	    ...
	    Test.prototype.LaunchBomb = function () {
	        var p = new b2Math_1.b2Vec2(b2Math_1.b2RandomRange(-15, 15), 30);
	        var v = b2Math_1.b2MulSV(-5, p, new b2Math_1.b2Vec2());
	    ...
	    Test.prototype.LaunchBombAt = function (position, velocity) {
	        ...
	        var bd = new b2Body_1.b2BodyDef();
	        bd.type = b2Body_1.b2BodyType.b2_dynamicBody;
	        bd.position.Copy(position);
	        bd.bullet = true;
	        this.m_bomb = this.m_world.CreateBody(bd);
	        this.m_bomb.SetLinearVelocity(velocity);
	        var circle = new b2CircleShape_1.b2CircleShape();
	        circle.m_radius = 0.3;
	        var fd = new b2Fixture_1.b2FixtureDef();
	        fd.shape = circle;
	        fd.density = 20;
	        fd.restitution = 0;
	    ...
	    Test.prototype.Step = function (settings) {
	        ...
	        var flags = b2Draw_1.b2DrawFlags.e_none;
	        if (settings.drawShapes) {
	            flags |= b2Draw_1.b2DrawFlags.e_shapeBit;
	        }
	        if (settings.drawJoints) {
	            flags |= b2Draw_1.b2DrawFlags.e_jointBit;
	        }
	        if (settings.drawAABBs) {
	            flags |= b2Draw_1.b2DrawFlags.e_aabbBit;
	        }
	        if (settings.drawCOMs) {
	            flags |= b2Draw_1.b2DrawFlags.e_centerOfMassBit;
	        }
	        if (settings.drawControllers) {
	            flags |= b2Draw_1.b2DrawFlags.e_controllerBit;
	        }
	        ...
	        if (true) {
	            ...
	            this.m_maxProfile.step = b2Math_1.b2Max(this.m_maxProfile.step, p.step);
	            this.m_maxProfile.collide = b2Math_1.b2Max(this.m_maxProfile.collide, p.collide);
	            this.m_maxProfile.solve = b2Math_1.b2Max(this.m_maxProfile.solve, p.solve);
	            this.m_maxProfile.solveInit = b2Math_1.b2Max(this.m_maxProfile.solveInit, p.solveInit);
	            this.m_maxProfile.solveVelocity = b2Math_1.b2Max(this.m_maxProfile.solveVelocity, p.solveVelocity);
	            this.m_maxProfile.solvePosition = b2Math_1.b2Max(this.m_maxProfile.solvePosition, p.solvePosition);
	            this.m_maxProfile.solveTOI = b2Math_1.b2Max(this.m_maxProfile.solveTOI, p.solveTOI);
	            this.m_maxProfile.broadphase = b2Math_1.b2Max(this.m_maxProfile.broadphase, p.broadphase);
	        ...
	        if (settings.drawProfile) {
	            var p = this.m_world.GetProfile();
	            var aveProfile = new b2TimeStep_1.b2Profile();
	        ...
	        if (this.m_mouseJoint) {
	            var p1 = this.m_mouseJoint.GetAnchorB(new b2Math_1.b2Vec2());
	            var p2 = this.m_mouseJoint.GetTarget();
	            var c = new b2Draw_1.b2Color(0, 1, 0);
	        ...
	        if (this.m_bombSpawning) {
	            var c = new b2Draw_1.b2Color(0, 0, 1);
	        ...
	        if (settings.drawContactPoints) {
	            ...
	            for (var i = 0; i < this.m_pointCount; ++i) {
	                ...
	                if (point.state == b2Collision_1.b2PointState.b2_addState) {
	                    // Add
	                    this.m_debugDraw.DrawPoint(point.position, 10, new b2Draw_1.b2Color(0.3, 0.95, 0.3));
	                }
	                else if (point.state == b2Collision_1.b2PointState.b2_persistState) {
	                    // Persist
	                    this.m_debugDraw.DrawPoint(point.position, 5, new b2Draw_1.b2Color(0.3, 0.3, 0.95));
	                }
	                if (settings.drawContactNormals) {
	                    var p1 = point.position;
	                    var p2 = b2Math_1.b2AddVV(p1, b2Math_1.b2MulSV(k_axisScale, point.normal, b2Math_1.b2Vec2.s_t0), new b2Math_1.b2Vec2());
	                    this.m_debugDraw.DrawSegment(p1, p2, new b2Draw_1.b2Color(0.9, 0.9, 0.9));
	                }
	                else if (settings.drawContactImpulse) {
	                    var p1 = point.position;
	                    var p2 = b2Math_1.b2AddVMulSV(p1, k_impulseScale * point.normalImpulse, point.normal, new b2Math_1.b2Vec2());
	                    this.m_debugDraw.DrawSegment(p1, p2, new b2Draw_1.b2Color(0.9, 0.9, 0.3));
	                }
	                if (settings.drawFrictionImpulse) {
	                    var tangent = b2Math_1.b2CrossVOne(point.normal, new b2Math_1.b2Vec2());
	                    var p1 = point.position;
	                    var p2 = b2Math_1.b2AddVMulSV(p1, k_impulseScale * point.tangentImpulse, tangent, new b2Math_1.b2Vec2());
	                    this.m_debugDraw.DrawSegment(p1, p2, new b2Draw_1.b2Color(0.9, 0.9, 0.3));
	                }
	            }
	        }
	    };
	    Test.prototype.ShiftOrigin = function (newOrigin) {
	        this.m_world.ShiftOrigin(newOrigin);
	    };
	    Test.k_maxContactPoints = 2048;
	    Test.PreSolve_s_state1 = new Array(b2Settings_1.b2_maxManifoldPoints);
	    Test.PreSolve_s_state2 = new Array(b2Settings_1.b2_maxManifoldPoints);
	    Test.PreSolve_s_worldManifold = new b2Collision_1.b2WorldManifold();
	    return Test;
	}(b2WorldCallbacks_1.b2ContactListener));
	exports.Test = Test;
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var b2DrawFlags = exports.b2DrawFlags;
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var b2Math_1 = __webpack_require__(2);
	var b2Settings_1 = __webpack_require__(3);
	var b2Joint_1 = __webpack_require__(8);
	/// Mouse joint definition. This requires a world target point,
	/// tuning parameters, and the time step.
	var b2MouseJointDef = (function (_super) {
	    __extends(b2MouseJointDef, _super);
	    function b2MouseJointDef() {
	        _super.call(this, b2Joint_1.b2JointType.e_mouseJoint); // base class constructor
	...
	var b2MouseJoint = (function (_super) {
	    ...
	    function b2MouseJoint(def) {
	        ...
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(def.target.IsValid());
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(b2Math_1.b2IsValid(def.maxForce) && def.maxForce >= 0);
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(b2Math_1.b2IsValid(def.frequencyHz) && def.frequencyHz >= 0);
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(b2Math_1.b2IsValid(def.dampingRatio) && def.dampingRatio >= 0);
	        }
	        this.m_targetA.Copy(def.target);
	        b2Math_1.b2MulTXV(this.m_bodyB.GetTransform(), this.m_targetA, this.m_localAnchorB);
	    ...
	    b2MouseJoint.prototype.InitVelocityConstraints = function (data) {
	        ...
	        var h = data.step.dt;
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(d + h * k > b2Settings_1.b2_epsilon);
	        }
	        ...
	        b2Math_1.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
	        b2Math_1.b2MulRV(qB, this.m_lalcB, this.m_rB);
	        ...
	        if (data.step.warmStarting) {
	            ...
	            wB += this.m_invIB * b2Math_1.b2CrossVV(this.m_rB, this.m_impulse);
	        }
	        else {
	            this.m_impulse.SetZero();
	        }
	    ...
	    b2MouseJoint.prototype.SolveVelocityConstraints = function (data) {
	        ...
	        var Cdot = b2Math_1.b2AddVCrossSV(vB, wB, this.m_rB, b2MouseJoint.SolveVelocityConstraints_s_Cdot);
	        //b2Vec2 impulse = b2Mul(m_mass, -(Cdot + m_C + m_gamma * m_impulse));
	        var impulse = b2Math_1.b2MulMV(this.m_mass, b2Math_1.b2AddVV(Cdot, b2Math_1.b2AddVV(this.m_C, b2Math_1.b2MulSV(this.m_gamma, this.m_impulse, b2Math_1.b2Vec2.s_t0), b2Math_1.b2Vec2.s_t0), b2Math_1.b2Vec2.s_t0).SelfNeg(), b2MouseJoint.SolveVelocityConstraints_s_impulse);
	        ...
	        b2Math_1.b2SubVV(this.m_impulse, oldImpulse, impulse);
	        //vB += m_invMassB * impulse;
	        vB.SelfMulAdd(this.m_invMassB, impulse);
	        wB += this.m_invIB * b2Math_1.b2CrossVV(this.m_rB, impulse);
	        //data.velocities[this.m_indexB].v = vB;
	        data.velocities[this.m_indexB].w = wB;
	    };
	    ...
	    b2MouseJoint.prototype.GetReactionForce = function (inv_dt, out) {
	        return b2Math_1.b2MulSV(inv_dt, this.m_impulse, out);
	    };
	    b2MouseJoint.prototype.GetReactionTorque = function (inv_dt) {
	        return 0;
	    };
	    b2MouseJoint.prototype.Dump = function () {
	        if (b2Settings_1.DEBUG) {
	            b2Settings_1.b2Log("Mouse joint dumping is not supported.\n");
	        }
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var b2JointType = exports.b2JointType;
	...
	var b2LimitState = exports.b2LimitState;
	...
	var b2Joint = (function () {
	    function b2Joint(def) {
	        ...
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(def.bodyA != def.bodyB);
	        }
	    ...
	    b2Joint.prototype.Dump = function () {
	        if (b2Settings_1.DEBUG) {
	            b2Settings_1.b2Log("// Dump is not supported for this joint type.\n");
	        }
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var b2Settings_1 = __webpack_require__(3);
	var b2Collision_1 = __webpack_require__(10);
	var b2Shape_1 = __webpack_require__(12);
	var b2Math_1 = __webpack_require__(2);
	...
	var b2Fixture = (function () {
	    ...
	    b2Fixture.prototype.GetAABB = function (childIndex) {
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(0 <= childIndex && childIndex < this.m_proxyCount);
	        }
	    ...
	    b2Fixture.prototype.Dump = function (bodyIndex) {
	        if (b2Settings_1.DEBUG) {
	            b2Settings_1.b2Log("    var fd: b2FixtureDef = new b2FixtureDef();\n");
	            b2Settings_1.b2Log("    fd.friction = %.15f;\n", this.m_friction);
	            b2Settings_1.b2Log("    fd.restitution = %.15f;\n", this.m_restitution);
	            b2Settings_1.b2Log("    fd.density = %.15f;\n", this.m_density);
	            b2Settings_1.b2Log("    fd.isSensor = %s;\n", (this.m_isSensor) ? ('true') : ('false'));
	            b2Settings_1.b2Log("    fd.filter.categoryBits = %d;\n", this.m_filter.categoryBits);
	            b2Settings_1.b2Log("    fd.filter.maskBits = %d;\n", this.m_filter.maskBits);
	            b2Settings_1.b2Log("    fd.filter.groupIndex = %d;\n", this.m_filter.groupIndex);
	            this.m_shape.Dump();
	            //			switch (this.m_shape.m_type)
	            //			{
	            //			case b2ShapeType.e_circleShape:
	            //				{
	            //					var circle: b2CircleShape = <b2CircleShape> this.m_shape;
	            //					b2Log("    var shape: b2CircleShape = new b2CircleShape();\n");
	            ...
	            //					for (var i: number = 0; i < polygon.m_count; ++i)
	            //					{
	            ...
	            //					b2Log("    var shape: b2ChainShape = new b2ChainShape();\n");
	            //					b2Log("    var vs: b2Vec2[] = b2Vec2.MakeArray(%d);\n", b2_maxPolygonVertices);
	            //					for (var i: number = 0; i < chain.m_count; ++i)
	            //					{
	            ...
	            //			}
	            b2Settings_1.b2Log("\n");
	            b2Settings_1.b2Log("    fd.shape = shape;\n");
	            b2Settings_1.b2Log("\n");
	            b2Settings_1.b2Log("    bodies[%d].CreateFixture(fd);\n", bodyIndex);
	        }
	    };
	    ...
	    b2Fixture.prototype.Destroy = function () {
	        ...
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(this.m_proxyCount == 0);
	        }
	    ...
	    b2Fixture.prototype.Synchronize = function (broadPhase, transform1, transform2) {
	        ...
	        for (var i = 0; i < this.m_proxyCount; ++i) {
	            ...
	            var displacement = b2Math_1.b2SubVV(transform2.p, transform1.p, b2Fixture.Synchronize_s_displacement);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var b2Settings_1 = __webpack_require__(3);
	var b2Math_1 = __webpack_require__(2);
	var b2Distance_1 = __webpack_require__(11);
	/// @file
	...
	var b2ContactFeatureType = exports.b2ContactFeatureType;
	...
	var b2ManifoldType = exports.b2ManifoldType;
	...
	var b2Manifold = (function () {
	    ...
	    b2Manifold.prototype.Reset = function () {
	        for (var i = 0, ict = b2Settings_1.b2_maxManifoldPoints; i < ict; ++i) {
	            if (b2Settings_1.ENABLE_ASSERTS) {
	                b2Settings_1.b2Assert(this.points[i] instanceof b2ManifoldPoint);
	            }
	            this.points[i].Reset();
	        }
	            ...
	            case b2ManifoldType.e_circles:
	                {
	                    ...
	                    var pointA = b2Math_1.b2MulXV(xfA, manifold.localPoint, b2WorldManifold.Initialize_s_pointA);
	                    var pointB = b2Math_1.b2MulXV(xfB, manifold.points[0].localPoint, b2WorldManifold.Initialize_s_pointB);
	                    if (b2Math_1.b2DistanceSquaredVV(pointA, pointB) > b2Settings_1.b2_epsilon_sq) {
	                        b2Math_1.b2SubVV(pointB, pointA, this.normal).SelfNormalize();
	                    }
	                    var cA = b2Math_1.b2AddVMulSV(pointA, radiusA, this.normal, b2WorldManifold.Initialize_s_cA);
	                    var cB = b2Math_1.b2SubVMulSV(pointB, radiusB, this.normal, b2WorldManifold.Initialize_s_cB);
	                    b2Math_1.b2MidVV(cA, cB, this.points[0]);
	                }
	                break;
	            case b2ManifoldType.e_faceA:
	                {
	                    b2Math_1.b2MulRV(xfA.q, manifold.localNormal, this.normal);
	                    var planePoint = b2Math_1.b2MulXV(xfA, manifold.localPoint, b2WorldManifold.Initialize_s_planePoint);
	                    for (var i = 0, ict = manifold.pointCount; i < ict; ++i) {
	                        var clipPoint = b2Math_1.b2MulXV(xfB, manifold.points[i].localPoint, b2WorldManifold.Initialize_s_clipPoint);
	                        var s = radiusA - b2Math_1.b2DotVV(b2Math_1.b2SubVV(clipPoint, planePoint, b2Math_1.b2Vec2.s_t0), this.normal);
	                        var cA = b2Math_1.b2AddVMulSV(clipPoint, s, this.normal, b2WorldManifold.Initialize_s_cA);
	                        var cB = b2Math_1.b2SubVMulSV(clipPoint, radiusB, this.normal, b2WorldManifold.Initialize_s_cB);
	                        b2Math_1.b2MidVV(cA, cB, this.points[i]);
	                    }
	                }
	                break;
	            case b2ManifoldType.e_faceB:
	                {
	                    b2Math_1.b2MulRV(xfB.q, manifold.localNormal, this.normal);
	                    var planePoint = b2Math_1.b2MulXV(xfB, manifold.localPoint, b2WorldManifold.Initialize_s_planePoint);
	                    for (var i = 0, ict = manifold.pointCount; i < ict; ++i) {
	                        var clipPoint = b2Math_1.b2MulXV(xfA, manifold.points[i].localPoint, b2WorldManifold.Initialize_s_clipPoint);
	                        var s = radiusB - b2Math_1.b2DotVV(b2Math_1.b2SubVV(clipPoint, planePoint, b2Math_1.b2Vec2.s_t0), this.normal);
	                        var cB = b2Math_1.b2AddVMulSV(clipPoint, s, this.normal, b2WorldManifold.Initialize_s_cB);
	                        var cA = b2Math_1.b2SubVMulSV(clipPoint, radiusA, this.normal, b2WorldManifold.Initialize_s_cA);
	                        b2Math_1.b2MidVV(cA, cB, this.points[i]);
	                    }
	...
	var b2PointState = exports.b2PointState;
	...
	function b2GetPointStates(state1, state2, manifold1, manifold2) {
	    ...
	    for (var ict = b2Settings_1.b2_maxManifoldPoints; i < ict; ++i) {
	...
	var b2AABB = (function () {
	    ...
	    b2AABB.prototype.GetCenter = function () {
	        return b2Math_1.b2MidVV(this.lowerBound, this.upperBound, this.m_cache_center);
	    };
	    /// Get the extents of the AABB (half-widths).
	    b2AABB.prototype.GetExtents = function () {
	        return b2Math_1.b2ExtVV(this.lowerBound, this.upperBound, this.m_cache_extent);
	    };
	...
	function b2ClipSegmentToLine(vOut, vIn, normal, offset, vertexIndexA) {
	    ...
	    var distance0 = b2Math_1.b2DotVV(normal, vIn0.v) - offset;
	    var distance1 = b2Math_1.b2DotVV(normal, vIn1.v) - offset;
	...
	*/
	...
	var b2DistanceProxy = (function () {
	    ...
	    b2DistanceProxy.prototype.GetSupport = function (d) {
	        var bestIndex = 0;
	        var bestValue = b2Math_1.b2DotVV(this.m_vertices[0], d);
	        for (var i = 1; i < this.m_count; ++i) {
	            var value = b2Math_1.b2DotVV(this.m_vertices[i], d);
	            if (value > bestValue) {
	                bestIndex = i;
	                bestValue = value;
	            }
	    ...
	    b2DistanceProxy.prototype.GetVertex = function (index) {
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(0 <= index && index < this.m_count);
	        }
	...
	var b2SimplexCache = (function () {
	    function b2SimplexCache() {
	        this.metric = 0;
	        this.count = 0;
	        this.indexA = b2Settings_1.b2MakeNumberArray(3);
	        this.indexB = b2Settings_1.b2MakeNumberArray(3);
	    }
	...
	var b2Simplex = (function () {
	    ...
	    b2Simplex.prototype.ReadCache = function (cache, proxyA, transformA, proxyB, transformB) {
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(0 <= cache.count && cache.count <= 3);
	        }
	        ...
	        for (var i = 0; i < this.m_count; ++i) {
	            ...
	            b2Math_1.b2MulXV(transformA, wALocal, v.wA);
	            b2Math_1.b2MulXV(transformB, wBLocal, v.wB);
	            b2Math_1.b2SubVV(v.wB, v.wA, v.w);
	            v.a = 0;
	        }
	    ...
	    b2Simplex.prototype.GetSearchDirection = function (out) {
	        switch (this.m_count) {
	            case 1:
	                return b2Math_1.b2NegV(this.m_v1.w, out);
	            case 2:
	                {
	                    var e12 = b2Math_1.b2SubVV(this.m_v2.w, this.m_v1.w, out);
	                    var sgn = b2Math_1.b2CrossVV(e12, b2Math_1.b2NegV(this.m_v1.w, b2Math_1.b2Vec2.s_t0));
	                    if (sgn > 0) {
	                        // Origin is left of e12.
	                        return b2Math_1.b2CrossOneV(e12, out);
	                    }
	                    else {
	                        // Origin is right of e12.
	                        return b2Math_1.b2CrossVOne(e12, out);
	                    }
	                }
	            default:
	                if (b2Settings_1.ENABLE_ASSERTS) {
	    ...
	    b2Simplex.prototype.GetMetric = function () {
	        switch (this.m_count) {
	            ...
	            case 1:
	                return 0;
	            case 2:
	                return b2Math_1.b2DistanceVV(this.m_v1.w, this.m_v2.w);
	            case 3:
	                return b2Math_1.b2CrossVV(b2Math_1.b2SubVV(this.m_v2.w, this.m_v1.w, b2Math_1.b2Vec2.s_t0), b2Math_1.b2SubVV(this.m_v3.w, this.m_v1.w, b2Math_1.b2Vec2.s_t1));
	            default:
	                if (b2Settings_1.ENABLE_ASSERTS) {
	                    b2Settings_1.b2Assert(false);
	                }
	    ...
	    b2Simplex.prototype.Solve2 = function () {
	        var w1 = this.m_v1.w;
	        var w2 = this.m_v2.w;
	        var e12 = b2Math_1.b2SubVV(w2, w1, b2Simplex.s_e12);
	        // w1 region
	        var d12_2 = (-b2Math_1.b2DotVV(w1, e12));
	        if (d12_2 <= 0) {
	        ...
	        // w2 region
	        var d12_1 = b2Math_1.b2DotVV(w2, e12);
	        if (d12_1 <= 0) {
	    ...
	    b2Simplex.prototype.Solve3 = function () {
	        ...
	        // a3 = 0
	        var e12 = b2Math_1.b2SubVV(w2, w1, b2Simplex.s_e12);
	        var w1e12 = b2Math_1.b2DotVV(w1, e12);
	        var w2e12 = b2Math_1.b2DotVV(w2, e12);
	        var d12_1 = w2e12;
	        var d12_2 = (-w1e12);
	        // Edge13
	        // [1      1     ][a1] = [1]
	        // [w1.e13 w3.e13][a3] = [0]
	        // a2 = 0
	        var e13 = b2Math_1.b2SubVV(w3, w1, b2Simplex.s_e13);
	        var w1e13 = b2Math_1.b2DotVV(w1, e13);
	        var w3e13 = b2Math_1.b2DotVV(w3, e13);
	        var d13_1 = w3e13;
	        var d13_2 = (-w1e13);
	        // Edge23
	        // [1      1     ][a2] = [1]
	        // [w2.e23 w3.e23][a3] = [0]
	        // a1 = 0
	        var e23 = b2Math_1.b2SubVV(w3, w2, b2Simplex.s_e23);
	        var w2e23 = b2Math_1.b2DotVV(w2, e23);
	        var w3e23 = b2Math_1.b2DotVV(w3, e23);
	        var d23_1 = w3e23;
	        var d23_2 = (-w2e23);
	        // Triangle123
	        var n123 = b2Math_1.b2CrossVV(e12, e13);
	        var d123_1 = n123 * b2Math_1.b2CrossVV(w2, w3);
	        var d123_2 = n123 * b2Math_1.b2CrossVV(w3, w1);
	        var d123_3 = n123 * b2Math_1.b2CrossVV(w1, w2);
	        // w1 region
	        if (d12_2 <= 0 && d13_2 <= 0) {
	            this.m_v1.a = 1;
	            this.m_count = 1;
	...
	var b2Distance_s_saveA = b2Settings_1.b2MakeNumberArray(3);
	var b2Distance_s_saveB = b2Settings_1.b2MakeNumberArray(3);
	...
	function b2Distance(output, cache, input) {
	    ...
	    while (iter < k_maxIters) {
	        ...
	        */
	        ...
	        if (d.GetLengthSquared() < b2Settings_1.b2_epsilon_sq) {
	        ...
	        vertex.indexA = proxyA.GetSupport(b2Math_1.b2MulTRV(transformA.q, b2Math_1.b2NegV(d, b2Math_1.b2Vec2.s_t0), b2Distance_s_supportA));
	        b2Math_1.b2MulXV(transformA, proxyA.GetVertex(vertex.indexA), vertex.wA);
	        vertex.indexB = proxyB.GetSupport(b2Math_1.b2MulTRV(transformB.q, d, b2Distance_s_supportB));
	        b2Math_1.b2MulXV(transformB, proxyB.GetVertex(vertex.indexB), vertex.wB);
	        b2Math_1.b2SubVV(vertex.wB, vertex.wA, vertex.w);
	    ...
	    output.distance = b2Math_1.b2DistanceVV(output.pointA, output.pointB);
	    ...
	    if (input.useRadii) {
	        ...
	        if (output.distance > (rA + rB) && output.distance > b2Settings_1.b2_epsilon) {
	            ...
	            var normal = b2Math_1.b2SubVV(output.pointB, output.pointA, b2Distance_s_normal);
	            normal.Normalize();
	            ...
	            var p = b2Math_1.b2MidVV(output.pointA, output.pointB, b2Distance_s_p);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var b2ShapeType = exports.b2ShapeType;
	...
	var b2Shape = (function () {
	    ...
	    b2Shape.prototype.Copy = function (other) {
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(this.m_type == other.m_type);
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var b2Shape_1 = __webpack_require__(12);
	var b2Collision_1 = __webpack_require__(10);
	var b2TimeOfImpact_1 = __webpack_require__(14);
	var b2Fixture_1 = __webpack_require__(9);
	var b2Contact_1 = __webpack_require__(16);
	var b2Joint_1 = __webpack_require__(8);
	var b2JointFactory_1 = __webpack_require__(17);
	var b2Body_1 = __webpack_require__(29);
	var b2Island_1 = __webpack_require__(30);
	var b2TimeStep_1 = __webpack_require__(31);
	var b2Timer_1 = __webpack_require__(15);
	var b2ContactManager_1 = __webpack_require__(33);
	var b2WorldCallbacks_1 = __webpack_require__(6);
	...
	})(exports.b2WorldFlag || (exports.b2WorldFlag = {}));
	var b2WorldFlag = exports.b2WorldFlag;
	...
	var b2World = (function () {
	    ...
	    b2World.prototype.CreateBody = function (def) {
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(this.IsLocked() == false);
	        }
	        if (this.IsLocked()) {
	            return null;
	        }
	    ...
	    b2World.prototype.DestroyBody = function (b) {
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(this.m_bodyCount > 0);
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(this.IsLocked() == false);
	        }
	    ...
	    b2World.prototype.DestroyJoint = function (j) {
	        ...
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(this.m_jointCount > 0);
	        }
	        --this.m_jointCount;
	        // If the joint prevents collisions, then flag any contacts for filtering.
	    ...
	    b2World.prototype.Step = function (dt, velocityIterations, positionIterations) {
	        var stepTimer = new b2Timer_1.b2Timer();
	    ...
	    b2World.prototype.QueryAABB = function (callback, aabb) {
	        ...
	        var WorldQueryWrapper = function (proxy) {
	            ...
	            if (b2Settings_1.ENABLE_ASSERTS) {
	                b2Settings_1.b2Assert(fixture_proxy instanceof b2Fixture_1.b2FixtureProxy);
	            }
	    ...
	    b2World.prototype.QueryPoint = function (callback, point) {
	        ...
	        aabb.lowerBound.SetXY(point.x - b2Settings_1.b2_linearSlop, point.y - b2Settings_1.b2_linearSlop);
	        aabb.upperBound.SetXY(point.x + b2Settings_1.b2_linearSlop, point.y + b2Settings_1.b2_linearSlop);
	        broadPhase.Query(WorldQueryWrapper, aabb);
	    };
	    b2World.prototype.RayCast = function (callback, point1, point2) {
	        ...
	        var WorldRayCastWrapper = function (input, proxy) {
	            ...
	            if (hit) {
	                ...
	                if (callback instanceof b2WorldCallbacks_1.b2RayCastCallback) {
	    ...
	    b2World.prototype.Dump = function () {
	        if (b2Settings_1.DEBUG) {
	            ...
	            b2Settings_1.b2Log("var g: b2Vec2 = new b2Vec2(%.15f, %.15f);\n", this.m_gravity.x, this.m_gravity.y);
	            b2Settings_1.b2Log("this.m_world.SetGravity(g);\n");
	            b2Settings_1.b2Log("var bodies: b2Body[] = new Array(%d);\n", this.m_bodyCount);
	            b2Settings_1.b2Log("var joints: b2Joint[] = new Array(%d);\n", this.m_jointCount);
	            var i = 0;
	            for (var b = this.m_bodyList; b; b = b.m_next) {
	                b.m_islandIndex = i;
	                b.Dump();
	    ...
	    b2World.prototype.Solve = function (step) {
	        ...
	        for (var b = this.m_bodyList; b; b = b.m_next) {
	            b.m_flags &= ~b2Body_1.b2BodyFlag.e_islandFlag;
	        }
	        for (var c = this.m_contactManager.m_contactList; c; c = c.m_next) {
	            c.m_flags &= ~b2Contact_1.b2ContactFlag.e_islandFlag;
	        }
	        for (var j = this.m_jointList; j; j = j.m_next) {
	        ...
	        for (var seed = this.m_bodyList; seed; seed = seed.m_next) {
	            if (seed.m_flags & b2Body_1.b2BodyFlag.e_islandFlag) {
	                continue;
	            }
	            ...
	            seed.m_flags |= b2Body_1.b2BodyFlag.e_islandFlag;
	            // Perform a depth first search (DFS) on the constraint graph.
	            while (stackCount > 0) {
	                // Grab the next body off the stack and add it to the island.
	                var b = stack[--stackCount];
	                if (b2Settings_1.ENABLE_ASSERTS) {
	                    b2Settings_1.b2Assert(b.IsActive() == true);
	                }
	                island.AddBody(b);
	                ...
	                for (var ce = b.m_contactList; ce; ce = ce.next) {
	                    ...
	                    if (contact.m_flags & b2Contact_1.b2ContactFlag.e_islandFlag) {
	                        continue;
	                    }
	                    ...
	                    contact.m_flags |= b2Contact_1.b2ContactFlag.e_islandFlag;
	                    var other = ce.other;
	                    // Was the other body already added to this island?
	                    if (other.m_flags & b2Body_1.b2BodyFlag.e_islandFlag) {
	                        continue;
	                    }
	                    if (b2Settings_1.ENABLE_ASSERTS) {
	                        b2Settings_1.b2Assert(stackCount < stackSize);
	                    }
	                    stack[stackCount++] = other;
	                    other.m_flags |= b2Body_1.b2BodyFlag.e_islandFlag;
	                }
	        ...
	        }
	        {
	            ...
	            for (var b = this.m_bodyList; b; b = b.m_next) {
	                ...
	                if ((b.m_flags & b2Body_1.b2BodyFlag.e_islandFlag) == 0) {
	                    continue;
	                }
	                if (b.GetType() == b2Body_1.b2BodyType.b2_staticBody) {
	                    continue;
	    ...
	    b2World.prototype.SolveTOI = function (step) {
	        ...
	        if (this.m_stepComplete) {
	            ...
	            for (var c = this.m_contactManager.m_contactList; c; c = c.m_next) {
	                // Invalidate TOI
	                c.m_flags &= ~(b2Contact_1.b2ContactFlag.e_toiFlag | b2Contact_1.b2ContactFlag.e_islandFlag);
	                c.m_toiCount = 0;
	                c.m_toi = 1;
	            }
	        }
	        ...
	        for (;;) {
	            ...
	            for (var c = this.m_contactManager.m_contactList; c; c = c.m_next) {
	                ...
	                var alpha = 1;
	                if (c.m_flags & b2Contact_1.b2ContactFlag.e_toiFlag) {
	                    ...
	                    var typeB = bB.m_type;
	                    if (b2Settings_1.ENABLE_ASSERTS) {
	                        b2Settings_1.b2Assert(typeA == b2Body_1.b2BodyType.b2_dynamicBody || typeB == b2Body_1.b2BodyType.b2_dynamicBody);
	                    }
	                    var activeA = bA.IsAwake() && typeA != b2Body_1.b2BodyType.b2_staticBody;
	                    var activeB = bB.IsAwake() && typeB != b2Body_1.b2BodyType.b2_staticBody;
	                    // Is at least one body active (awake and dynamic or kinematic)?
	                    if (activeA == false && activeB == false) {
	                        continue;
	                    }
	                    var collideA = bA.IsBullet() || typeA != b2Body_1.b2BodyType.b2_dynamicBody;
	                    var collideB = bB.IsBullet() || typeB != b2Body_1.b2BodyType.b2_dynamicBody;
	                    ...
	                    if (b2Settings_1.ENABLE_ASSERTS) {
	                        b2Settings_1.b2Assert(alpha0 < 1);
	                    }
	                    ...
	                    c.m_toi = alpha;
	                    c.m_flags |= b2Contact_1.b2ContactFlag.e_toiFlag;
	                }
	                if (alpha < minAlpha) {
	            ...
	            minContact.m_flags &= ~b2Contact_1.b2ContactFlag.e_toiFlag;
	            ...
	            bA.m_flags |= b2Body_1.b2BodyFlag.e_islandFlag;
	            bB.m_flags |= b2Body_1.b2BodyFlag.e_islandFlag;
	            minContact.m_flags |= b2Contact_1.b2ContactFlag.e_islandFlag;
	            ...
	            for (var i = 0; i < 2; ++i) {
	                ...
	                if (body.m_type == b2Body_1.b2BodyType.b2_dynamicBody) {
	                    for (var ce = body.m_contactList; ce; ce = ce.next) {
	                        ...
	                        if ((other.m_flags & b2Body_1.b2BodyFlag.e_islandFlag) == 0) {
	            ...
	            for (var i = 0; i < island.m_bodyCount; ++i) {
	                ...
	                body.m_flags &= ~b2Body_1.b2BodyFlag.e_islandFlag;
	                if (body.m_type != b2Body_1.b2BodyType.b2_dynamicBody) {
	                    continue;
	                }
	                ...
	                for (var ce = body.m_contactList; ce; ce = ce.next) {
	                    ce.contact.m_flags &= ~(b2Contact_1.b2ContactFlag.e_toiFlag | b2Contact_1.b2ContactFlag.e_islandFlag);
	                }
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var b2TOIOutputState = exports.b2TOIOutputState;
	...
	var b2SeparationFunctionType = exports.b2SeparationFunctionType;
	var b2SeparationFunction = (function () {
	    ...
	    b2SeparationFunction.prototype.Initialize = function (cache, proxyA, sweepA, proxyB, sweepB, t1) {
	        ...
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(0 < count && count < 3);
	        }
	        ...
	        if (count == 1) {
	            ...
	            var pointA = b2Math_1.b2MulXV(xfA, localPointA, b2TimeOfImpact_s_pointA);
	            var pointB = b2Math_1.b2MulXV(xfB, localPointB, b2TimeOfImpact_s_pointB);
	            b2Math_1.b2SubVV(pointB, pointA, this.m_axis);
	            ...
	            b2Math_1.b2CrossVOne(b2Math_1.b2SubVV(localPointB2, localPointB1, b2Math_1.b2Vec2.s_t0), this.m_axis).SelfNormalize();
	            var normal = b2Math_1.b2MulRV(xfB.q, this.m_axis, b2TimeOfImpact_s_normal);
	            b2Math_1.b2MidVV(localPointB1, localPointB2, this.m_localPoint);
	            var pointB = b2Math_1.b2MulXV(xfB, this.m_localPoint, b2TimeOfImpact_s_pointB);
	            var localPointA = this.m_proxyA.GetVertex(cache.indexA[0]);
	            var pointA = b2Math_1.b2MulXV(xfA, localPointA, b2TimeOfImpact_s_pointA);
	            var s = b2Math_1.b2DotVV(b2Math_1.b2SubVV(pointA, pointB, b2Math_1.b2Vec2.s_t0), normal);
	            if (s < 0) {
	                this.m_axis.SelfNeg();
	                s = -s;
	            }
	            ...
	            b2Math_1.b2CrossVOne(b2Math_1.b2SubVV(localPointA2, localPointA1, b2Math_1.b2Vec2.s_t0), this.m_axis).SelfNormalize();
	            var normal = b2Math_1.b2MulRV(xfA.q, this.m_axis, b2TimeOfImpact_s_normal);
	            b2Math_1.b2MidVV(localPointA1, localPointA2, this.m_localPoint);
	            var pointA = b2Math_1.b2MulXV(xfA, this.m_localPoint, b2TimeOfImpact_s_pointA);
	            var localPointB = this.m_proxyB.GetVertex(cache.indexB[0]);
	            var pointB = b2Math_1.b2MulXV(xfB, localPointB, b2TimeOfImpact_s_pointB);
	            var s = b2Math_1.b2DotVV(b2Math_1.b2SubVV(pointB, pointA, b2Math_1.b2Vec2.s_t0), normal);
	            if (s < 0) {
	                this.m_axis.SelfNeg();
	                s = -s;
	            }
	    ...
	    b2SeparationFunction.prototype.FindMinSeparation = function (indexA, indexB, t) {
	        ...
	        switch (this.m_type) {
	            case b2SeparationFunctionType.e_points:
	                {
	                    var axisA = b2Math_1.b2MulTRV(xfA.q, this.m_axis, b2TimeOfImpact_s_axisA);
	                    var axisB = b2Math_1.b2MulTRV(xfB.q, b2Math_1.b2NegV(this.m_axis, b2Math_1.b2Vec2.s_t0), b2TimeOfImpact_s_axisB);
	                    ...
	                    var pointA = b2Math_1.b2MulXV(xfA, localPointA, b2TimeOfImpact_s_pointA);
	                    var pointB = b2Math_1.b2MulXV(xfB, localPointB, b2TimeOfImpact_s_pointB);
	                    var separation = b2Math_1.b2DotVV(b2Math_1.b2SubVV(pointB, pointA, b2Math_1.b2Vec2.s_t0), this.m_axis);
	                    return separation;
	                }
	            case b2SeparationFunctionType.e_faceA:
	                {
	                    var normal = b2Math_1.b2MulRV(xfA.q, this.m_axis, b2TimeOfImpact_s_normal);
	                    var pointA = b2Math_1.b2MulXV(xfA, this.m_localPoint, b2TimeOfImpact_s_pointA);
	                    var axisB = b2Math_1.b2MulTRV(xfB.q, b2Math_1.b2NegV(normal, b2Math_1.b2Vec2.s_t0), b2TimeOfImpact_s_axisB);
	                    indexA[0] = -1;
	                    indexB[0] = this.m_proxyB.GetSupport(axisB);
	                    var localPointB = this.m_proxyB.GetVertex(indexB[0]);
	                    var pointB = b2Math_1.b2MulXV(xfB, localPointB, b2TimeOfImpact_s_pointB);
	                    var separation = b2Math_1.b2DotVV(b2Math_1.b2SubVV(pointB, pointA, b2Math_1.b2Vec2.s_t0), normal);
	                    return separation;
	                }
	            case b2SeparationFunctionType.e_faceB:
	                {
	                    var normal = b2Math_1.b2MulRV(xfB.q, this.m_axis, b2TimeOfImpact_s_normal);
	                    var pointB = b2Math_1.b2MulXV(xfB, this.m_localPoint, b2TimeOfImpact_s_pointB);
	                    var axisA = b2Math_1.b2MulTRV(xfA.q, b2Math_1.b2NegV(normal, b2Math_1.b2Vec2.s_t0), b2TimeOfImpact_s_axisA);
	                    indexB[0] = -1;
	                    indexA[0] = this.m_proxyA.GetSupport(axisA);
	                    var localPointA = this.m_proxyA.GetVertex(indexA[0]);
	                    var pointA = b2Math_1.b2MulXV(xfA, localPointA, b2TimeOfImpact_s_pointA);
	                    var separation = b2Math_1.b2DotVV(b2Math_1.b2SubVV(pointA, pointB, b2Math_1.b2Vec2.s_t0), normal);
	                    return separation;
	                }
	            default:
	                if (b2Settings_1.ENABLE_ASSERTS) {
	...
	var b2TimeOfImpact_s_indexA = b2Settings_1.b2MakeNumberArray(1);
	var b2TimeOfImpact_s_indexB = b2Settings_1.b2MakeNumberArray(1);
	...
	function b2TimeOfImpact(output, input) {
	    ...
	    if (b2Settings_1.ENABLE_ASSERTS) {
	        b2Settings_1.b2Assert(target > tolerance);
	    }
	    var t1 = 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	})(exports.b2ContactFlag || (exports.b2ContactFlag = {}));
	var b2ContactFlag = exports.b2ContactFlag;
	var b2Contact = (function () {
	    ...
	    b2Contact.prototype.Update = function (listener) {
	        ...
	        //var aabbOverlap = b2TestOverlapAABB(this.m_fixtureA.GetAABB(0), this.m_fixtureB.GetAABB(0));
	        ...
	        if (sensor) {
	            ...
	            var shapeA = this.m_fixtureA.GetShape();
	            var shapeB = this.m_fixtureB.GetShape();
	            touching = b2Collision_1.b2TestOverlapShape(shapeA, this.m_indexA, shapeB, this.m_indexB, xfA, xfB);
	            //}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var b2Settings_1 = __webpack_require__(3);
	var b2Joint_1 = __webpack_require__(8);
	var b2DistanceJoint_1 = __webpack_require__(18);
	var b2MouseJoint_1 = __webpack_require__(7);
	var b2PrismaticJoint_1 = __webpack_require__(19);
	var b2RevoluteJoint_1 = __webpack_require__(20);
	var b2PulleyJoint_1 = __webpack_require__(21);
	var b2GearJoint_1 = __webpack_require__(22);
	var b2WheelJoint_1 = __webpack_require__(23);
	var b2WeldJoint_1 = __webpack_require__(24);
	var b2FrictionJoint_1 = __webpack_require__(25);
	var b2RopeJoint_1 = __webpack_require__(26);
	var b2MotorJoint_1 = __webpack_require__(27);
	var b2AreaJoint_1 = __webpack_require__(28);
	...
	*/
	...
	var b2DistanceJointDef = (function (_super) {
	    ...
	    function b2DistanceJointDef() {
	        _super.call(this, b2Joint_1.b2JointType.e_distanceJoint); // base class constructor
	    ...
	    b2DistanceJointDef.prototype.Initialize = function (b1, b2, anchor1, anchor2) {
	        ...
	        this.length = b2Math_1.b2DistanceVV(anchor1, anchor2);
	        this.frequencyHz = 0;
	        this.dampingRatio = 0;
	    };
	...
	var b2DistanceJoint = (function (_super) {
	    ...
	    b2DistanceJoint.prototype.Dump = function () {
	        if (b2Settings_1.DEBUG) {
	            ...
	            b2Settings_1.b2Log("  var jd: b2DistanceJointDef = new b2DistanceJointDef();\n");
	            b2Settings_1.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
	            b2Settings_1.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
	            b2Settings_1.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ('true') : ('false'));
	            b2Settings_1.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
	            b2Settings_1.b2Log("  jd.localAnchorB.SetXY(%.15f, %.15f);\n", this.m_localAnchorB.x, this.m_localAnchorB.y);
	            b2Settings_1.b2Log("  jd.length = %.15f;\n", this.m_length);
	            b2Settings_1.b2Log("  jd.frequencyHz = %.15f;\n", this.m_frequencyHz);
	            b2Settings_1.b2Log("  jd.dampingRatio = %.15f;\n", this.m_dampingRatio);
	            b2Settings_1.b2Log("  joints[%d] = this.m_world.CreateJoint(jd);\n", this.m_index);
	        }
	    };
	    b2DistanceJoint.prototype.InitVelocityConstraints = function (data) {
	        ...
	        b2Math_1.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA);
	        b2Math_1.b2MulRV(qA, this.m_lalcA, this.m_rA);
	        ...
	        var crAu = b2Math_1.b2CrossVV(this.m_rA, this.m_u);
	        //float32 crBu = b2Cross(m_rB, m_u);
	        var crBu = b2Math_1.b2CrossVV(this.m_rB, this.m_u);
	        ...
	        if (data.step.warmStarting) {
	            ...
	            var P = b2Math_1.b2MulSV(this.m_impulse, this.m_u, b2DistanceJoint.InitVelocityConstraints_s_P);
	            //vA -= m_invMassA * P;
	            vA.SelfMulSub(this.m_invMassA, P);
	            //wA -= m_invIA * b2Cross(m_rA, P);
	            wA -= this.m_invIA * b2Math_1.b2CrossVV(this.m_rA, P);
	            //vB += m_invMassB * P;
	            vB.SelfMulAdd(this.m_invMassB, P);
	            //wB += m_invIB * b2Cross(m_rB, P);
	            wB += this.m_invIB * b2Math_1.b2CrossVV(this.m_rB, P);
	        }
	        else {
	            this.m_impulse = 0;
	        }
	    ...
	    b2DistanceJoint.prototype.SolveVelocityConstraints = function (data) {
	        ...
	        var vpA = b2Math_1.b2AddVCrossSV(vA, wA, this.m_rA, b2DistanceJoint.SolveVelocityConstraints_s_vpA);
	        //b2Vec2 vpB = vB + b2Cross(wB, m_rB);
	        var vpB = b2Math_1.b2AddVCrossSV(vB, wB, this.m_rB, b2DistanceJoint.SolveVelocityConstraints_s_vpB);
	        //float32 Cdot = b2Dot(m_u, vpB - vpA);
	        var Cdot = b2Math_1.b2DotVV(this.m_u, b2Math_1.b2SubVV(vpB, vpA, b2Math_1.b2Vec2.s_t0));
	        var impulse = (-this.m_mass * (Cdot + this.m_bias + this.m_gamma * this.m_impulse));
	        this.m_impulse += impulse;
	        //b2Vec2 P = impulse * m_u;
	        var P = b2Math_1.b2MulSV(impulse, this.m_u, b2DistanceJoint.SolveVelocityConstraints_s_P);
	        //vA -= m_invMassA * P;
	        vA.SelfMulSub(this.m_invMassA, P);
	        //wA -= m_invIA * b2Cross(m_rA, P);
	        wA -= this.m_invIA * b2Math_1.b2CrossVV(this.m_rA, P);
	    ...
	    b2DistanceJoint.prototype.SolvePositionConstraints = function (data) {
	        ...
	        var rA = b2Math_1.b2MulRV(this.m_qA, this.m_lalcA, this.m_rA); // use m_rA
	        //b2Vec2 rB = b2Mul(qB, m_localAnchorB - m_localCenterB);
	        var rB = b2Math_1.b2MulRV(this.m_qB, this.m_lalcB, this.m_rB); // use m_rB
	        ...
	        //b2Vec2 P = impulse * u;
	        var P = b2Math_1.b2MulSV(impulse, u, b2DistanceJoint.SolvePositionConstraints_s_P);
	        //cA -= m_invMassA * P;
	        cA.SelfMulSub(this.m_invMassA, P);
	        //aA -= m_invIA * b2Cross(rA, P);
	        aA -= this.m_invIA * b2Math_1.b2CrossVV(rA, P);
	        //cB += m_invMassB * P;
	        cB.SelfMulAdd(this.m_invMassB, P);
	        //aB += m_invIB * b2Cross(rB, P);
	        aB += this.m_invIB * b2Math_1.b2CrossVV(rB, P);
	...
	*/
	...
	var b2PrismaticJointDef = (function (_super) {
	    ...
	    function b2PrismaticJointDef() {
	        _super.call(this, b2Joint_1.b2JointType.e_prismaticJoint); // base class constructor
	...
	var b2PrismaticJoint = (function (_super) {
	    ...
	    function b2PrismaticJoint(def) {
	        ...
	        this.m_localYAxisA = b2Math_1.b2CrossOneV(this.m_localXAxisA, new b2Math_1.b2Vec2());
	    ...
	    b2PrismaticJoint.prototype.InitVelocityConstraints = function (data) {
	        ...
	        //b2Vec2 rA = b2Mul(qA, m_localAnchorA - m_localCenterA);
	        b2Math_1.b2SubVV(this.m_localAnchorA, this.m_localCenterA, this.m_lalcA);
	        var rA = b2Math_1.b2MulRV(qA, this.m_lalcA, this.m_rA);
	        //b2Vec2 rB = b2Mul(qB, m_localAnchorB - m_localCenterB);
	        b2Math_1.b2SubVV(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
	        var rB = b2Math_1.b2MulRV(qB, this.m_lalcB, this.m_rB);
	        //b2Vec2 d = (cB - cA) + rB - rA;
	        var d = b2Math_1.b2AddVV(b2Math_1.b2SubVV(cB, cA, b2Math_1.b2Vec2.s_t0), b2Math_1.b2SubVV(rB, rA, b2Math_1.b2Vec2.s_t1), b2PrismaticJoint.InitVelocityConstraints_s_d);
	        var mA = this.m_invMassA, mB = this.m_invMassB;
	        var iA = this.m_invIA, iB = this.m_invIB;
	        // Compute motor Jacobian and effective mass.
	        {
	            //m_axis = b2Mul(qA, m_localXAxisA);
	            b2Math_1.b2MulRV(qA, this.m_localXAxisA, this.m_axis);
	            //m_a1 = b2Cross(d + rA, m_axis);
	            this.m_a1 = b2Math_1.b2CrossVV(b2Math_1.b2AddVV(d, rA, b2Math_1.b2Vec2.s_t0), this.m_axis);
	            //m_a2 = b2Cross(rB, m_axis);
	            this.m_a2 = b2Math_1.b2CrossVV(rB, this.m_axis);
	        ...
	        // Prismatic constraint.
	        {
	            ...
	            b2Math_1.b2MulRV(qA, this.m_localYAxisA, this.m_perp);
	            //m_s1 = b2Cross(d + rA, m_perp);
	            this.m_s1 = b2Math_1.b2CrossVV(b2Math_1.b2AddVV(d, rA, b2Math_1.b2Vec2.s_t0), this.m_perp);
	            //m_s2 = b2Cross(rB, m_perp);
	            this.m_s2 = b2Math_1.b2CrossVV(rB, this.m_perp);
	        ...
	        if (this.m_enableLimit) {
	            ...
	            var jointTranslation = b2Math_1.b2DotVV(this.m_axis, d);
	        ...
	        if (data.step.warmStarting) {
	            ...
	            var P = b2Math_1.b2AddVV(b2Math_1.b2MulSV(this.m_impulse.x, this.m_perp, b2Math_1.b2Vec2.s_t0), b2Math_1.b2MulSV((this.m_motorImpulse + this.m_impulse.z), this.m_axis, b2Math_1.b2Vec2.s_t1), b2PrismaticJoint.InitVelocityConstraints_s_P);
	    ...
	    b2PrismaticJoint.prototype.SolveVelocityConstraints = function (data) {
	        ...
	        if (this.m_enableMotor && this.m_limitState != b2Joint_1.b2LimitState.e_equalLimits) {
	            ...
	            var Cdot = b2Math_1.b2DotVV(this.m_axis, b2Math_1.b2SubVV(vB, vA, b2Math_1.b2Vec2.s_t0)) + this.m_a2 * wB - this.m_a1 * wA;
	            ...
	            var P = b2Math_1.b2MulSV(impulse, this.m_axis, b2PrismaticJoint.SolveVelocityConstraints_s_P);
	        ...
	        var Cdot1_x = b2Math_1.b2DotVV(this.m_perp, b2Math_1.b2SubVV(vB, vA, b2Math_1.b2Vec2.s_t0)) + this.m_s2 * wB - this.m_s1 * wA;
	        //Cdot1.y = wB - wA;
	        var Cdot1_y = wB - wA;
	        if (this.m_enableLimit && this.m_limitState != b2Joint_1.b2LimitState.e_inactiveLimit) {
	            ...
	            var Cdot2 = b2Math_1.b2DotVV(this.m_axis, b2Math_1.b2SubVV(vB, vA, b2Math_1.b2Vec2.s_t0)) + this.m_a2 * wB - this.m_a1 * wA;
	            ...
	            var P = b2Math_1.b2AddVV(b2Math_1.b2MulSV(df3.x, this.m_perp, b2Math_1.b2Vec2.s_t0), b2Math_1.b2MulSV(df3.z, this.m_axis, b2Math_1.b2Vec2.s_t1), b2PrismaticJoint.SolveVelocityConstraints_s_P);
	            ...
	            var P = b2Math_1.b2MulSV(df2.x, this.m_perp, b2PrismaticJoint.SolveVelocityConstraints_s_P);
	    ...
	    b2PrismaticJoint.prototype.SolvePositionConstraints = function (data) {
	        ...
	        var d = b2Math_1.b2SubVV(b2Math_1.b2AddVV(cB, rB, b2Math_1.b2Vec2.s_t0), b2Math_1.b2AddVV(cA, rA, b2Math_1.b2Vec2.s_t1), b2PrismaticJoint.SolvePositionConstraints_s_d);
	        //b2Vec2 axis = b2Mul(qA, m_localXAxisA);
	        var axis = b2Math_1.b2MulRV(qA, this.m_localXAxisA, this.m_axis);
	        //float32 a1 = b2Cross(d + rA, axis);
	        var a1 = b2Math_1.b2CrossVV(b2Math_1.b2AddVV(d, rA, b2Math_1.b2Vec2.s_t0), axis);
	        //float32 a2 = b2Cross(rB, axis);
	        var a2 = b2Math_1.b2CrossVV(rB, axis);
	        //b2Vec2 perp = b2Mul(qA, m_localYAxisA);
	        var perp = b2Math_1.b2MulRV(qA, this.m_localYAxisA, this.m_perp);
	        //float32 s1 = b2Cross(d + rA, perp);
	        var s1 = b2Math_1.b2CrossVV(b2Math_1.b2AddVV(d, rA, b2Math_1.b2Vec2.s_t0), perp);
	        //float32 s2 = b2Cross(rB, perp);
	        var s2 = b2Math_1.b2CrossVV(rB, perp);
	        //b2Vec3 impulse;
	        var impulse = b2PrismaticJoint.SolvePositionConstraints_s_impulse;
	        //b2Vec2 C1;
	        //C1.x = b2Dot(perp, d);
	        var C1_x = b2Math_1.b2DotVV(perp, d);
	        ...
	        if (this.m_enableLimit) {
	            ...
	            var translation = b2Math_1.b2DotVV(axis, d);
	            if (b2Math_1.b2Abs(this.m_upperTranslation - this.m_lowerTranslation) < 2 * b2Settings_1.b2_linearSlop) {
	        ...
	        var P = b2Math_1.b2AddVV(b2Math_1.b2MulSV(impulse.x, perp, b2Math_1.b2Vec2.s_t0), b2Math_1.b2MulSV(impulse.z, axis, b2Math_1.b2Vec2.s_t1), b2PrismaticJoint.SolvePositionConstraints_s_P);
	    ...
	    b2PrismaticJoint.prototype.GetJointSpeed = function () {
	        ...
	        b2Math_1.b2SubVV(this.m_localAnchorA, bA.m_sweep.localCenter, this.m_lalcA);
	        var rA = b2Math_1.b2MulRV(bA.m_xf.q, this.m_lalcA, this.m_rA);
	        //b2Vec2 rB = b2Mul(bB->m_xf.q, m_localAnchorB - bB->m_sweep.localCenter);
	        b2Math_1.b2SubVV(this.m_localAnchorB, bB.m_sweep.localCenter, this.m_lalcB);
	        var rB = b2Math_1.b2MulRV(bB.m_xf.q, this.m_lalcB, this.m_rB);
	        //b2Vec2 pA = bA->m_sweep.c + rA;
	        var pA = b2Math_1.b2AddVV(bA.m_sweep.c, rA, b2Math_1.b2Vec2.s_t0); // pA uses s_t0
	        //b2Vec2 pB = bB->m_sweep.c + rB;
	        var pB = b2Math_1.b2AddVV(bB.m_sweep.c, rB, b2Math_1.b2Vec2.s_t1); // pB uses s_t1
	        //b2Vec2 d = pB - pA;
	        var d = b2Math_1.b2SubVV(pB, pA, b2Math_1.b2Vec2.s_t2); // d uses s_t2
	        ...
	        var speed = b2Math_1.b2DotVV(d, b2Math_1.b2CrossSV(wA, axis, b2Math_1.b2Vec2.s_t0)) +
	            b2Math_1.b2DotVV(axis, b2Math_1.b2SubVV(b2Math_1.b2AddVCrossSV(vB, wB, rB, b2Math_1.b2Vec2.s_t0), b2Math_1.b2AddVCrossSV(vA, wA, rA, b2Math_1.b2Vec2.s_t1), b2Math_1.b2Vec2.s_t0));
	        return speed;
	    };
	    ...
	    b2PrismaticJoint.prototype.Dump = function () {
	        if (b2Settings_1.DEBUG) {
	            var indexA = this.m_bodyA.m_islandIndex;
	            var indexB = this.m_bodyB.m_islandIndex;
	            b2Settings_1.b2Log("  var jd: b2PrismaticJointDef = new b2PrismaticJointDef();\n");
	            b2Settings_1.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
	            b2Settings_1.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
	            b2Settings_1.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ('true') : ('false'));
	            b2Settings_1.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
	            b2Settings_1.b2Log("  jd.localAnchorB.SetXY(%.15f, %.15f);\n", this.m_localAnchorB.x, this.m_localAnchorB.y);
	            b2Settings_1.b2Log("  jd.localAxisA.SetXY(%.15f, %.15f);\n", this.m_localXAxisA.x, this.m_localXAxisA.y);
	            b2Settings_1.b2Log("  jd.referenceAngle = %.15f;\n", this.m_referenceAngle);
	            b2Settings_1.b2Log("  jd.enableLimit = %s;\n", (this.m_enableLimit) ? ('true') : ('false'));
	            b2Settings_1.b2Log("  jd.lowerTranslation = %.15f;\n", this.m_lowerTranslation);
	            b2Settings_1.b2Log("  jd.upperTranslation = %.15f;\n", this.m_upperTranslation);
	            b2Settings_1.b2Log("  jd.enableMotor = %s;\n", (this.m_enableMotor) ? ('true') : ('false'));
	            b2Settings_1.b2Log("  jd.motorSpeed = %.15f;\n", this.m_motorSpeed);
	            b2Settings_1.b2Log("  jd.maxMotorForce = %.15f;\n", this.m_maxMotorForce);
	            b2Settings_1.b2Log("  joints[%d] = this.m_world.CreateJoint(jd);\n", this.m_index);
	        }
	    };
	...
	*/
	...
	var b2RevoluteJointDef = (function (_super) {
	    ...
	    function b2RevoluteJointDef() {
	        _super.call(this, b2Joint_1.b2JointType.e_revoluteJoint); // base class constructor
	...
	var b2RevoluteJoint = (function (_super) {
	    ...
	    b2RevoluteJoint.prototype.InitVelocityConstraints = function (data) {
	        ...
	        if (data.step.warmStarting) {
	            ...
	            //vA -= mA * P;
	            vA.SelfMulSub(mA, P);
	            wA -= iA * (b2Math_1.b2CrossVV(this.m_rA, P) + this.m_motorImpulse + this.m_impulse.z);
	            //vB += mB * P;
	            vB.SelfMulAdd(mB, P);
	            wB += iB * (b2Math_1.b2CrossVV(this.m_rB, P) + this.m_motorImpulse + this.m_impulse.z);
	        }
	        else {
	            this.m_impulse.SetZero();
	            this.m_motorImpulse = 0;
	    ...
	    b2RevoluteJoint.prototype.SolveVelocityConstraints = function (data) {
	        ...
	        if (this.m_enableMotor && this.m_limitState != b2Joint_1.b2LimitState.e_equalLimits && fixedRotation == false) {
	        ...
	        if (this.m_enableLimit && this.m_limitState != b2Joint_1.b2LimitState.e_inactiveLimit && fixedRotation == false) {
	            //b2Vec2 Cdot1 = vB + b2Cross(wB, m_rB) - vA - b2Cross(wA, m_rA);
	            var Cdot1 = b2Math_1.b2SubVV(b2Math_1.b2AddVCrossSV(vB, wB, this.m_rB, b2Math_1.b2Vec2.s_t0), b2Math_1.b2AddVCrossSV(vA, wA, this.m_rA, b2Math_1.b2Vec2.s_t1), b2RevoluteJoint.SolveVelocityConstraints_s_Cdot1);
	            var Cdot2 = wB - wA;
	            //b2Vec3 Cdot(Cdot1.x, Cdot1.y, Cdot2);
	            ...
	            //vA -= mA * P;
	            vA.SelfMulSub(mA, P);
	            wA -= iA * (b2Math_1.b2CrossVV(this.m_rA, P) + impulse_v3.z);
	            //vB += mB * P;
	            vB.SelfMulAdd(mB, P);
	            wB += iB * (b2Math_1.b2CrossVV(this.m_rB, P) + impulse_v3.z);
	        }
	        else {
	            // Solve point-to-point constraint
	            //b2Vec2 Cdot = vB + b2Cross(wB, m_rB) - vA - b2Cross(wA, m_rA);
	            var Cdot_v2 = b2Math_1.b2SubVV(b2Math_1.b2AddVCrossSV(vB, wB, this.m_rB, b2Math_1.b2Vec2.s_t0), b2Math_1.b2AddVCrossSV(vA, wA, this.m_rA, b2Math_1.b2Vec2.s_t1), b2RevoluteJoint.SolveVelocityConstraints_s_Cdot_v2);
	            ...
	            wA -= iA * b2Math_1.b2CrossVV(this.m_rA, impulse_v2);
	            //vB += mB * impulse;
	            vB.SelfMulAdd(mB, impulse_v2);
	            wB += iB * b2Math_1.b2CrossVV(this.m_rB, impulse_v2);
	        }
	        //data.velocities[this.m_indexA].v = vA;
	        data.velocities[this.m_indexA].w = wA;
	        //data.velocities[this.m_indexB].v = vB;
	    ...
	    b2RevoluteJoint.prototype.SolvePositionConstraints = function (data) {
	        ...
	        // Solve point-to-point constraint.
	        {
	            ...
	            var C_v2 = b2Math_1.b2SubVV(b2Math_1.b2AddVV(cB, rB, b2Math_1.b2Vec2.s_t0), b2Math_1.b2AddVV(cA, rA, b2Math_1.b2Vec2.s_t1), b2RevoluteJoint.SolvePositionConstraints_s_C_v2);
	            ...
	            aA -= iA * b2Math_1.b2CrossVV(rA, impulse);
	            //cB += mB * impulse;
	            cB.SelfMulAdd(mB, impulse);
	            aB += iB * b2Math_1.b2CrossVV(rB, impulse);
	        }
	        //data.positions[this.m_indexA].c = cA;
	        data.positions[this.m_indexA].a = aA;
	        //data.positions[this.m_indexB].c = cB;
	    ...
	    b2RevoluteJoint.prototype.Dump = function () {
	        if (b2Settings_1.DEBUG) {
	            var indexA = this.m_bodyA.m_islandIndex;
	            var indexB = this.m_bodyB.m_islandIndex;
	            b2Settings_1.b2Log("  var jd: b2RevoluteJointDef = new b2RevoluteJointDef();\n");
	            b2Settings_1.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
	            b2Settings_1.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
	            b2Settings_1.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ('true') : ('false'));
	            b2Settings_1.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
	            ...
	            b2Settings_1.b2Log("  jd.referenceAngle = %.15f;\n", this.m_referenceAngle);
	            b2Settings_1.b2Log("  jd.enableLimit = %s;\n", (this.m_enableLimit) ? ('true') : ('false'));
	            b2Settings_1.b2Log("  jd.lowerAngle = %.15f;\n", this.m_lowerAngle);
	            b2Settings_1.b2Log("  jd.upperAngle = %.15f;\n", this.m_upperAngle);
	            b2Settings_1.b2Log("  jd.enableMotor = %s;\n", (this.m_enableMotor) ? ('true') : ('false'));
	            b2Settings_1.b2Log("  jd.motorSpeed = %.15f;\n", this.m_motorSpeed);
	            b2Settings_1.b2Log("  jd.maxMotorTorque = %.15f;\n", this.m_maxMotorTorque);
	            b2Settings_1.b2Log("  joints[%d] = this.m_world.CreateJoint(jd);\n", this.m_index);
	        }
	    };
	...
	*/
	...
	var b2PulleyJointDef = (function (_super) {
	    ...
	    function b2PulleyJointDef() {
	        _super.call(this, b2Joint_1.b2JointType.e_pulleyJoint); // base class constructor
	    ...
	    b2PulleyJointDef.prototype.Initialize = function (bA, bB, groundA, groundB, anchorA, anchorB, r) {
	        ...
	        this.lengthA = b2Math_1.b2DistanceVV(anchorA, groundA);
	        this.lengthB = b2Math_1.b2DistanceVV(anchorB, groundB);
	        this.ratio = r;
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(this.ratio > b2Settings_1.b2_epsilon);
	        }
	    };
	...
	var b2PulleyJoint = (function (_super) {
	    ...
	    function b2PulleyJoint(def) {
	        ...
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(def.ratio != 0);
	        }
	    ...
	    b2PulleyJoint.prototype.InitVelocityConstraints = function (data) {
	        ...
	        var ruA = b2Math_1.b2CrossVV(this.m_rA, this.m_uA);
	        var ruB = b2Math_1.b2CrossVV(this.m_rB, this.m_uB);
	        ...
	        if (data.step.warmStarting) {
	            ...
	            var PA = b2Math_1.b2MulSV(-(this.m_impulse), this.m_uA, b2PulleyJoint.InitVelocityConstraints_s_PA);
	            //b2Vec2 PB = (-m_ratio * m_impulse) * m_uB;
	            var PB = b2Math_1.b2MulSV((-this.m_ratio * this.m_impulse), this.m_uB, b2PulleyJoint.InitVelocityConstraints_s_PB);
	            //vA += m_invMassA * PA;
	            vA.SelfMulAdd(this.m_invMassA, PA);
	            wA += this.m_invIA * b2Math_1.b2CrossVV(this.m_rA, PA);
	            //vB += m_invMassB * PB;
	            vB.SelfMulAdd(this.m_invMassB, PB);
	            wB += this.m_invIB * b2Math_1.b2CrossVV(this.m_rB, PB);
	        }
	        else {
	            this.m_impulse = 0;
	        }
	    ...
	    b2PulleyJoint.prototype.SolveVelocityConstraints = function (data) {
	        ...
	        var wB = data.velocities[this.m_indexB].w;
	        //b2Vec2 vpA = vA + b2Cross(wA, m_rA);
	        var vpA = b2Math_1.b2AddVCrossSV(vA, wA, this.m_rA, b2PulleyJoint.SolveVelocityConstraints_s_vpA);
	        //b2Vec2 vpB = vB + b2Cross(wB, m_rB);
	        var vpB = b2Math_1.b2AddVCrossSV(vB, wB, this.m_rB, b2PulleyJoint.SolveVelocityConstraints_s_vpB);
	        var Cdot = -b2Math_1.b2DotVV(this.m_uA, vpA) - this.m_ratio * b2Math_1.b2DotVV(this.m_uB, vpB);
	        var impulse = -this.m_mass * Cdot;
	        this.m_impulse += impulse;
	        //b2Vec2 PA = -impulse * m_uA;
	        var PA = b2Math_1.b2MulSV(-impulse, this.m_uA, b2PulleyJoint.SolveVelocityConstraints_s_PA);
	        //b2Vec2 PB = -m_ratio * impulse * m_uB;
	        var PB = b2Math_1.b2MulSV(-this.m_ratio * impulse, this.m_uB, b2PulleyJoint.SolveVelocityConstraints_s_PB);
	        //vA += m_invMassA * PA;
	        vA.SelfMulAdd(this.m_invMassA, PA);
	        wA += this.m_invIA * b2Math_1.b2CrossVV(this.m_rA, PA);
	        //vB += m_invMassB * PB;
	    ...
	    b2PulleyJoint.prototype.SolvePositionConstraints = function (data) {
	        ...
	        // Compute effective mass.
	        var ruA = b2Math_1.b2CrossVV(rA, uA);
	        var ruB = b2Math_1.b2CrossVV(rB, uB);
	        var mA = this.m_invMassA + this.m_invIA * ruA * ruA;
	        var mB = this.m_invMassB + this.m_invIB * ruB * ruB;
	        ...
	        var PA = b2Math_1.b2MulSV(-impulse, uA, b2PulleyJoint.SolvePositionConstraints_s_PA);
	        //b2Vec2 PB = -m_ratio * impulse * uB;
	        var PB = b2Math_1.b2MulSV(-this.m_ratio * impulse, uB, b2PulleyJoint.SolvePositionConstraints_s_PB);
	        //cA += m_invMassA * PA;
	        cA.SelfMulAdd(this.m_invMassA, PA);
	        aA += this.m_invIA * b2Math_1.b2CrossVV(rA, PA);
	        //cB += m_invMassB * PB;
	        cB.SelfMulAdd(this.m_invMassB, PB);
	        aB += this.m_invIB * b2Math_1.b2CrossVV(rB, PB);
	        //data.positions[this.m_indexA].c = cA;
	        data.positions[this.m_indexA].a = aA;
	        //data.positions[this.m_indexB].c = cB;
	        data.positions[this.m_indexB].a = aB;
	    ...
	    b2PulleyJoint.prototype.GetCurrentLengthA = function () {
	        ...
	        return b2Math_1.b2DistanceVV(p, s);
	    };
	    ...
	    b2PulleyJoint.prototype.Dump = function () {
	        if (b2Settings_1.DEBUG) {
	            var indexA = this.m_bodyA.m_islandIndex;
	            var indexB = this.m_bodyB.m_islandIndex;
	            b2Settings_1.b2Log("  var jd: b2PulleyJointDef = new b2PulleyJointDef();\n");
	            b2Settings_1.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
	            b2Settings_1.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
	            b2Settings_1.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ('true') : ('false'));
	            b2Settings_1.b2Log("  jd.groundAnchorA.SetXY(%.15f, %.15f);\n", this.m_groundAnchorA.x, this.m_groundAnchorA.y);
	            b2Settings_1.b2Log("  jd.groundAnchorB.SetXY(%.15f, %.15f);\n", this.m_groundAnchorB.x, this.m_groundAnchorB.y);
	            b2Settings_1.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
	            b2Settings_1.b2Log("  jd.localAnchorB.SetXY(%.15f, %.15f);\n", this.m_localAnchorB.x, this.m_localAnchorB.y);
	            b2Settings_1.b2Log("  jd.lengthA = %.15f;\n", this.m_lengthA);
	            b2Settings_1.b2Log("  jd.lengthB = %.15f;\n", this.m_lengthB);
	            b2Settings_1.b2Log("  jd.ratio = %.15f;\n", this.m_ratio);
	            b2Settings_1.b2Log("  joints[%d] = this.m_world.CreateJoint(jd);\n", this.m_index);
	        }
	    };
	...
	*/
	...
	var b2GearJointDef = (function (_super) {
	    ...
	    function b2GearJointDef() {
	        _super.call(this, b2Joint_1.b2JointType.e_gearJoint); // base class constructor
	        this.joint1 = null;
	        this.joint2 = null;
	        this.ratio = 1;
	    }
	...
	var b2GearJoint = (function (_super) {
	    ...
	    function b2GearJoint(def) {
	        ...
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(this.m_typeA == b2Joint_1.b2JointType.e_revoluteJoint || this.m_typeA == b2Joint_1.b2JointType.e_prismaticJoint);
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(this.m_typeB == b2Joint_1.b2JointType.e_revoluteJoint || this.m_typeB == b2Joint_1.b2JointType.e_prismaticJoint);
	        }
	        ...
	        if (this.m_typeA == b2Joint_1.b2JointType.e_revoluteJoint) {
	            ...
	            var pA = b2Math_1.b2MulTRV(xfC.q, b2Math_1.b2AddVV(b2Math_1.b2MulRV(xfA.q, this.m_localAnchorA, b2Math_1.b2Vec2.s_t0), b2Math_1.b2SubVV(xfA.p, xfC.p, b2Math_1.b2Vec2.s_t1), b2Math_1.b2Vec2.s_t0), b2Math_1.b2Vec2.s_t0); // pA uses s_t0
	            //coordinateA = b2Dot(pA - pC, m_localAxisC);
	            coordinateA = b2Math_1.b2DotVV(b2Math_1.b2SubVV(pA, pC, b2Math_1.b2Vec2.s_t0), this.m_localAxisC);
	        }
	        ...
	        if (this.m_typeB == b2Joint_1.b2JointType.e_revoluteJoint) {
	            ...
	            var pB = b2Math_1.b2MulTRV(xfD.q, b2Math_1.b2AddVV(b2Math_1.b2MulRV(xfB.q, this.m_localAnchorB, b2Math_1.b2Vec2.s_t0), b2Math_1.b2SubVV(xfB.p, xfD.p, b2Math_1.b2Vec2.s_t1), b2Math_1.b2Vec2.s_t0), b2Math_1.b2Vec2.s_t0); // pB uses s_t0
	            //coordinateB = b2Dot(pB - pD, m_localAxisD);
	            coordinateB = b2Math_1.b2DotVV(b2Math_1.b2SubVV(pB, pD, b2Math_1.b2Vec2.s_t0), this.m_localAxisD);
	        }
	        this.m_ratio = def.ratio;
	    ...
	    b2GearJoint.prototype.InitVelocityConstraints = function (data) {
	        ...
	        if (this.m_typeA == b2Joint_1.b2JointType.e_revoluteJoint) {
	            ...
	            var u = b2Math_1.b2MulRV(qC, this.m_localAxisC, b2GearJoint.InitVelocityConstraints_s_u);
	            //b2Vec2 rC = b2Mul(qC, m_localAnchorC - m_lcC);
	            b2Math_1.b2SubVV(this.m_localAnchorC, this.m_lcC, this.m_lalcC);
	            var rC = b2Math_1.b2MulRV(qC, this.m_lalcC, b2GearJoint.InitVelocityConstraints_s_rC);
	            //b2Vec2 rA = b2Mul(qA, m_localAnchorA - m_lcA);
	            b2Math_1.b2SubVV(this.m_localAnchorA, this.m_lcA, this.m_lalcA);
	            var rA = b2Math_1.b2MulRV(qA, this.m_lalcA, b2GearJoint.InitVelocityConstraints_s_rA);
	            //m_JvAC = u;
	            this.m_JvAC.Copy(u);
	            //m_JwC = b2Cross(rC, u);
	            this.m_JwC = b2Math_1.b2CrossVV(rC, u);
	            //m_JwA = b2Cross(rA, u);
	            this.m_JwA = b2Math_1.b2CrossVV(rA, u);
	        ...
	        if (this.m_typeB == b2Joint_1.b2JointType.e_revoluteJoint) {
	            ...
	            var u = b2Math_1.b2MulRV(qD, this.m_localAxisD, b2GearJoint.InitVelocityConstraints_s_u);
	            //b2Vec2 rD = b2Mul(qD, m_localAnchorD - m_lcD);
	            b2Math_1.b2SubVV(this.m_localAnchorD, this.m_lcD, this.m_lalcD);
	            var rD = b2Math_1.b2MulRV(qD, this.m_lalcD, b2GearJoint.InitVelocityConstraints_s_rD);
	            //b2Vec2 rB = b2Mul(qB, m_localAnchorB - m_lcB);
	            b2Math_1.b2SubVV(this.m_localAnchorB, this.m_lcB, this.m_lalcB);
	            var rB = b2Math_1.b2MulRV(qB, this.m_lalcB, b2GearJoint.InitVelocityConstraints_s_rB);
	            //m_JvBD = m_ratio * u;
	            b2Math_1.b2MulSV(this.m_ratio, u, this.m_JvBD);
	            //m_JwD = m_ratio * b2Cross(rD, u);
	            this.m_JwD = this.m_ratio * b2Math_1.b2CrossVV(rD, u);
	            //m_JwB = m_ratio * b2Cross(rB, u);
	            this.m_JwB = this.m_ratio * b2Math_1.b2CrossVV(rB, u);
	    ...
	    b2GearJoint.prototype.SolveVelocityConstraints = function (data) {
	        ...
	        var Cdot = b2Math_1.b2DotVV(this.m_JvAC, b2Math_1.b2SubVV(vA, vC, b2Math_1.b2Vec2.s_t0)) +
	            b2Math_1.b2DotVV(this.m_JvBD, b2Math_1.b2SubVV(vB, vD, b2Math_1.b2Vec2.s_t0));
	    ...
	    b2GearJoint.prototype.SolvePositionConstraints = function (data) {
	        ...
	        if (this.m_typeA == b2Joint_1.b2JointType.e_revoluteJoint) {
	            ...
	            //b2Vec2 u = b2Mul(qC, m_localAxisC);
	            var u = b2Math_1.b2MulRV(qC, this.m_localAxisC, b2GearJoint.SolvePositionConstraints_s_u);
	            //b2Vec2 rC = b2Mul(qC, m_localAnchorC - m_lcC);
	            var rC = b2Math_1.b2MulRV(qC, this.m_lalcC, b2GearJoint.SolvePositionConstraints_s_rC);
	            //b2Vec2 rA = b2Mul(qA, m_localAnchorA - m_lcA);
	            var rA = b2Math_1.b2MulRV(qA, this.m_lalcA, b2GearJoint.SolvePositionConstraints_s_rA);
	            //JvAC = u;
	            JvAC.Copy(u);
	            //JwC = b2Cross(rC, u);
	            JwC = b2Math_1.b2CrossVV(rC, u);
	            //JwA = b2Cross(rA, u);
	            JwA = b2Math_1.b2CrossVV(rA, u);
	            mass += this.m_mC + this.m_mA + this.m_iC * JwC * JwC + this.m_iA * JwA * JwA;
	            //b2Vec2 pC = m_localAnchorC - m_lcC;
	            var pC = this.m_lalcC;
	            //b2Vec2 pA = b2MulT(qC, rA + (cA - cC));
	            var pA = b2Math_1.b2MulTRV(qC, b2Math_1.b2AddVV(rA, b2Math_1.b2SubVV(cA, cC, b2Math_1.b2Vec2.s_t0), b2Math_1.b2Vec2.s_t0), b2Math_1.b2Vec2.s_t0); // pA uses s_t0
	            //coordinateA = b2Dot(pA - pC, m_localAxisC);
	            coordinateA = b2Math_1.b2DotVV(b2Math_1.b2SubVV(pA, pC, b2Math_1.b2Vec2.s_t0), this.m_localAxisC);
	        }
	        if (this.m_typeB == b2Joint_1.b2JointType.e_revoluteJoint) {
	            ...
	            //b2Vec2 u = b2Mul(qD, m_localAxisD);
	            var u = b2Math_1.b2MulRV(qD, this.m_localAxisD, b2GearJoint.SolvePositionConstraints_s_u);
	            //b2Vec2 rD = b2Mul(qD, m_localAnchorD - m_lcD);
	            var rD = b2Math_1.b2MulRV(qD, this.m_lalcD, b2GearJoint.SolvePositionConstraints_s_rD);
	            //b2Vec2 rB = b2Mul(qB, m_localAnchorB - m_lcB);
	            var rB = b2Math_1.b2MulRV(qB, this.m_lalcB, b2GearJoint.SolvePositionConstraints_s_rB);
	            //JvBD = m_ratio * u;
	            b2Math_1.b2MulSV(this.m_ratio, u, JvBD);
	            //JwD = m_ratio * b2Cross(rD, u);
	            JwD = this.m_ratio * b2Math_1.b2CrossVV(rD, u);
	            //JwB = m_ratio * b2Cross(rB, u);
	            JwB = this.m_ratio * b2Math_1.b2CrossVV(rB, u);
	            mass += this.m_ratio * this.m_ratio * (this.m_mD + this.m_mB) + this.m_iD * JwD * JwD + this.m_iB * JwB * JwB;
	            //b2Vec2 pD = m_localAnchorD - m_lcD;
	            var pD = this.m_lalcD;
	            //b2Vec2 pB = b2MulT(qD, rB + (cB - cD));
	            var pB = b2Math_1.b2MulTRV(qD, b2Math_1.b2AddVV(rB, b2Math_1.b2SubVV(cB, cD, b2Math_1.b2Vec2.s_t0), b2Math_1.b2Vec2.s_t0), b2Math_1.b2Vec2.s_t0); // pB uses s_t0
	            //coordinateB = b2Dot(pB - pD, m_localAxisD);
	            coordinateB = b2Math_1.b2DotVV(b2Math_1.b2SubVV(pB, pD, b2Math_1.b2Vec2.s_t0), this.m_localAxisD);
	        }
	    ...
	    b2GearJoint.prototype.GetReactionForce = function (inv_dt, out) {
	        ...
	        //return inv_dt * P;
	        return b2Math_1.b2MulSV(inv_dt * this.m_impulse, this.m_JvAC, out);
	    };
	    ...
	    b2GearJoint.prototype.SetRatio = function (ratio) {
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(b2Math_1.b2IsValid(ratio));
	        }
	        this.m_ratio = ratio;
	    };
	    b2GearJoint.prototype.Dump = function () {
	        if (b2Settings_1.DEBUG) {
	            ...
	            b2Settings_1.b2Log("  var jd: b2GearJointDef = new b2GearJointDef();\n");
	            b2Settings_1.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
	            b2Settings_1.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
	            b2Settings_1.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ('true') : ('false'));
	            b2Settings_1.b2Log("  jd.joint1 = joints[%d];\n", index1);
	            b2Settings_1.b2Log("  jd.joint2 = joints[%d];\n", index2);
	            b2Settings_1.b2Log("  jd.ratio = %.15f;\n", this.m_ratio);
	            b2Settings_1.b2Log("  joints[%d] = this.m_world.CreateJoint(jd);\n", this.m_index);
	        }
	    };
	...
	*/
	...
	var b2WheelJointDef = (function (_super) {
	    ...
	    function b2WheelJointDef() {
	        _super.call(this, b2Joint_1.b2JointType.e_wheelJoint); // base class constructor
	        this.localAnchorA = new b2Math_1.b2Vec2(0, 0);
	        this.localAnchorB = new b2Math_1.b2Vec2(0, 0);
	        this.localAxisA = new b2Math_1.b2Vec2(1, 0);
	        this.enableMotor = false;
	...
	var b2WheelJoint = (function (_super) {
	    ...
	    function b2WheelJoint(def) {
	        ...
	        b2Math_1.b2CrossOneV(this.m_localXAxisA, this.m_localYAxisA);
	        this.m_maxMotorTorque = def.maxMotorTorque;
	        this.m_motorSpeed = def.motorSpeed;
	        this.m_enableMotor = def.enableMotor;
	        this.m_ax.SetZero();
	    ...
	    b2WheelJoint.prototype.InitVelocityConstraints = function (data) {
	        ...
	        var rB = b2Math_1.b2MulRV(qB, this.m_lalcB, this.m_rB);
	        //b2Vec2 d = cB + rB - cA - rA;
	        var d = b2Math_1.b2SubVV(b2Math_1.b2AddVV(cB, rB, b2Math_1.b2Vec2.s_t0), b2Math_1.b2AddVV(cA, rA, b2Math_1.b2Vec2.s_t1), b2WheelJoint.InitVelocityConstraints_s_d);
	        // Point to line constraint
	        {
	            //m_ay = b2Mul(qA, m_localYAxisA);
	            b2Math_1.b2MulRV(qA, this.m_localYAxisA, this.m_ay);
	            //m_sAy = b2Cross(d + rA, m_ay);
	            this.m_sAy = b2Math_1.b2CrossVV(b2Math_1.b2AddVV(d, rA, b2Math_1.b2Vec2.s_t0), this.m_ay);
	            //m_sBy = b2Cross(rB, m_ay);
	            this.m_sBy = b2Math_1.b2CrossVV(rB, this.m_ay);
	        ...
	        if (this.m_frequencyHz > 0) {
	            ...
	            b2Math_1.b2MulRV(qA, this.m_localXAxisA, this.m_ax);
	            //m_sAx = b2Cross(d + rA, m_ax);
	            this.m_sAx = b2Math_1.b2CrossVV(b2Math_1.b2AddVV(d, rA, b2Math_1.b2Vec2.s_t0), this.m_ax);
	            //m_sBx = b2Cross(rB, m_ax);
	            this.m_sBx = b2Math_1.b2CrossVV(rB, this.m_ax);
	            var invMass = mA + mB + iA * this.m_sAx * this.m_sAx + iB * this.m_sBx * this.m_sBx;
	            if (invMass > 0) {
	                this.m_springMass = 1 / invMass;
	                var C = b2Math_1.b2DotVV(d, this.m_ax);
	                // Frequency
	                var omega = 2 * b2Settings_1.b2_pi * this.m_frequencyHz;
	                // Damping coefficient
	        ...
	        if (data.step.warmStarting) {
	            ...
	            var P = b2Math_1.b2AddVV(b2Math_1.b2MulSV(this.m_impulse, this.m_ay, b2Math_1.b2Vec2.s_t0), b2Math_1.b2MulSV(this.m_springImpulse, this.m_ax, b2Math_1.b2Vec2.s_t1), b2WheelJoint.InitVelocityConstraints_s_P);
	    ...
	    b2WheelJoint.prototype.SolveVelocityConstraints = function (data) {
	        ...
	        if (true) {
	            var Cdot = b2Math_1.b2DotVV(this.m_ax, b2Math_1.b2SubVV(vB, vA, b2Math_1.b2Vec2.s_t0)) + this.m_sBx * wB - this.m_sAx * wA;
	            var impulse = -this.m_springMass * (Cdot + this.m_bias + this.m_gamma * this.m_springImpulse);
	            this.m_springImpulse += impulse;
	            //b2Vec2 P = impulse * m_ax;
	            var P = b2Math_1.b2MulSV(impulse, this.m_ax, b2WheelJoint.SolveVelocityConstraints_s_P);
	        ...
	        if (true) {
	            var Cdot = b2Math_1.b2DotVV(this.m_ay, b2Math_1.b2SubVV(vB, vA, b2Math_1.b2Vec2.s_t0)) + this.m_sBy * wB - this.m_sAy * wA;
	            var impulse = -this.m_mass * Cdot;
	            this.m_impulse += impulse;
	            //b2Vec2 P = impulse * m_ay;
	            var P = b2Math_1.b2MulSV(impulse, this.m_ay, b2WheelJoint.SolveVelocityConstraints_s_P);
	    ...
	    b2WheelJoint.prototype.SolvePositionConstraints = function (data) {
	        ...
	        var rB = b2Math_1.b2MulRV(qB, this.m_lalcB, this.m_rB);
	        //b2Vec2 d = (cB - cA) + rB - rA;
	        var d = b2Math_1.b2AddVV(b2Math_1.b2SubVV(cB, cA, b2Math_1.b2Vec2.s_t0), b2Math_1.b2SubVV(rB, rA, b2Math_1.b2Vec2.s_t1), b2WheelJoint.SolvePositionConstraints_s_d);
	        //b2Vec2 ay = b2Mul(qA, m_localYAxisA);
	        var ay = b2Math_1.b2MulRV(qA, this.m_localYAxisA, this.m_ay);
	        //float32 sAy = b2Cross(d + rA, ay);
	        var sAy = b2Math_1.b2CrossVV(b2Math_1.b2AddVV(d, rA, b2Math_1.b2Vec2.s_t0), ay);
	        //float32 sBy = b2Cross(rB, ay);
	        var sBy = b2Math_1.b2CrossVV(rB, ay);
	        //float32 C = b2Dot(d, ay);
	        var C = b2Math_1.b2DotVV(d, this.m_ay);
	        ...
	        //b2Vec2 P = impulse * ay;
	        var P = b2Math_1.b2MulSV(impulse, ay, b2WheelJoint.SolvePositionConstraints_s_P);
	        var LA = impulse * sAy;
	        var LB = impulse * sBy;
	        //cA -= m_invMassA * P;
	        cA.SelfMulSub(this.m_invMassA, P);
	    ...
	    b2WheelJoint.prototype.GetJointTranslation = function () {
	        ...
	        var d = b2Math_1.b2SubVV(pB, pA, new b2Math_1.b2Vec2());
	    ...
	    b2WheelJoint.prototype.Dump = function () {
	        if (b2Settings_1.DEBUG) {
	            var indexA = this.m_bodyA.m_islandIndex;
	            var indexB = this.m_bodyB.m_islandIndex;
	            b2Settings_1.b2Log("  var jd: b2WheelJointDef = new b2WheelJointDef();\n");
	            b2Settings_1.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
	            b2Settings_1.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
	            b2Settings_1.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ('true') : ('false'));
	            b2Settings_1.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
	            b2Settings_1.b2Log("  jd.localAnchorB.SetXY(%.15f, %.15f);\n", this.m_localAnchorB.x, this.m_localAnchorB.y);
	            b2Settings_1.b2Log("  jd.localAxisA.Set(%.15f, %.15f);\n", this.m_localXAxisA.x, this.m_localXAxisA.y);
	            b2Settings_1.b2Log("  jd.enableMotor = %s;\n", (this.m_enableMotor) ? ('true') : ('false'));
	            b2Settings_1.b2Log("  jd.motorSpeed = %.15f;\n", this.m_motorSpeed);
	            b2Settings_1.b2Log("  jd.maxMotorTorque = %.15f;\n", this.m_maxMotorTorque);
	            b2Settings_1.b2Log("  jd.frequencyHz = %.15f;\n", this.m_frequencyHz);
	...
	*/
	...
	var b2WeldJointDef = (function (_super) {
	    ...
	    function b2WeldJointDef() {
	        _super.call(this, b2Joint_1.b2JointType.e_weldJoint); // base class constructor
	        this.localAnchorA = new b2Math_1.b2Vec2();
	        this.localAnchorB = new b2Math_1.b2Vec2();
	        this.referenceAngle = 0;
	        this.frequencyHz = 0;
	...
	var b2WeldJoint = (function (_super) {
	    ...
	    b2WeldJoint.prototype.InitVelocityConstraints = function (data) {
	        ...
	        if (data.step.warmStarting) {
	            ...
	            //vA -= mA * P;
	            vA.SelfMulSub(mA, P);
	            wA -= iA * (b2Math_1.b2CrossVV(this.m_rA, P) + this.m_impulse.z);
	            //vB += mB * P;
	            vB.SelfMulAdd(mB, P);
	            wB += iB * (b2Math_1.b2CrossVV(this.m_rB, P) + this.m_impulse.z);
	        }
	        else {
	            this.m_impulse.SetZero();
	        }
	    ...
	    b2WeldJoint.prototype.SolveVelocityConstraints = function (data) {
	        ...
	        if (this.m_frequencyHz > 0) {
	            ...
	            var Cdot1 = b2Math_1.b2SubVV(b2Math_1.b2AddVCrossSV(vB, wB, this.m_rB, b2Math_1.b2Vec2.s_t0), b2Math_1.b2AddVCrossSV(vA, wA, this.m_rA, b2Math_1.b2Vec2.s_t1), b2WeldJoint.SolveVelocityConstraints_s_Cdot1);
	            //b2Vec2 impulse1 = -b2Mul22(m_mass, Cdot1);
	            var impulse1 = b2Math_1.b2MulM33XY(this.m_mass, Cdot1.x, Cdot1.y, b2WeldJoint.SolveVelocityConstraints_s_impulse1).SelfNeg();
	            ...
	            wA -= iA * b2Math_1.b2CrossVV(this.m_rA, P);
	            //vB += mB * P;
	            vB.SelfMulAdd(mB, P);
	            //wB += iB * b2Cross(m_rB, P);
	            wB += iB * b2Math_1.b2CrossVV(this.m_rB, P);
	        }
	        else {
	            ...
	            var impulse = b2Math_1.b2MulM33XYZ(this.m_mass, Cdot1.x, Cdot1.y, Cdot2, b2WeldJoint.SolveVelocityConstraints_s_impulse).SelfNeg();
	            this.m_impulse.SelfAdd(impulse);
	            //b2Vec2 P(impulse.x, impulse.y);
	            var P = b2WeldJoint.SolveVelocityConstraints_s_P.SetXY(impulse.x, impulse.y);
	            //vA -= mA * P;
	            vA.SelfMulSub(mA, P);
	            wA -= iA * (b2Math_1.b2CrossVV(this.m_rA, P) + impulse.z);
	            //vB += mB * P;
	            vB.SelfMulAdd(mB, P);
	            wB += iB * (b2Math_1.b2CrossVV(this.m_rB, P) + impulse.z);
	        }
	        //data.velocities[this.m_indexA].v = vA;
	        data.velocities[this.m_indexA].w = wA;
	        //data.velocities[this.m_indexB].v = vB;
	    ...
	    b2WeldJoint.prototype.SolvePositionConstraints = function (data) {
	        ...
	        if (this.m_frequencyHz > 0) {
	            ...
	            var C1 = b2Math_1.b2SubVV(b2Math_1.b2AddVV(cB, rB, b2Math_1.b2Vec2.s_t0), b2Math_1.b2AddVV(cA, rA, b2Math_1.b2Vec2.s_t1), b2WeldJoint.SolvePositionConstraints_s_C1);
	            ...
	            //cA -= mA * P;
	            cA.SelfMulSub(mA, P);
	            aA -= iA * b2Math_1.b2CrossVV(rA, P);
	            //cB += mB * P;
	            cB.SelfMulAdd(mB, P);
	            aB += iB * b2Math_1.b2CrossVV(rB, P);
	        }
	        else {
	            //b2Vec2 C1 =  cB + rB - cA - rA;
	            var C1 = b2Math_1.b2SubVV(b2Math_1.b2AddVV(cB, rB, b2Math_1.b2Vec2.s_t0), b2Math_1.b2AddVV(cA, rA, b2Math_1.b2Vec2.s_t1), b2WeldJoint.SolvePositionConstraints_s_C1);
	            ...
	            //cA -= mA * P;
	            cA.SelfMulSub(mA, P);
	            aA -= iA * (b2Math_1.b2CrossVV(this.m_rA, P) + impulse.z);
	            //cB += mB * P;
	            cB.SelfMulAdd(mB, P);
	            aB += iB * (b2Math_1.b2CrossVV(this.m_rB, P) + impulse.z);
	        }
	        //data.positions[this.m_indexA].c = cA;
	        data.positions[this.m_indexA].a = aA;
	        //data.positions[this.m_indexB].c = cB;
	    ...
	    b2WeldJoint.prototype.Dump = function () {
	        if (b2Settings_1.DEBUG) {
	            var indexA = this.m_bodyA.m_islandIndex;
	            var indexB = this.m_bodyB.m_islandIndex;
	            b2Settings_1.b2Log("  var jd: b2WeldJointDef = new b2WeldJointDef();\n");
	            b2Settings_1.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
	            b2Settings_1.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
	            b2Settings_1.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ('true') : ('false'));
	            b2Settings_1.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
	...
	*/
	...
	var b2FrictionJointDef = (function (_super) {
	    ...
	    function b2FrictionJointDef() {
	        _super.call(this, b2Joint_1.b2JointType.e_frictionJoint); // base class constructor
	        this.localAnchorA = new b2Math_1.b2Vec2();
	        this.localAnchorB = new b2Math_1.b2Vec2();
	        this.maxForce = 0;
	        this.maxTorque = 0;
	...
	var b2FrictionJoint = (function (_super) {
	    ...
	    b2FrictionJoint.prototype.InitVelocityConstraints = function (data) {
	        ...
	        if (data.step.warmStarting) {
	            ...
	            wA -= iA * (b2Math_1.b2CrossVV(this.m_rA, P) + this.m_angularImpulse);
	            //vB += mB * P;
	            vB.SelfMulAdd(mB, P);
	            //wB += iB * (b2Cross(m_rB, P) + m_angularImpulse);
	            wB += iB * (b2Math_1.b2CrossVV(this.m_rB, P) + this.m_angularImpulse);
	        }
	        else {
	            this.m_linearImpulse.SetZero();
	            this.m_angularImpulse = 0;
	    ...
	    b2FrictionJoint.prototype.SolveVelocityConstraints = function (data) {
	        ...
	        if (true) {
	            //b2Vec2 Cdot = vB + b2Cross(wB, m_rB) - vA - b2Cross(wA, m_rA);
	            var Cdot_v2 = b2Math_1.b2SubVV(b2Math_1.b2AddVCrossSV(vB, wB, this.m_rB, b2Math_1.b2Vec2.s_t0), b2Math_1.b2AddVCrossSV(vA, wA, this.m_rA, b2Math_1.b2Vec2.s_t1), b2FrictionJoint.SolveVelocityConstraints_s_Cdot_v2);
	            //b2Vec2 impulse = -b2Mul(m_linearMass, Cdot);
	            var impulseV = b2Math_1.b2MulMV(this.m_linearMass, Cdot_v2, b2FrictionJoint.SolveVelocityConstraints_s_impulseV).SelfNeg();
	            ...
	            b2Math_1.b2SubVV(this.m_linearImpulse, oldImpulseV, impulseV);
	            //vA -= mA * impulse;
	            vA.SelfMulSub(mA, impulseV);
	            //wA -= iA * b2Cross(m_rA, impulse);
	            wA -= iA * b2Math_1.b2CrossVV(this.m_rA, impulseV);
	            //vB += mB * impulse;
	            vB.SelfMulAdd(mB, impulseV);
	            //wB += iB * b2Cross(m_rB, impulse);
	            wB += iB * b2Math_1.b2CrossVV(this.m_rB, impulseV);
	        }
	        //data.velocities[this.m_indexA].v = vA;
	        data.velocities[this.m_indexA].w = wA;
	        //data.velocities[this.m_indexB].v = vB;
	    ...
	    b2FrictionJoint.prototype.Dump = function () {
	        if (b2Settings_1.DEBUG) {
	            var indexA = this.m_bodyA.m_islandIndex;
	            var indexB = this.m_bodyB.m_islandIndex;
	            b2Settings_1.b2Log("  var jd: b2FrictionJointDef = new b2FrictionJointDef();\n");
	            b2Settings_1.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
	            b2Settings_1.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
	            b2Settings_1.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ('true') : ('false'));
	            b2Settings_1.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
	            b2Settings_1.b2Log("  jd.localAnchorB.SetXY(%.15f, %.15f);\n", this.m_localAnchorB.x, this.m_localAnchorB.y);
	            b2Settings_1.b2Log("  jd.maxForce = %.15f;\n", this.m_maxForce);
	            b2Settings_1.b2Log("  jd.maxTorque = %.15f;\n", this.m_maxTorque);
	            b2Settings_1.b2Log("  joints[%d] = this.m_world.CreateJoint(jd);\n", this.m_index);
	        }
	    };
	...
	*/
	...
	var b2RopeJointDef = (function (_super) {
	    ...
	    function b2RopeJointDef() {
	        _super.call(this, b2Joint_1.b2JointType.e_ropeJoint); // base class constructor
	        this.localAnchorA = new b2Math_1.b2Vec2(-1, 0);
	        this.localAnchorB = new b2Math_1.b2Vec2(1, 0);
	        this.maxLength = 0;
	    }
	...
	var b2RopeJoint = (function (_super) {
	    ...
	    b2RopeJoint.prototype.InitVelocityConstraints = function (data) {
	        ...
	        // Compute effective mass.
	        var crA = b2Math_1.b2CrossVV(this.m_rA, this.m_u);
	        var crB = b2Math_1.b2CrossVV(this.m_rB, this.m_u);
	        ...
	        if (data.step.warmStarting) {
	            ...
	            this.m_impulse *= data.step.dtRatio;
	            //b2Vec2 P = m_impulse * m_u;
	            var P = b2Math_1.b2MulSV(this.m_impulse, this.m_u, b2RopeJoint.InitVelocityConstraints_s_P);
	            //vA -= m_invMassA * P;
	            vA.SelfMulSub(this.m_invMassA, P);
	            wA -= this.m_invIA * b2Math_1.b2CrossVV(this.m_rA, P);
	            //vB += m_invMassB * P;
	    ...
	    b2RopeJoint.prototype.SolveVelocityConstraints = function (data) {
	        ...
	        //b2Vec2 vpA = vA + b2Cross(wA, m_rA);
	        var vpA = b2Math_1.b2AddVCrossSV(vA, wA, this.m_rA, b2RopeJoint.SolveVelocityConstraints_s_vpA);
	        //b2Vec2 vpB = vB + b2Cross(wB, m_rB);
	        var vpB = b2Math_1.b2AddVCrossSV(vB, wB, this.m_rB, b2RopeJoint.SolveVelocityConstraints_s_vpB);
	        ...
	        //b2Vec2 P = impulse * m_u;
	        var P = b2Math_1.b2MulSV(impulse, this.m_u, b2RopeJoint.SolveVelocityConstraints_s_P);
	        //vA -= m_invMassA * P;
	        vA.SelfMulSub(this.m_invMassA, P);
	        wA -= this.m_invIA * b2Math_1.b2CrossVV(this.m_rA, P);
	        //vB += m_invMassB * P;
	    ...
	    b2RopeJoint.prototype.SolvePositionConstraints = function (data) {
	        ...
	        var impulse = -this.m_mass * C;
	        //b2Vec2 P = impulse * u;
	        var P = b2Math_1.b2MulSV(impulse, u, b2RopeJoint.SolvePositionConstraints_s_P);
	        //cA -= m_invMassA * P;
	        cA.SelfMulSub(this.m_invMassA, P);
	        aA -= this.m_invIA * b2Math_1.b2CrossVV(rA, P);
	        //cB += m_invMassB * P;
	    ...
	    b2RopeJoint.prototype.GetReactionForce = function (inv_dt, out) {
	        var F = b2Math_1.b2MulSV((inv_dt * this.m_impulse), this.m_u, out);
	        return F;
	        //return out.SetXY(inv_dt * this.m_linearImpulse.x, inv_dt * this.m_linearImpulse.y);
	    };
	    ...
	    b2RopeJoint.prototype.Dump = function () {
	        if (b2Settings_1.DEBUG) {
	            var indexA = this.m_bodyA.m_islandIndex;
	            var indexB = this.m_bodyB.m_islandIndex;
	            b2Settings_1.b2Log("  var jd: b2RopeJointDef = new b2RopeJointDef();\n");
	            b2Settings_1.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
	            b2Settings_1.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
	            b2Settings_1.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ('true') : ('false'));
	            b2Settings_1.b2Log("  jd.localAnchorA.SetXY(%.15f, %.15f);\n", this.m_localAnchorA.x, this.m_localAnchorA.y);
	            b2Settings_1.b2Log("  jd.localAnchorB.SetXY(%.15f, %.15f);\n", this.m_localAnchorB.x, this.m_localAnchorB.y);
	            b2Settings_1.b2Log("  jd.maxLength = %.15f;\n", this.m_maxLength);
	            b2Settings_1.b2Log("  joints[%d] = this.m_world.CreateJoint(jd);\n", this.m_index);
	        }
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var b2MotorJointDef = (function (_super) {
	    ...
	    function b2MotorJointDef() {
	        _super.call(this, b2Joint_1.b2JointType.e_motorJoint); // base class constructor
	...
	var b2MotorJoint = (function (_super) {
	    ...
	    b2MotorJoint.prototype.SetMaxForce = function (force) {
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(b2Math_1.b2IsValid(force) && force >= 0);
	        }
	        this.m_maxForce = force;
	    };
	    ...
	    b2MotorJoint.prototype.SetMaxTorque = function (torque) {
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(b2Math_1.b2IsValid(torque) && torque >= 0);
	        }
	        this.m_maxTorque = torque;
	    };
	    ...
	    b2MotorJoint.prototype.InitVelocityConstraints = function (data) {
	        ...
	        var rA = b2Math_1.b2MulRV(qA, b2Math_1.b2NegV(this.m_localCenterA, b2Math_1.b2Vec2.s_t0), this.m_rA);
	        //this.m_rB = b2Mul(qB, -this.m_localCenterB);
	        var rB = b2Math_1.b2MulRV(qB, b2Math_1.b2NegV(this.m_localCenterB, b2Math_1.b2Vec2.s_t0), this.m_rB);
	        // J = [-I -r1_skew I r2_skew]
	        //     [ 0       -1 0       1]
	        // r_skew = [-ry; rx]
	        // Matlab
	        ...
	        b2Math_1.b2SubVV(b2Math_1.b2SubVV(b2Math_1.b2AddVV(cB, rB, b2Math_1.b2Vec2.s_t0), b2Math_1.b2AddVV(cA, rA, b2Math_1.b2Vec2.s_t1), b2Math_1.b2Vec2.s_t2), b2Math_1.b2MulRV(qA, this.m_linearOffset, b2Math_1.b2Vec2.s_t3), this.m_linearError);
	        ...
	        if (data.step.warmStarting) {
	            ...
	            //vA -= mA * P;
	            vA.SelfMulSub(mA, P);
	            wA -= iA * (b2Math_1.b2CrossVV(rA, P) + this.m_angularImpulse);
	            //vB += mB * P;
	            vB.SelfMulAdd(mB, P);
	            wB += iB * (b2Math_1.b2CrossVV(rB, P) + this.m_angularImpulse);
	        }
	        else {
	            this.m_linearImpulse.SetZero();
	            this.m_angularImpulse = 0;
	    ...
	    b2MotorJoint.prototype.SolveVelocityConstraints = function (data) {
	        ...
	        // Solve linear friction
	        {
	            ...
	            var Cdot_v2 = b2Math_1.b2AddVV(b2Math_1.b2SubVV(b2Math_1.b2AddVV(vB, b2Math_1.b2CrossSV(wB, rB, b2Math_1.b2Vec2.s_t0), b2Math_1.b2Vec2.s_t0), b2Math_1.b2AddVV(vA, b2Math_1.b2CrossSV(wA, rA, b2Math_1.b2Vec2.s_t1), b2Math_1.b2Vec2.s_t1), b2Math_1.b2Vec2.s_t2), b2Math_1.b2MulSV(inv_h * this.m_correctionFactor, this.m_linearError, b2Math_1.b2Vec2.s_t3), b2MotorJoint.SolveVelocityConstraints_s_Cdot_v2);
	            //b2Vec2 impulse = -b2Mul(this.m_linearMass, Cdot);
	            var impulse_v2 = b2Math_1.b2MulMV(this.m_linearMass, Cdot_v2, b2MotorJoint.SolveVelocityConstraints_s_impulse_v2).SelfNeg();
	            ...
	            b2Math_1.b2SubVV(this.m_linearImpulse, oldImpulse_v2, impulse_v2);
	            //vA -= mA * impulse;
	            vA.SelfMulSub(mA, impulse_v2);
	            //wA -= iA * b2CrossVV(rA, impulse);
	            wA -= iA * b2Math_1.b2CrossVV(rA, impulse_v2);
	            //vB += mB * impulse;
	            vB.SelfMulAdd(mB, impulse_v2);
	            //wB += iB * b2CrossVV(rB, impulse);
	            wB += iB * b2Math_1.b2CrossVV(rB, impulse_v2);
	        }
	        //data.velocities[this.m_indexA].v = vA; // vA is a reference
	        data.velocities[this.m_indexA].w = wA;
	        //data.velocities[this.m_indexB].v = vB; // vB is a reference
	    ...
	    b2MotorJoint.prototype.Dump = function () {
	        if (b2Settings_1.DEBUG) {
	            var indexA = this.m_bodyA.m_islandIndex;
	            var indexB = this.m_bodyB.m_islandIndex;
	            b2Settings_1.b2Log("  var jd: b2MotorJointDef = new b2MotorJointDef();\n");
	            b2Settings_1.b2Log("  jd.bodyA = bodies[%d];\n", indexA);
	            b2Settings_1.b2Log("  jd.bodyB = bodies[%d];\n", indexB);
	            b2Settings_1.b2Log("  jd.collideConnected = %s;\n", (this.m_collideConnected) ? ('true') : ('false'));
	            b2Settings_1.b2Log("  jd.linearOffset.SetXY(%.15f, %.15f);\n", this.m_linearOffset.x, this.m_linearOffset.y);
	            b2Settings_1.b2Log("  jd.angularOffset = %.15f;\n", this.m_angularOffset);
	            b2Settings_1.b2Log("  jd.maxForce = %.15f;\n", this.m_maxForce);
	            b2Settings_1.b2Log("  jd.maxTorque = %.15f;\n", this.m_maxTorque);
	            b2Settings_1.b2Log("  jd.correctionFactor = %.15f;\n", this.m_correctionFactor);
	            b2Settings_1.b2Log("  joints[%d] = this.m_world.CreateJoint(jd);\n", this.m_index);
	        }
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var b2AreaJointDef = (function (_super) {
	    ...
	    function b2AreaJointDef() {
	        _super.call(this, b2Joint_1.b2JointType.e_areaJoint); // base class constructor
	        this.world = null;
	...
	var b2AreaJoint = (function (_super) {
	    ...
	    function b2AreaJoint(def) {
	        ...
	        this.m_delta = null;
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(def.bodies.length >= 3, "You cannot create an area joint with less than three bodies.");
	        }
	        ...
	        for (var i = 0, ict = this.m_bodies.length; i < ict; ++i) {
	            ...
	            this.m_targetLengths[i] = b2Math_1.b2DistanceVV(body_c, next_c);
	            this.m_targetArea += b2Math_1.b2CrossVV(body_c, next_c);
	    ...
	    b2AreaJoint.prototype.Dump = function () {
	        if (b2Settings_1.DEBUG) {
	            b2Settings_1.b2Log("Area joint dumping is not supported.\n");
	        }
	    };
	    b2AreaJoint.prototype.InitVelocityConstraints = function (data) {
	        for (var i = 0, ict = this.m_bodies.length; i < ict; ++i) {
	            ...
	            b2Math_1.b2SubVV(next_c, prev_c, delta);
	        }
	        if (data.step.warmStarting) {
	            this.m_impulse *= data.step.dtRatio;
	            for (var i = 0, ict = this.m_bodies.length; i < ict; ++i) {
	    ...
	    b2AreaJoint.prototype.SolveVelocityConstraints = function (data) {
	        ...
	        for (var i = 0, ict = this.m_bodies.length; i < ict; ++i) {
	            ...
	            crossMassSum += b2Math_1.b2CrossVV(body_v, delta);
	        }
	    ...
	    b2AreaJoint.prototype.SolvePositionConstraints = function (data) {
	        ...
	        for (var i = 0, ict = this.m_bodies.length; i < ict; ++i) {
	            ...
	            var next_c = data.positions[next.m_islandIndex].c;
	            var delta = b2Math_1.b2SubVV(next_c, body_c, this.m_delta);
	            ...
	            perimeter += dist;
	            area += b2Math_1.b2CrossVV(body_c, next_c);
	        }
	        area *= 0.5;
	        ...
	        for (var i = 0, ict = this.m_bodies.length; i < ict; ++i) {
	            ...
	            var body_c = data.positions[body.m_islandIndex].c;
	            var next_i = (i + 1) % ict;
	            var delta = b2Math_1.b2AddVV(this.m_normals[i], this.m_normals[next_i], this.m_delta);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var b2BodyType = exports.b2BodyType;
	...
	})(exports.b2BodyFlag || (exports.b2BodyFlag = {}));
	var b2BodyFlag = exports.b2BodyFlag;
	...
	var b2Body = (function () {
	    ...
	    function b2Body(bd, world) {
	        ...
	        this.m_userData = null;
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(bd.position.IsValid());
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(bd.linearVelocity.IsValid());
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(b2Math_1.b2IsValid(bd.angle));
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(b2Math_1.b2IsValid(bd.angularVelocity));
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(b2Math_1.b2IsValid(bd.gravityScale) && bd.gravityScale >= 0);
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(b2Math_1.b2IsValid(bd.angularDamping) && bd.angularDamping >= 0);
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(b2Math_1.b2IsValid(bd.linearDamping) && bd.linearDamping >= 0);
	        }
	        this.m_flags = b2BodyFlag.e_none;
	        if (bd.bullet) {
	    ...
	    b2Body.prototype.CreateFixture = function (def) {
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(this.m_world.IsLocked() == false);
	        }
	        if (this.m_world.IsLocked() == true) {
	            return null;
	        }
	        var fixture = new b2Fixture_1.b2Fixture();
	        ...
	        this.m_world.m_flags |= b2World_1.b2WorldFlag.e_newFixture;
	        return fixture;
	    };
	    ...
	    b2Body.prototype.DestroyFixture = function (fixture) {
	        ...
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(fixture.m_body == this);
	        }
	        // Remove the fixture from this body's singly linked list.
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(this.m_fixtureCount > 0);
	        }
	    ...
	    b2Body.prototype.SetTransformXYRadians = function (x, y, angle) {
	        ...
	        b2Math_1.b2MulXV(this.m_xf, this.m_sweep.localCenter, this.m_sweep.c);
	    ...
	    b2Body.prototype.GetInertia = function () {
	        return this.m_I + this.m_mass * b2Math_1.b2DotVV(this.m_sweep.localCenter, this.m_sweep.localCenter);
	    };
	    /// Get the mass data of the body.
	    /// @return a struct containing the mass, inertia and center of the body.
	    b2Body.prototype.GetMassData = function (data) {
	        data.mass = this.m_mass;
	        data.I = this.m_I + this.m_mass * b2Math_1.b2DotVV(this.m_sweep.localCenter, this.m_sweep.localCenter);
	    ...
	    b2Body.prototype.SetMassData = function (massData) {
	        ...
	        if (massData.I > 0 && (this.m_flags & b2BodyFlag.e_fixedRotationFlag) == 0) {
	            this.m_I = massData.I - this.m_mass * b2Math_1.b2DotVV(massData.center, massData.center);
	            if (b2Settings_1.ENABLE_ASSERTS) {
	                b2Settings_1.b2Assert(this.m_I > 0);
	            }
	        ...
	        b2Math_1.b2AddVCrossSV(this.m_linearVelocity, this.m_angularVelocity, b2Math_1.b2SubVV(this.m_sweep.c, oldCenter, b2Math_1.b2Vec2.s_t0), this.m_linearVelocity);
	    };
	    b2Body.prototype.ResetMassData = function () {
	        ...
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(this.m_type == b2BodyType.b2_dynamicBody);
	        }
	        ...
	        if (this.m_I > 0 && (this.m_flags & b2BodyFlag.e_fixedRotationFlag) == 0) {
	            ...
	            this.m_I -= this.m_mass * b2Math_1.b2DotVV(localCenter, localCenter);
	            if (b2Settings_1.ENABLE_ASSERTS) {
	                b2Settings_1.b2Assert(this.m_I > 0);
	            }
	            this.m_invI = 1 / this.m_I;
	    ...
	    b2Body.prototype.Dump = function () {
	        if (b2Settings_1.DEBUG) {
	            ...
	            b2Settings_1.b2Log("{\n");
	            b2Settings_1.b2Log("  var bd: b2BodyDef = new b2BodyDef();\n");
	            var type_str = '';
	            switch (this.m_type) {
	            ...
	            b2Settings_1.b2Log("  bd.type = %s;\n", type_str);
	            b2Settings_1.b2Log("  bd.position.SetXY(%.15f, %.15f);\n", this.m_xf.p.x, this.m_xf.p.y);
	            b2Settings_1.b2Log("  bd.angle = %.15f;\n", this.m_sweep.a);
	            b2Settings_1.b2Log("  bd.linearVelocity.SetXY(%.15f, %.15f);\n", this.m_linearVelocity.x, this.m_linearVelocity.y);
	            b2Settings_1.b2Log("  bd.angularVelocity = %.15f;\n", this.m_angularVelocity);
	            b2Settings_1.b2Log("  bd.linearDamping = %.15f;\n", this.m_linearDamping);
	            b2Settings_1.b2Log("  bd.angularDamping = %.15f;\n", this.m_angularDamping);
	            b2Settings_1.b2Log("  bd.allowSleep = %s;\n", (this.m_flags & b2BodyFlag.e_autoSleepFlag) ? ('true') : ('false'));
	            b2Settings_1.b2Log("  bd.awake = %s;\n", (this.m_flags & b2BodyFlag.e_awakeFlag) ? ('true') : ('false'));
	            b2Settings_1.b2Log("  bd.fixedRotation = %s;\n", (this.m_flags & b2BodyFlag.e_fixedRotationFlag) ? ('true') : ('false'));
	            b2Settings_1.b2Log("  bd.bullet = %s;\n", (this.m_flags & b2BodyFlag.e_bulletFlag) ? ('true') : ('false'));
	            b2Settings_1.b2Log("  bd.active = %s;\n", (this.m_flags & b2BodyFlag.e_activeFlag) ? ('true') : ('false'));
	            b2Settings_1.b2Log("  bd.gravityScale = %.15f;\n", this.m_gravityScale);
	            b2Settings_1.b2Log("\n");
	            b2Settings_1.b2Log("  bodies[%d] = this.m_world.CreateBody(bd);\n", this.m_islandIndex);
	            b2Settings_1.b2Log("\n");
	            for (var f = this.m_fixtureList; f; f = f.m_next) {
	                b2Settings_1.b2Log("  {\n");
	                f.Dump(bodyIndex);
	    ...
	    b2Body.prototype.SynchronizeFixtures = function () {
	        ...
	        b2Math_1.b2MulRV(xf1.q, this.m_sweep.localCenter, xf1.p);
	        b2Math_1.b2SubVV(this.m_sweep.c0, xf1.p, xf1.p);
	        var broadPhase = this.m_world.m_contactManager.m_broadPhase;
	        for (var f = this.m_fixtureList; f; f = f.m_next) {
	    ...
	    b2Body.prototype.SynchronizeTransform = function () {
	        ...
	        b2Math_1.b2MulRV(this.m_xf.q, this.m_sweep.localCenter, this.m_xf.p);
	        b2Math_1.b2SubVV(this.m_sweep.c, this.m_xf.p, this.m_xf.p);
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var b2Body_1 = __webpack_require__(29);
	var b2TimeStep_1 = __webpack_require__(31);
	var b2ContactSolver_1 = __webpack_require__(32);
	var b2Math_1 = __webpack_require__(2);
	var b2Timer_1 = __webpack_require__(15);
	var b2WorldCallbacks_1 = __webpack_require__(6);
	/*
	...
	*/
	var b2Island = (function () {
	    ...
	    b2Island.prototype.AddBody = function (body) {
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(this.m_bodyCount < this.m_bodyCapacity);
	        }
	    ...
	    b2Island.prototype.AddContact = function (contact) {
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(this.m_contactCount < this.m_contactCapacity);
	        }
	        this.m_contacts[this.m_contactCount++] = contact;
	    };
	    b2Island.prototype.AddJoint = function (joint) {
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(this.m_jointCount < this.m_jointCapacity);
	        }
	    ...
	    b2Island.prototype.Solve = function (profile, step, gravity, allowSleep) {
	        ...
	        for (var i = 0; i < this.m_bodyCount; ++i) {
	            ...
	            if (b.m_type == b2Body_1.b2BodyType.b2_dynamicBody) {
	                ...
	                // Taylor expansion:
	                // v2 = (1.0f - c * dt) * v1
	                v.SelfMul(b2Math_1.b2Clamp(1 - h * b.m_linearDamping, 0, 1));
	                w *= b2Math_1.b2Clamp(1 - h * b.m_angularDamping, 0, 1);
	            }
	        ...
	        for (var i = 0; i < this.m_bodyCount; ++i) {
	            ...
	            var translation = b2Math_1.b2MulSV(h, v, b2Island.s_translation);
	            if (b2Math_1.b2DotVV(translation, translation) > b2Settings_1.b2_maxTranslationSquared) {
	                var ratio = b2Settings_1.b2_maxTranslation / translation.GetLength();
	                v.SelfMul(ratio);
	            }
	            var rotation = h * w;
	            if (rotation * rotation > b2Settings_1.b2_maxRotationSquared) {
	                var ratio = b2Settings_1.b2_maxRotation / b2Math_1.b2Abs(rotation);
	                w *= ratio;
	            }
	            // Integrate
	            c.x += h * v.x;
	        ...
	        if (allowSleep) {
	            ...
	            var linTolSqr = b2Settings_1.b2_linearSleepTolerance * b2Settings_1.b2_linearSleepTolerance;
	            var angTolSqr = b2Settings_1.b2_angularSleepTolerance * b2Settings_1.b2_angularSleepTolerance;
	            for (var i = 0; i < this.m_bodyCount; ++i) {
	                var b = this.m_bodies[i];
	                if (b.GetType() == b2Body_1.b2BodyType.b2_staticBody) {
	                    continue;
	                }
	                if ((b.m_flags & b2Body_1.b2BodyFlag.e_autoSleepFlag) == 0 ||
	                    b.m_angularVelocity * b.m_angularVelocity > angTolSqr ||
	                    b2Math_1.b2DotVV(b.m_linearVelocity, b.m_linearVelocity) > linTolSqr) {
	                    b.m_sleepTime = 0;
	                    minSleepTime = 0;
	                }
	                else {
	    ...
	    b2Island.prototype.SolveTOI = function (subStep, toiIndexA, toiIndexB) {
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(toiIndexA < this.m_bodyCount);
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(toiIndexB < this.m_bodyCount);
	        }
	...
	*/
	...
	var b2PositionSolverManifold = (function () {
	    ...
	    b2PositionSolverManifold.prototype.Initialize = function (pc, xfA, xfB, index) {
	        ...
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(pc.pointCount > 0);
	        }
	        switch (pc.type) {
	            case b2Collision_1.b2ManifoldType.e_circles:
	                {
	                    //b2Vec2 pointA = b2Mul(xfA, pc->localPoint);
	                    b2Math_1.b2MulXV(xfA, pc.localPoint, pointA);
	                    //b2Vec2 pointB = b2Mul(xfB, pc->localPoints[0]);
	                    b2Math_1.b2MulXV(xfB, pc.localPoints[0], pointB);
	                    //normal = pointB - pointA;
	                    //normal.Normalize();
	                    b2Math_1.b2SubVV(pointB, pointA, this.normal).SelfNormalize();
	                    //point = 0.5f * (pointA + pointB);
	                    b2Math_1.b2MidVV(pointA, pointB, this.point);
	                    //separation = b2Dot(pointB - pointA, normal) - pc->radius;
	                    this.separation = b2Math_1.b2DotVV(b2Math_1.b2SubVV(pointB, pointA, b2Math_1.b2Vec2.s_t0), this.normal) - pc.radiusA - pc.radiusB;
	                }
	                break;
	            case b2Collision_1.b2ManifoldType.e_faceA:
	                {
	                    //normal = b2Mul(xfA.q, pc->localNormal);
	                    b2Math_1.b2MulRV(xfA.q, pc.localNormal, this.normal);
	                    //b2Vec2 planePoint = b2Mul(xfA, pc->localPoint);
	                    b2Math_1.b2MulXV(xfA, pc.localPoint, planePoint);
	                    //b2Vec2 clipPoint = b2Mul(xfB, pc->localPoints[index]);
	                    b2Math_1.b2MulXV(xfB, pc.localPoints[index], clipPoint);
	                    //separation = b2Dot(clipPoint - planePoint, normal) - pc->radius;
	                    this.separation = b2Math_1.b2DotVV(b2Math_1.b2SubVV(clipPoint, planePoint, b2Math_1.b2Vec2.s_t0), this.normal) - pc.radiusA - pc.radiusB;
	                    //point = clipPoint;
	            ...
	            case b2Collision_1.b2ManifoldType.e_faceB:
	                {
	                    ...
	                    b2Math_1.b2MulRV(xfB.q, pc.localNormal, this.normal);
	                    //b2Vec2 planePoint = b2Mul(xfB, pc->localPoint);
	                    b2Math_1.b2MulXV(xfB, pc.localPoint, planePoint);
	                    //b2Vec2 clipPoint = b2Mul(xfA, pc->localPoints[index]);
	                    b2Math_1.b2MulXV(xfA, pc.localPoints[index], clipPoint);
	                    //separation = b2Dot(clipPoint - planePoint, normal) - pc->radius;
	                    this.separation = b2Math_1.b2DotVV(b2Math_1.b2SubVV(clipPoint, planePoint, b2Math_1.b2Vec2.s_t0), this.normal) - pc.radiusA - pc.radiusB;
	                    //point = clipPoint;
	                    this.point.Copy(clipPoint);
	...
	var b2ContactSolver = (function () {
	    ...
	    b2ContactSolver.prototype.Initialize = function (def) {
	        ...
	        for (i = 0, ict = this.m_count; i < ict; ++i) {
	            ...
	            if (b2Settings_1.ENABLE_ASSERTS) {
	                b2Settings_1.b2Assert(pointCount > 0);
	            }
	    ...
	    b2ContactSolver.prototype.InitializeVelocityConstraints = function () {
	        ...
	        for (i = 0, ict = this.m_count; i < ict; ++i) {
	            ...
	            if (b2Settings_1.ENABLE_ASSERTS) {
	                b2Settings_1.b2Assert(manifold.pointCount > 0);
	            }
	            xfA.q.SetAngleRadians(aA);
	            xfB.q.SetAngleRadians(aB);
	            b2Math_1.b2SubVV(cA, b2Math_1.b2MulRV(xfA.q, localCenterA, b2Math_1.b2Vec2.s_t0), xfA.p);
	            b2Math_1.b2SubVV(cB, b2Math_1.b2MulRV(xfB.q, localCenterB, b2Math_1.b2Vec2.s_t0), xfB.p);
	            worldManifold.Initialize(manifold, xfA, radiusA, xfB, radiusB);
	            vc.normal.Copy(worldManifold.normal);
	            b2Math_1.b2CrossVOne(vc.normal, vc.tangent); // compute from normal
	            pointCount = vc.pointCount;
	            for (j = 0, jct = pointCount; j < jct; ++j) {
	                vcp = vc.points[j];
	                //vcp->rA = worldManifold.points[j] - cA;
	                b2Math_1.b2SubVV(worldManifold.points[j], cA, vcp.rA);
	                //vcp->rB = worldManifold.points[j] - cB;
	                b2Math_1.b2SubVV(worldManifold.points[j], cB, vcp.rB);
	                rnA = b2Math_1.b2CrossVV(vcp.rA, vc.normal);
	                rnB = b2Math_1.b2CrossVV(vcp.rB, vc.normal);
	                kNormal = mA + mB + iA * rnA * rnA + iB * rnB * rnB;
	                vcp.normalMass = kNormal > 0 ? 1 / kNormal : 0;
	                //b2Vec2 tangent = b2Cross(vc->normal, 1.0f);
	                tangent = vc.tangent; // precomputed from normal
	                rtA = b2Math_1.b2CrossVV(vcp.rA, tangent);
	                rtB = b2Math_1.b2CrossVV(vcp.rB, tangent);
	                kTangent = mA + mB + iA * rtA * rtA + iB * rtB * rtB;
	                vcp.tangentMass = kTangent > 0 ? 1 / kTangent : 0;
	                // Setup a velocity bias for restitution.
	                vcp.velocityBias = 0;
	                //float32 vRel = b2Dot(vc->normal, vB + b2Cross(wB, vcp->rB) - vA - b2Cross(wA, vcp->rA));
	                vRel = b2Math_1.b2DotVV(vc.normal, b2Math_1.b2SubVV(b2Math_1.b2AddVCrossSV(vB, wB, vcp.rB, b2Math_1.b2Vec2.s_t0), b2Math_1.b2AddVCrossSV(vA, wA, vcp.rA, b2Math_1.b2Vec2.s_t1), b2Math_1.b2Vec2.s_t0));
	            ...
	            if (vc.pointCount == 2) {
	                vcp1 = vc.points[0];
	                vcp2 = vc.points[1];
	                rn1A = b2Math_1.b2CrossVV(vcp1.rA, vc.normal);
	                rn1B = b2Math_1.b2CrossVV(vcp1.rB, vc.normal);
	                rn2A = b2Math_1.b2CrossVV(vcp2.rA, vc.normal);
	                rn2B = b2Math_1.b2CrossVV(vcp2.rB, vc.normal);
	    ...
	    b2ContactSolver.prototype.WarmStart = function () {
	        ...
	        for (i = 0, ict = this.m_count; i < ict; ++i) {
	            ...
	            for (j = 0, jct = pointCount; j < jct; ++j) {
	                ...
	                b2Math_1.b2AddVV(b2Math_1.b2MulSV(vcp.normalImpulse, normal, b2Math_1.b2Vec2.s_t0), b2Math_1.b2MulSV(vcp.tangentImpulse, tangent, b2Math_1.b2Vec2.s_t1), P);
	                //wA -= iA * b2Cross(vcp->rA, P);
	                wA -= iA * b2Math_1.b2CrossVV(vcp.rA, P);
	                //vA -= mA * P;
	                vA.SelfMulSub(mA, P);
	                //wB += iB * b2Cross(vcp->rB, P);
	                wB += iB * b2Math_1.b2CrossVV(vcp.rB, P);
	                //vB += mB * P;
	                vB.SelfMulAdd(mB, P);
	            }
	    ...
	    b2ContactSolver.prototype.SolveVelocityConstraints = function () {
	        ...
	        for (i = 0, ict = this.m_count; i < ict; ++i) {
	            ...
	            if (b2Settings_1.ENABLE_ASSERTS) {
	                b2Settings_1.b2Assert(pointCount == 1 || pointCount == 2);
	            }
	            ...
	            for (j = 0, jct = pointCount; j < jct; ++j) {
	                ...
	                b2Math_1.b2SubVV(b2Math_1.b2AddVCrossSV(vB, wB, vcp.rB, b2Math_1.b2Vec2.s_t0), b2Math_1.b2AddVCrossSV(vA, wA, vcp.rA, b2Math_1.b2Vec2.s_t1), dv);
	                // Compute tangent force
	                //float32 vt = b2Dot(dv, tangent) - vc->tangentSpeed;
	                vt = b2Math_1.b2DotVV(dv, tangent) - vc.tangentSpeed;
	                lambda = vcp.tangentMass * (-vt);
	                // b2Clamp the accumulated force
	                maxFriction = friction * vcp.normalImpulse;
	                newImpulse = b2Math_1.b2Clamp(vcp.tangentImpulse + lambda, (-maxFriction), maxFriction);
	                lambda = newImpulse - vcp.tangentImpulse;
	                vcp.tangentImpulse = newImpulse;
	                // Apply contact impulse
	                //b2Vec2 P = lambda * tangent;
	                b2Math_1.b2MulSV(lambda, tangent, P);
	                //vA -= mA * P;
	                vA.SelfMulSub(mA, P);
	                //wA -= iA * b2Cross(vcp->rA, P);
	                wA -= iA * b2Math_1.b2CrossVV(vcp.rA, P);
	            ...
	            if (vc.pointCount == 1) {
	                ...
	                vn = b2Math_1.b2DotVV(dv, normal);
	                lambda = (-vcp.normalMass * (vn - vcp.velocityBias));
	                // b2Clamp the accumulated impulse
	                //float32 newImpulse = b2Max(vcp->normalImpulse + lambda, 0.0f);
	                newImpulse = b2Math_1.b2Max(vcp.normalImpulse + lambda, 0);
	                lambda = newImpulse - vcp.normalImpulse;
	                vcp.normalImpulse = newImpulse;
	                // Apply contact impulse
	                //b2Vec2 P = lambda * normal;
	                b2Math_1.b2MulSV(lambda, normal, P);
	                //vA -= mA * P;
	                vA.SelfMulSub(mA, P);
	                //wA -= iA * b2Cross(vcp->rA, P);
	                wA -= iA * b2Math_1.b2CrossVV(vcp.rA, P);
	                ...
	                if (b2Settings_1.ENABLE_ASSERTS) {
	                    b2Settings_1.b2Assert(a.x >= 0 && a.y >= 0);
	                }
	                // Relative velocity at contact
	                //b2Vec2 dv1 = vB + b2Cross(wB, cp1->rB) - vA - b2Cross(wA, cp1->rA);
	                b2Math_1.b2SubVV(b2Math_1.b2AddVCrossSV(vB, wB, cp1.rB, b2Math_1.b2Vec2.s_t0), b2Math_1.b2AddVCrossSV(vA, wA, cp1.rA, b2Math_1.b2Vec2.s_t1), dv1);
	                //b2Vec2 dv2 = vB + b2Cross(wB, cp2->rB) - vA - b2Cross(wA, cp2->rA);
	                b2Math_1.b2SubVV(b2Math_1.b2AddVCrossSV(vB, wB, cp2.rB, b2Math_1.b2Vec2.s_t0), b2Math_1.b2AddVCrossSV(vA, wA, cp2.rA, b2Math_1.b2Vec2.s_t1), dv2);
	                // Compute normal velocity
	                //float32 vn1 = b2Dot(dv1, normal);
	                vn1 = b2Math_1.b2DotVV(dv1, normal);
	                //float32 vn2 = b2Dot(dv2, normal);
	                vn2 = b2Math_1.b2DotVV(dv2, normal);
	                //b2Vec2 b;
	                b.x = vn1 - cp1.velocityBias;
	                b.y = vn2 - cp2.velocityBias;
	                // Compute b'
	                //b -= b2Mul(vc->K, a);
	                b.SelfSub(b2Math_1.b2MulMV(vc.K, a, b2Math_1.b2Vec2.s_t0));
	                /*
	                ...
	                */
	                for (;;) {
	                    ...
	                    b2Math_1.b2MulMV(vc.normalMass, b, x).SelfNeg();
	                    if (x.x >= 0 && x.y >= 0) {
	                        // Get the incremental impulse
	                        //b2Vec2 d = x - a;
	                        b2Math_1.b2SubVV(x, a, d);
	                        // Apply incremental impulse
	                        //b2Vec2 P1 = d.x * normal;
	                        b2Math_1.b2MulSV(d.x, normal, P1);
	                        //b2Vec2 P2 = d.y * normal;
	                        b2Math_1.b2MulSV(d.y, normal, P2);
	                        b2Math_1.b2AddVV(P1, P2, P1P2);
	                        //vA -= mA * (P1 + P2);
	                        vA.SelfMulSub(mA, P1P2);
	                        //wA -= iA * (b2Cross(cp1->rA, P1) + b2Cross(cp2->rA, P2));
	                        wA -= iA * (b2Math_1.b2CrossVV(cp1.rA, P1) + b2Math_1.b2CrossVV(cp2.rA, P2));
	                        //vB += mB * (P1 + P2);
	                        vB.SelfMulAdd(mB, P1P2);
	                        //wB += iB * (b2Cross(cp1->rB, P1) + b2Cross(cp2->rB, P2));
	                        wB += iB * (b2Math_1.b2CrossVV(cp1.rB, P1) + b2Math_1.b2CrossVV(cp2.rB, P2));
	                        // Accumulate
	    ...
	    b2ContactSolver.prototype.SolvePositionConstraints = function () {
	        ...
	        for (i = 0, ict = this.m_count; i < ict; ++i) {
	            ...
	            for (j = 0, jct = pointCount; j < jct; ++j) {
	                ...
	                //b2Vec2 rA = point - cA;
	                b2Math_1.b2SubVV(point, cA, rA);
	                //b2Vec2 rB = point - cB;
	                b2Math_1.b2SubVV(point, cB, rB);
	                // Track max constraint error.
	                minSeparation = b2Math_1.b2Min(minSeparation, separation);
	                // Prevent large corrections and allow slop.
	                C = b2Math_1.b2Clamp(b2Settings_1.b2_baumgarte * (separation + b2Settings_1.b2_linearSlop), (-b2Settings_1.b2_maxLinearCorrection), 0);
	                // Compute the effective mass.
	                //float32 rnA = b2Cross(rA, normal);
	                rnA = b2Math_1.b2CrossVV(rA, normal);
	                //float32 rnB = b2Cross(rB, normal);
	                rnB = b2Math_1.b2CrossVV(rB, normal);
	                //float32 K = mA + mB + iA * rnA * rnA + iB * rnB * rnB;
	                K = mA + mB + iA * rnA * rnA + iB * rnB * rnB;
	                // Compute normal impulse
	                impulse = K > 0 ? -C / K : 0;
	                //b2Vec2 P = impulse * normal;
	                b2Math_1.b2MulSV(impulse, normal, P);
	                //cA -= mA * P;
	                cA.SelfMulSub(mA, P);
	                //aA -= iA * b2Cross(rA, P);
	                aA -= iA * b2Math_1.b2CrossVV(rA, P);
	    ...
	    b2ContactSolver.prototype.SolveTOIPositionConstraints = function (toiIndexA, toiIndexB) {
	        ...
	        for (i = 0, ict = this.m_count; i < ict; ++i) {
	            ...
	            for (j = 0, jct = pointCount; j < jct; ++j) {
	                ...
	                minSeparation = b2Math_1.b2Min(minSeparation, separation);
	                // Prevent large corrections and allow slop.
	                C = b2Math_1.b2Clamp(b2Settings_1.b2_toiBaumgarte * (separation + b2Settings_1.b2_linearSlop), (-b2Settings_1.b2_maxLinearCorrection), 0);
	                // Compute the effective mass.
	                //float32 rnA = b2Cross(rA, normal);
	                rnA = b2Math_1.b2CrossVV(rA, normal);
	                //float32 rnB = b2Cross(rB, normal);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	"use strict";
	var b2Settings_1 = __webpack_require__(3);
	var b2BroadPhase_1 = __webpack_require__(34);
	var b2Fixture_1 = __webpack_require__(9);
	var b2Body_1 = __webpack_require__(29);
	var b2Contact_1 = __webpack_require__(16);
	var b2ContactFactory_1 = __webpack_require__(37);
	var b2WorldCallbacks_1 = __webpack_require__(6);
	// Delegate of b2World.
	var b2ContactManager = (function () {
	    ...
	    b2ContactManager.prototype.AddPair = function (proxyUserDataA, proxyUserDataB) {
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(proxyUserDataA instanceof b2Fixture_1.b2FixtureProxy);
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(proxyUserDataB instanceof b2Fixture_1.b2FixtureProxy);
	        }
	    ...
	    b2ContactManager.prototype.Collide = function () {
	        ...
	        while (c) {
	            ...
	            if (c.m_flags & b2Contact_1.b2ContactFlag.e_filterFlag) {
	                ...
	                c.m_flags &= ~b2Contact_1.b2ContactFlag.e_filterFlag;
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	"use strict";
	var b2Collision_1 = __webpack_require__(10);
	var b2DynamicTree_1 = __webpack_require__(35);
	var b2Pair = (function () {
	    function b2Pair() {
	        this.proxyA = null;
	        this.proxyB = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var b2Math_1 = __webpack_require__(2);
	var b2Collision_1 = __webpack_require__(10);
	var b2GrowableStack_1 = __webpack_require__(36);
	...
	var b2DynamicTree = (function () {
	    ...
	    b2DynamicTree.prototype.GetUserData = function (proxy) {
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(proxy != null);
	        }
	    ...
	    b2DynamicTree.prototype.RayCast = function (callback, input) {
	        ...
	        var p1 = input.p1;
	        var p2 = input.p2;
	        var r = b2Math_1.b2SubVV(p2, p1, b2DynamicTree.s_r);
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(r.GetLengthSquared() > 0);
	        }
	        r.Normalize();
	        // v is perpendicular to the segment.
	        var v = b2Math_1.b2CrossOneV(r, b2DynamicTree.s_v);
	        var abs_v = b2Math_1.b2AbsV(v, b2DynamicTree.s_abs_v);
	        ...
	        while (stack.GetCount() > 0) {
	            ...
	            var separation = b2Math_1.b2Abs(b2Math_1.b2DotVV(v, b2Math_1.b2SubVV(p1, c, b2Math_1.b2Vec2.s_t0))) - b2Math_1.b2DotVV(abs_v, h);
	            if (separation > 0) {
	                continue;
	            }
	            if (node.IsLeaf()) {
	    ...
	    b2DynamicTree.prototype.DestroyProxy = function (proxy) {
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(proxy.IsLeaf());
	        }
	    ...
	    b2DynamicTree.prototype.InsertLeaf = function (leaf) {
	        ...
	        while (index != null) {
	            ...
	            child2 = index.child2;
	            if (b2Settings_1.ENABLE_ASSERTS) {
	                b2Settings_1.b2Assert(child1 != null);
	            }
	            if (b2Settings_1.ENABLE_ASSERTS) {
	                b2Settings_1.b2Assert(child2 != null);
	            }
	        ...
	        if (balance > 1) {
	            ...
	            if (C.parent != null) {
	                if (C.parent.child1 == A) {
	                    ...
	                    if (b2Settings_1.ENABLE_ASSERTS) {
	                        b2Settings_1.b2Assert(C.parent.child2 == A);
	                    }
	                    C.parent.child2 = C;
	                }
	            }
	        ...
	        if (balance < -1) {
	            ...
	            if (B.parent != null) {
	                if (B.parent.child1 == A) {
	                    ...
	                    if (b2Settings_1.ENABLE_ASSERTS) {
	                        b2Settings_1.b2Assert(B.parent.child2 == A);
	                    }
	                    B.parent.child2 = B;
	                }
	            }
	    ...
	    b2DynamicTree.prototype.ValidateStructure = function (index) {
	        ...
	        if (index == this.m_root) {
	            if (b2Settings_1.ENABLE_ASSERTS) {
	                b2Settings_1.b2Assert(index.parent == null);
	            }
	        }
	        var node = index;
	        ...
	        if (node.IsLeaf()) {
	            ...
	            if (b2Settings_1.ENABLE_ASSERTS) {
	                b2Settings_1.b2Assert(node.height == 0);
	            }
	            return;
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(child1.parent == index);
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(child2.parent == index);
	        }
	    ...
	    b2DynamicTree.prototype.ValidateMetrics = function (index) {
	        ...
	        var height;
	        height = 1 + b2Math_1.b2Max(height1, height2);
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(node.height == height);
	        }
	        var aabb = b2DynamicTree.s_aabb;
	        aabb.Combine2(child1.aabb, child2.aabb);
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(aabb.lowerBound == node.aabb.lowerBound);
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(aabb.upperBound == node.aabb.upperBound);
	        }
	    ...
	    b2DynamicTree.prototype.Validate = function () {
	        ...
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(this.GetHeight() == this.ComputeHeight());
	        }
	    };
	    b2DynamicTree.prototype.GetMaxBalance = function () {
	        var GetMaxBalanceNode = function (node, maxBalance) {
	            ...
	            if (b2Settings_1.ENABLE_ASSERTS) {
	                b2Settings_1.b2Assert(node.IsLeaf() == false);
	            }
	            var child1 = node.child1;
	            var child2 = node.child2;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var b2Settings_1 = __webpack_require__(3);
	var b2Shape_1 = __webpack_require__(12);
	var b2CircleContact_1 = __webpack_require__(38);
	var b2PolygonAndCircleContact_1 = __webpack_require__(41);
	var b2PolygonContact_1 = __webpack_require__(43);
	var b2EdgeAndCircleContact_1 = __webpack_require__(45);
	var b2EdgeAndPolygonContact_1 = __webpack_require__(48);
	var b2ChainAndCircleContact_1 = __webpack_require__(49);
	var b2ChainAndPolygonContact_1 = __webpack_require__(51);
	...
	var b2ContactFactory = (function () {
	    ...
	    b2ContactFactory.prototype.AddType = function (createFcn, destroyFcn, type1, type2) {
	        {
	            var that = this;
	            var pool = b2Settings_1.b2MakeArray(256, function (i) { return createFcn(that.m_allocator); }); // TODO: b2Settings
	    ...
	    b2ContactFactory.prototype.Create = function (fixtureA, indexA, fixtureB, indexB) {
	        ...
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(0 <= type1 && type1 < b2Shape_1.b2ShapeType.e_shapeTypeCount);
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(0 <= type2 && type2 < b2Shape_1.b2ShapeType.e_shapeTypeCount);
	        }
	    ...
	    b2ContactFactory.prototype.Destroy = function (contact) {
	        ...
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(0 <= typeA && typeB < b2Shape_1.b2ShapeType.e_shapeTypeCount);
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(0 <= typeA && typeB < b2Shape_1.b2ShapeType.e_shapeTypeCount);
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var b2CircleShape_1 = __webpack_require__(39);
	var b2Contact_1 = __webpack_require__(16);
	var b2CollideCircle_1 = __webpack_require__(40);
	var b2CircleContact = (function (_super) {
	    ...
	    b2CircleContact.prototype.Evaluate = function (manifold, xfA, xfB) {
	        ...
	        var shapeB = this.m_fixtureB.GetShape();
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(shapeA instanceof b2CircleShape_1.b2CircleShape);
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(shapeB instanceof b2CircleShape_1.b2CircleShape);
	        }
	...
	*/
	...
	var b2CircleShape = (function (_super) {
	    ...
	    function b2CircleShape(radius) {
	        ...
	        _super.call(this, b2Shape_1.b2ShapeType.e_circleShape, radius);
	    ...
	    b2CircleShape.prototype.Copy = function (other) {
	        ...
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(other instanceof b2CircleShape);
	        }
	    ...
	    b2CircleShape.prototype.TestPoint = function (transform, p) {
	        var center = b2Math_1.b2MulXV(transform, this.m_p, b2CircleShape.TestPoint_s_center);
	        var d = b2Math_1.b2SubVV(p, center, b2CircleShape.TestPoint_s_d);
	        return b2Math_1.b2DotVV(d, d) <= b2Math_1.b2Sq(this.m_radius);
	    };
	    b2CircleShape.prototype.RayCast = function (output, input, transform, childIndex) {
	        var position = b2Math_1.b2MulXV(transform, this.m_p, b2CircleShape.RayCast_s_position);
	        var s = b2Math_1.b2SubVV(input.p1, position, b2CircleShape.RayCast_s_s);
	        var b = b2Math_1.b2DotVV(s, s) - b2Math_1.b2Sq(this.m_radius);
	        // Solve quadratic equation.
	        var r = b2Math_1.b2SubVV(input.p2, input.p1, b2CircleShape.RayCast_s_r);
	        var c = b2Math_1.b2DotVV(s, r);
	        var rr = b2Math_1.b2DotVV(r, r);
	        var sigma = c * c - rr * b;
	        ...
	        if (0 <= a && a <= input.maxFraction * rr) {
	            a /= rr;
	            output.fraction = a;
	            b2Math_1.b2AddVMulSV(s, a, r, output.normal).SelfNormalize();
	            return true;
	        }
	        return false;
	    };
	    b2CircleShape.prototype.ComputeAABB = function (aabb, transform, childIndex) {
	        var p = b2Math_1.b2MulXV(transform, this.m_p, b2CircleShape.ComputeAABB_s_p);
	    ...
	    b2CircleShape.prototype.ComputeMass = function (massData, density) {
	        ...
	        massData.I = massData.mass * (0.5 * radius_sq + b2Math_1.b2DotVV(this.m_p, this.m_p));
	    };
	    ...
	    b2CircleShape.prototype.ComputeSubmergedArea = function (normal, offset, xf, c) {
	        var p = b2Math_1.b2MulXV(xf, this.m_p, new b2Math_1.b2Vec2());
	        var l = (-(b2Math_1.b2DotVV(normal, p) - offset));
	    ...
	    b2CircleShape.prototype.Dump = function () {
	        b2Settings_1.b2Log("    var shape: b2CircleShape = new b2CircleShape();\n");
	        b2Settings_1.b2Log("    shape.m_radius = %.15f;\n", this.m_radius);
	        b2Settings_1.b2Log("    shape.m_p.SetXY(%.15f, %.15f);\n", this.m_p.x, this.m_p.y);
	    };
	    /// Implement b2Shape.
...
/***/ function(module, exports, __webpack_require__) {
	...
	function b2CollideCircles(manifold, circleA, xfA, circleB, xfB) {
	    ...
	    var pA = b2Math_1.b2MulXV(xfA, circleA.m_p, b2CollideCircles_s_pA);
	    var pB = b2Math_1.b2MulXV(xfB, circleB.m_p, b2CollideCircles_s_pB);
	    var distSqr = b2Math_1.b2DistanceSquaredVV(pA, pB);
	...
	function b2CollidePolygonAndCircle(manifold, polygonA, xfA, circleB, xfB) {
	    ...
	    var c = b2Math_1.b2MulXV(xfB, circleB.m_p, b2CollidePolygonAndCircle_s_c);
	    var cLocal = b2Math_1.b2MulTXV(xfA, c, b2CollidePolygonAndCircle_s_cLocal);
	    ...
	    for (var i = 0; i < vertexCount; ++i) {
	        var s = b2Math_1.b2DotVV(normals[i], b2Math_1.b2SubVV(cLocal, vertices[i], b2Math_1.b2Vec2.s_t0));
	        if (s > radius) {
	            // Early out.
	            return;
	        }
	    ...
	    if (separation < b2Settings_1.b2_epsilon) {
	        ...
	        b2Math_1.b2MidVV(v1, v2, manifold.localPoint);
	        manifold.points[0].localPoint.Copy(circleB.m_p);
	        manifold.points[0].id.key = 0;
	        return;
	    }
	    // Compute barycentric coordinates
	    var u1 = b2Math_1.b2DotVV(b2Math_1.b2SubVV(cLocal, v1, b2Math_1.b2Vec2.s_t0), b2Math_1.b2SubVV(v2, v1, b2Math_1.b2Vec2.s_t1));
	    var u2 = b2Math_1.b2DotVV(b2Math_1.b2SubVV(cLocal, v2, b2Math_1.b2Vec2.s_t0), b2Math_1.b2SubVV(v1, v2, b2Math_1.b2Vec2.s_t1));
	    if (u1 <= 0) {
	        if (b2Math_1.b2DistanceSquaredVV(cLocal, v1) > radius * radius) {
	            return;
	        }
	        manifold.pointCount = 1;
	        manifold.type = b2Collision_1.b2ManifoldType.e_faceA;
	        b2Math_1.b2SubVV(cLocal, v1, manifold.localNormal).SelfNormalize();
	        manifold.localPoint.Copy(v1);
	        manifold.points[0].localPoint.Copy(circleB.m_p);
	        manifold.points[0].id.key = 0;
	    }
	    else if (u2 <= 0) {
	        if (b2Math_1.b2DistanceSquaredVV(cLocal, v2) > radius * radius) {
	            return;
	        }
	        manifold.pointCount = 1;
	        manifold.type = b2Collision_1.b2ManifoldType.e_faceA;
	        b2Math_1.b2SubVV(cLocal, v2, manifold.localNormal).SelfNormalize();
	        manifold.localPoint.Copy(v2);
	        manifold.points[0].localPoint.Copy(circleB.m_p);
	        manifold.points[0].id.key = 0;
	    }
	    else {
	        var faceCenter = b2Math_1.b2MidVV(v1, v2, b2CollidePolygonAndCircle_s_faceCenter);
	        separation = b2Math_1.b2DotVV(b2Math_1.b2SubVV(cLocal, faceCenter, b2Math_1.b2Vec2.s_t1), normals[vertIndex1]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var b2Settings_1 = __webpack_require__(3);
	var b2PolygonShape_1 = __webpack_require__(42);
	var b2Contact_1 = __webpack_require__(16);
	var b2CollideCircle_1 = __webpack_require__(40);
	var b2Shape_1 = __webpack_require__(12);
	var b2CircleShape_1 = __webpack_require__(39);
	var b2PolygonAndCircleContact = (function (_super) {
	    ...
	    b2PolygonAndCircleContact.prototype.Reset = function (fixtureA, indexA, fixtureB, indexB) {
	        _super.prototype.Reset.call(this, fixtureA, indexA, fixtureB, indexB);
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(fixtureA.GetType() == b2Shape_1.b2ShapeType.e_polygonShape);
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(fixtureB.GetType() == b2Shape_1.b2ShapeType.e_circleShape);
	        }
	    };
	    b2PolygonAndCircleContact.prototype.Evaluate = function (manifold, xfA, xfB) {
	        ...
	        var shapeB = this.m_fixtureB.GetShape();
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(shapeA instanceof b2PolygonShape_1.b2PolygonShape);
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(shapeB instanceof b2CircleShape_1.b2CircleShape);
	        }
	...
	*/
	...
	var b2PolygonShape = (function (_super) {
	    ...
	    function b2PolygonShape() {
	        _super.call(this, b2Shape_1.b2ShapeType.e_polygonShape, b2Settings_1.b2_polygonRadius);
	    ...
	    b2PolygonShape.prototype.Copy = function (other) {
	        _super.prototype.Copy.call(this, other);
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(other instanceof b2PolygonShape);
	        }
	    ...
	    b2PolygonShape.prototype.SetAsVector = function (vertices, count) {
	        ...
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(3 <= count && count <= b2Settings_1.b2_maxPolygonVertices);
	        }
	        if (count < 3) {
	        ...
	        for (;;) {
	            ...
	            for (var j = 1; j < n; ++j) {
	                ...
	                var r = b2Math_1.b2SubVV(ps[ie], ps[hull[m]], b2PolygonShape.SetAsVector_s_r);
	                var v = b2Math_1.b2SubVV(ps[j], ps[hull[m]], b2PolygonShape.SetAsVector_s_v);
	                var c = b2Math_1.b2CrossVV(r, v);
	                if (c < 0) {
	                    ie = j;
	                }
	                // Collinearity check
	        ...
	        for (var i = 0, ict = m; i < ict; ++i) {
	            ...
	            var edge = b2Math_1.b2SubVV(vertexi2, vertexi1, b2Math_1.b2Vec2.s_t0); // edge uses s_t0
	            if (b2Settings_1.ENABLE_ASSERTS) {
	                b2Settings_1.b2Assert(edge.GetLengthSquared() > b2Settings_1.b2_epsilon_sq);
	            }
	            b2Math_1.b2CrossVOne(edge, this.m_normals[i]).SelfNormalize();
	        }
	    ...
	    b2PolygonShape.prototype.SetAsOrientedBox = function (hx, hy, center, angle) {
	        ...
	        for (var i = 0, ict = this.m_count; i < ict; ++i) {
	            b2Math_1.b2MulXV(xf, this.m_vertices[i], this.m_vertices[i]);
	            b2Math_1.b2MulRV(xf.q, this.m_normals[i], this.m_normals[i]);
	        }
	        return this;
	    };
	    b2PolygonShape.prototype.TestPoint = function (xf, p) {
	        var pLocal = b2Math_1.b2MulTXV(xf, p, b2PolygonShape.TestPoint_s_pLocal);
	        for (var i = 0, ict = this.m_count; i < ict; ++i) {
	            var dot = b2Math_1.b2DotVV(this.m_normals[i], b2Math_1.b2SubVV(pLocal, this.m_vertices[i], b2Math_1.b2Vec2.s_t0));
	            if (dot > 0) {
	                return false;
	            }
	        }
	    ...
	    b2PolygonShape.prototype.RayCast = function (output, input, xf, childIndex) {
	        ...
	        var p1 = b2Math_1.b2MulTXV(xf, input.p1, b2PolygonShape.RayCast_s_p1);
	        var p2 = b2Math_1.b2MulTXV(xf, input.p2, b2PolygonShape.RayCast_s_p2);
	        var d = b2Math_1.b2SubVV(p2, p1, b2PolygonShape.RayCast_s_d);
	        ...
	        for (var i = 0, ict = this.m_count; i < ict; ++i) {
	            ...
	            var numerator = b2Math_1.b2DotVV(this.m_normals[i], b2Math_1.b2SubVV(this.m_vertices[i], p1, b2Math_1.b2Vec2.s_t0));
	            var denominator = b2Math_1.b2DotVV(this.m_normals[i], d);
	            if (denominator == 0) {
	                if (numerator < 0) {
	                    return false;
	                }
	        ...
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(0 <= lower && lower <= input.maxFraction);
	        }
	        if (index >= 0) {
	            output.fraction = lower;
	            b2Math_1.b2MulRV(xf.q, this.m_normals[index], output.normal);
	            return true;
	        }
	        return false;
	    };
	    b2PolygonShape.prototype.ComputeAABB = function (aabb, xf, childIndex) {
	        var lower = b2Math_1.b2MulXV(xf, this.m_vertices[0], aabb.lowerBound);
	        var upper = aabb.upperBound.Copy(lower);
	        for (var i = 0, ict = this.m_count; i < ict; ++i) {
	            var v = b2Math_1.b2MulXV(xf, this.m_vertices[i], b2PolygonShape.ComputeAABB_s_v);
	            b2Math_1.b2MinV(v, lower, lower);
	            b2Math_1.b2MaxV(v, upper, upper);
	        }
	        var r = this.m_radius;
	        lower.SelfSubXY(r, r);
	        upper.SelfAddXY(r, r);
	    ...
	    b2PolygonShape.prototype.ComputeMass = function (massData, density) {
	        ...
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(this.m_count >= 3);
	        }
	        ...
	        for (var i = 0, ict = this.m_count; i < ict; ++i) {
	            // Triangle vertices.
	            var e1 = b2Math_1.b2SubVV(this.m_vertices[i], s, b2PolygonShape.ComputeMass_s_e1);
	            var e2 = b2Math_1.b2SubVV(this.m_vertices[(i + 1) % ict], s, b2PolygonShape.ComputeMass_s_e2);
	            var D = b2Math_1.b2CrossVV(e1, e2);
	            var triangleArea = 0.5 * D;
	            area += triangleArea;
	            // Area weighted centroid
	            center.SelfAdd(b2Math_1.b2MulSV(triangleArea * k_inv3, b2Math_1.b2AddVV(e1, e2, b2Math_1.b2Vec2.s_t0), b2Math_1.b2Vec2.s_t1));
	            var ex1 = e1.x;
	            var ey1 = e1.y;
	            var ex2 = e2.x;
	            var ey2 = e2.y;
	        ...
	        // Center of mass
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(area > b2Settings_1.b2_epsilon);
	        }
	        center.SelfMul(1 / area);
	        b2Math_1.b2AddVV(center, s, massData.center);
	        // Inertia tensor relative to the local origin (point s).
	        massData.I = density * I;
	        // Shift to center of mass then to original body origin.
	        massData.I += massData.mass * (b2Math_1.b2DotVV(massData.center, massData.center) - b2Math_1.b2DotVV(center, center));
	    };
	    b2PolygonShape.prototype.Validate = function () {
	        for (var i = 0; i < this.m_count; ++i) {
	            ...
	            var e = b2Math_1.b2SubVV(this.m_vertices[i2], p, b2PolygonShape.Validate_s_e);
	            for (var j = 0; j < this.m_count; ++j) {
	                if (j == i1 || j == i2) {
	                    continue;
	                }
	                var v = b2Math_1.b2SubVV(this.m_vertices[j], p, b2PolygonShape.Validate_s_v);
	                var c = b2Math_1.b2CrossVV(e, v);
	                if (c < 0) {
	                    return false;
	                }
	            }
	    ...
	    b2PolygonShape.prototype.ComputeSubmergedArea = function (normal, offset, xf, c) {
	        ...
	        var normalL = b2Math_1.b2MulTRV(xf.q, normal, b2PolygonShape.ComputeSubmergedArea_s_normalL);
	        var offsetL = offset - b2Math_1.b2DotVV(normal, xf.p);
	        ...
	        for (var i = 0, ict = this.m_count; i < ict; ++i) {
	            depths[i] = b2Math_1.b2DotVV(normalL, this.m_vertices[i]) - offsetL;
	            var isSubmerged = depths[i] < (-b2Settings_1.b2_epsilon);
	            if (i > 0) {
	                if (isSubmerged) {
	                    if (!lastSubmerged) {
	                        intoIndex = i - 1;
	        ...
	        switch (diveCount) {
	            case 0:
	                if (lastSubmerged) {
	                    ...
	                    b2Math_1.b2MulXV(xf, md.center, c);
	                    return md.mass;
	                }
	                else {
	                    //Completely dry
	        ...
	        center.SelfMul(1 / area);
	        b2Math_1.b2MulXV(xf, center, c);
	        return area;
	    };
	    b2PolygonShape.prototype.Dump = function () {
	        b2Settings_1.b2Log("    var shape: b2PolygonShape = new b2PolygonShape();\n");
	        b2Settings_1.b2Log("    var vs: b2Vec2[] = b2Vec2.MakeArray(%d);\n", b2Settings_1.b2_maxPolygonVertices);
	        for (var i = 0; i < this.m_count; ++i) {
	            b2Settings_1.b2Log("    vs[%d].SetXY(%.15f, %.15f);\n", i, this.m_vertices[i].x, this.m_vertices[i].y);
	        }
	        b2Settings_1.b2Log("    shape.SetAsVector(vs, %d);\n", this.m_count);
	    };
	    b2PolygonShape.ComputeCentroid = function (vs, count, out) {
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(count >= 3);
	        }
	        var c = out;
	        c.SetZero();
	        var area = 0;
	        ...
	        */
	        ...
	        for (var i = 0; i < count; ++i) {
	            ...
	            var p2 = vs[i];
	            var p3 = vs[(i + 1) % count];
	            var e1 = b2Math_1.b2SubVV(p2, p1, b2PolygonShape.ComputeCentroid_s_e1);
	            var e2 = b2Math_1.b2SubVV(p3, p1, b2PolygonShape.ComputeCentroid_s_e2);
	            var D = b2Math_1.b2CrossVV(e1, e2);
	            var triangleArea = 0.5 * D;
	            area += triangleArea;
	            // Area weighted centroid
	    ...
	    b2PolygonShape.SetAsVector_s_ps = b2Math_1.b2Vec2.MakeArray(b2Settings_1.b2_maxPolygonVertices);
	    b2PolygonShape.SetAsVector_s_hull = b2Settings_1.b2MakeNumberArray(b2Settings_1.b2_maxPolygonVertices);
	    b2PolygonShape.SetAsVector_s_r = new b2Math_1.b2Vec2();
	    b2PolygonShape.SetAsVector_s_v = new b2Math_1.b2Vec2();
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var b2PolygonShape_1 = __webpack_require__(42);
	var b2Contact_1 = __webpack_require__(16);
	var b2CollidePolygon_1 = __webpack_require__(44);
	var b2PolygonContact = (function (_super) {
	    ...
	    b2PolygonContact.prototype.Evaluate = function (manifold, xfA, xfB) {
	        ...
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(shapeB instanceof b2PolygonShape_1.b2PolygonShape);
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function b2EdgeSeparation(poly1, xf1, edge1, poly2, xf2) {
	    ...
	    if (b2Settings_1.ENABLE_ASSERTS) {
	        b2Settings_1.b2Assert(0 <= edge1 && edge1 < count1);
	    }
	    // Convert normal from poly1's frame into poly2's frame.
	    var normal1World = b2Math_1.b2MulRV(xf1.q, normals1[edge1], b2EdgeSeparation_s_normal1World);
	    var normal1 = b2Math_1.b2MulTRV(xf2.q, normal1World, b2EdgeSeparation_s_normal1);
	    // Find support vertex on poly2 for -normal.
	    var index = 0;
	    var minDot = b2Settings_1.b2_maxFloat;
	    for (var i = 0; i < count2; ++i) {
	        var dot = b2Math_1.b2DotVV(vertices2[i], normal1);
	        if (dot < minDot) {
	            minDot = dot;
	            index = i;
	        }
	    }
	    var v1 = b2Math_1.b2MulXV(xf1, vertices1[edge1], b2EdgeSeparation_s_v1);
	    var v2 = b2Math_1.b2MulXV(xf2, vertices2[index], b2EdgeSeparation_s_v2);
	    var separation = b2Math_1.b2DotVV(b2Math_1.b2SubVV(v2, v1, b2Math_1.b2Vec2.s_t0), normal1World);
	    return separation;
	}
	exports.b2EdgeSeparation = b2EdgeSeparation;
	...
	function b2FindMaxSeparation(edgeIndex, poly1, xf1, poly2, xf2) {
	    ...
	    var d = b2Math_1.b2SubVV(b2Math_1.b2MulXV(xf2, poly2.m_centroid, b2Math_1.b2Vec2.s_t0), b2Math_1.b2MulXV(xf1, poly1.m_centroid, b2Math_1.b2Vec2.s_t1), b2FindMaxSeparation_s_d);
	    var dLocal1 = b2Math_1.b2MulTRV(xf1.q, d, b2FindMaxSeparation_s_dLocal1);
	    // Find edge normal on poly1 that has the largest projection onto d.
	    var edge = 0;
	    var maxDot = (-b2Settings_1.b2_maxFloat);
	    for (var i = 0; i < count1; ++i) {
	        var dot = b2Math_1.b2DotVV(normals1[i], dLocal1);
	        if (dot > maxDot) {
	            maxDot = dot;
	            edge = i;
	        }
	...
	exports.b2FindMaxSeparation = b2FindMaxSeparation;
	...
	function b2FindIncidentEdge(c, poly1, xf1, edge1, poly2, xf2) {
	    ...
	    var normal1 = b2Math_1.b2MulTRV(xf2.q, b2Math_1.b2MulRV(xf1.q, normals1[edge1], b2Math_1.b2Vec2.s_t0), b2FindIncidentEdge_s_normal1);
	    // Find the incident edge on poly2.
	    var index = 0;
	    var minDot = b2Settings_1.b2_maxFloat;
	    for (var i = 0; i < count2; ++i) {
	        var dot = b2Math_1.b2DotVV(normal1, normals2[i]);
	        if (dot < minDot) {
	            minDot = dot;
	            index = i;
	        }
	    ...
	    var i2 = (i1 + 1) % count2;
	    var c0 = c[0];
	    b2Math_1.b2MulXV(xf2, vertices2[i1], c0.v);
	    var cf0 = c0.id.cf;
	    cf0.indexA = edge1;
	    cf0.indexB = i1;
	    ...
	    var c1 = c[1];
	    b2Math_1.b2MulXV(xf2, vertices2[i2], c1.v);
	    var cf1 = c1.id.cf;
	    cf1.indexA = edge1;
	    cf1.indexB = i2;
	...
	exports.b2FindIncidentEdge = b2FindIncidentEdge;
	var b2CollidePolygons_s_incidentEdge = b2Collision_1.b2ClipVertex.MakeArray(2);
	var b2CollidePolygons_s_clipPoints1 = b2Collision_1.b2ClipVertex.MakeArray(2);
	var b2CollidePolygons_s_clipPoints2 = b2Collision_1.b2ClipVertex.MakeArray(2);
	var b2CollidePolygons_s_edgeA = b2Settings_1.b2MakeNumberArray(1);
	var b2CollidePolygons_s_edgeB = b2Settings_1.b2MakeNumberArray(1);
	...
	function b2CollidePolygons(manifold, polyA, xfA, polyB, xfB) {
	    ...
	    if (separationB > k_relativeTol * separationA + k_absoluteTol) {
	        ...
	        xf2 = xfA;
	        edge1 = edgeB[0];
	        manifold.type = b2Collision_1.b2ManifoldType.e_faceB;
	        flip = 1;
	    }
	    else {
	        poly1 = polyA;
	    ...
	    var localTangent = b2Math_1.b2SubVV(local_v12, local_v11, b2CollidePolygons_s_localTangent);
	    localTangent.Normalize();
	    var localNormal = b2Math_1.b2CrossVOne(localTangent, b2CollidePolygons_s_localNormal);
	    var planePoint = b2Math_1.b2MidVV(local_v11, local_v12, b2CollidePolygons_s_planePoint);
	    var tangent = b2Math_1.b2MulRV(xf1.q, localTangent, b2CollidePolygons_s_tangent);
	    var normal = b2Math_1.b2CrossVOne(tangent, b2CollidePolygons_s_normal);
	    var v11 = b2Math_1.b2MulXV(xf1, local_v11, b2CollidePolygons_s_v11);
	    var v12 = b2Math_1.b2MulXV(xf1, local_v12, b2CollidePolygons_s_v12);
	    // Face offset.
	    var frontOffset = b2Math_1.b2DotVV(normal, v11);
	    // Side offsets, extended by polytope skin thickness.
	    var sideOffset1 = -b2Math_1.b2DotVV(tangent, v11) + totalRadius;
	    var sideOffset2 = b2Math_1.b2DotVV(tangent, v12) + totalRadius;
	    // Clip incident edge against extruded edge1 side edges.
	    var clipPoints1 = b2CollidePolygons_s_clipPoints1;
	    var clipPoints2 = b2CollidePolygons_s_clipPoints2;
	    var np;
	    // Clip to box side 1
	    var ntangent = b2Math_1.b2NegV(tangent, b2CollidePolygons_s_ntangent);
	    ...
	    for (var i = 0; i < b2Settings_1.b2_maxManifoldPoints; ++i) {
	        ...
	        var separation = b2Math_1.b2DotVV(normal, cv.v) - frontOffset;
	        if (separation <= totalRadius) {
	            var cp = manifold.points[pointCount];
	            b2Math_1.b2MulTXV(xf2, cv.v, cp.localPoint);
	            cp.id.Copy(cv.id);
	            if (flip) {
	                // Swap features
	                var cf = cp.id.cf;
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var b2CircleShape_1 = __webpack_require__(39);
	var b2Contact_1 = __webpack_require__(16);
	var b2CollideEdge_1 = __webpack_require__(46);
	var b2Shape_1 = __webpack_require__(12);
	var b2EdgeShape_1 = __webpack_require__(47);
	var b2EdgeAndCircleContact = (function (_super) {
	    ...
	    b2EdgeAndCircleContact.prototype.Reset = function (fixtureA, indexA, fixtureB, indexB) {
	        _super.prototype.Reset.call(this, fixtureA, indexA, fixtureB, indexB);
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(fixtureA.GetType() == b2Shape_1.b2ShapeType.e_edgeShape);
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(fixtureB.GetType() == b2Shape_1.b2ShapeType.e_circleShape);
	        }
	    ...
	    b2EdgeAndCircleContact.prototype.Evaluate = function (manifold, xfA, xfB) {
	        ...
	        var shapeB = this.m_fixtureB.GetShape();
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(shapeA instanceof b2EdgeShape_1.b2EdgeShape);
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(shapeB instanceof b2CircleShape_1.b2CircleShape);
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function b2CollideEdgeAndCircle(manifold, edgeA, xfA, circleB, xfB) {
	    ...
	    var Q = b2Math_1.b2MulTXV(xfA, b2Math_1.b2MulXV(xfB, circleB.m_p, b2Math_1.b2Vec2.s_t0), b2CollideEdgeAndCircle_s_Q);
	    var A = edgeA.m_vertex1;
	    var B = edgeA.m_vertex2;
	    var e = b2Math_1.b2SubVV(B, A, b2CollideEdgeAndCircle_s_e);
	    // Barycentric coordinates
	    var u = b2Math_1.b2DotVV(e, b2Math_1.b2SubVV(B, Q, b2Math_1.b2Vec2.s_t0));
	    var v = b2Math_1.b2DotVV(e, b2Math_1.b2SubVV(Q, A, b2Math_1.b2Vec2.s_t0));
	    ...
	    if (v <= 0) {
	        var P = A;
	        var d = b2Math_1.b2SubVV(Q, P, b2CollideEdgeAndCircle_s_d);
	        var dd = b2Math_1.b2DotVV(d, d);
	        if (dd > radius * radius) {
	            return;
	        }
	        ...
	        if (edgeA.m_hasVertex0) {
	            ...
	            var B1 = A;
	            var e1 = b2Math_1.b2SubVV(B1, A1, b2CollideEdgeAndCircle_s_e1);
	            var u1 = b2Math_1.b2DotVV(e1, b2Math_1.b2SubVV(B1, Q, b2Math_1.b2Vec2.s_t0));
	    ...
	    if (u <= 0) {
	        ...
	        if (edgeA.m_hasVertex3) {
	            ...
	            var A2 = B;
	            var e2 = b2Math_1.b2SubVV(B2, A2, b2CollideEdgeAndCircle_s_e2);
	            var v2 = b2Math_1.b2DotVV(e2, b2Math_1.b2SubVV(Q, A2, b2Math_1.b2Vec2.s_t0));
	    ...
	    // Region AB
	    var den = b2Math_1.b2DotVV(e, e);
	    if (b2Settings_1.ENABLE_ASSERTS) {
	        b2Settings_1.b2Assert(den > 0);
	    }
	    ...
	    if (b2Math_1.b2DotVV(n, b2Math_1.b2SubVV(Q, A, b2Math_1.b2Vec2.s_t0)) < 0) {
	        n.SetXY(-n.x, -n.y);
	    }
	    n.Normalize();
	    id.cf.indexA = 0;
	...
	})(exports.b2EPAxisType || (exports.b2EPAxisType = {}));
	var b2EPAxisType = exports.b2EPAxisType;
	...
	exports.b2TempPolygon = b2TempPolygon;
	...
	exports.b2ReferenceFace = b2ReferenceFace;
	...
	})(exports.b2EPColliderVertexType || (exports.b2EPColliderVertexType = {}));
	var b2EPColliderVertexType = exports.b2EPColliderVertexType;
	var b2EPCollider = (function () {
	    ...
	    b2EPCollider.prototype.Collide = function (manifold, edgeA, xfA, polygonB, xfB) {
	        b2Math_1.b2MulTXX(xfA, xfB, this.m_xf);
	        b2Math_1.b2MulXV(this.m_xf, polygonB.m_centroid, this.m_centroidB);
	        ...
	        var edge1 = b2Math_1.b2SubVV(this.m_v2, this.m_v1, b2EPCollider.s_edge1);
	        edge1.Normalize();
	        this.m_normal1.SetXY(edge1.y, -edge1.x);
	        var offset1 = b2Math_1.b2DotVV(this.m_normal1, b2Math_1.b2SubVV(this.m_centroidB, this.m_v1, b2Math_1.b2Vec2.s_t0));
	        var offset0 = 0;
	        var offset2 = 0;
	        var convex1 = false;
	        var convex2 = false;
	        ...
	        if (hasVertex0) {
	            var edge0 = b2Math_1.b2SubVV(this.m_v1, this.m_v0, b2EPCollider.s_edge0);
	            edge0.Normalize();
	            this.m_normal0.SetXY(edge0.y, -edge0.x);
	            convex1 = b2Math_1.b2CrossVV(edge0, edge1) >= 0;
	            offset0 = b2Math_1.b2DotVV(this.m_normal0, b2Math_1.b2SubVV(this.m_centroidB, this.m_v0, b2Math_1.b2Vec2.s_t0));
	        }
	        // Is there a following edge?
	        if (hasVertex3) {
	            var edge2 = b2Math_1.b2SubVV(this.m_v3, this.m_v2, b2EPCollider.s_edge2);
	            edge2.Normalize();
	            this.m_normal2.SetXY(edge2.y, -edge2.x);
	            convex2 = b2Math_1.b2CrossVV(edge1, edge2) > 0;
	            offset2 = b2Math_1.b2DotVV(this.m_normal2, b2Math_1.b2SubVV(this.m_centroidB, this.m_v2, b2Math_1.b2Vec2.s_t0));
	        }
	        ...
	        for (var i = 0, ict = polygonB.m_count; i < ict; ++i) {
	            b2Math_1.b2MulXV(this.m_xf, polygonB.m_vertices[i], this.m_polygonB.vertices[i]);
	            b2Math_1.b2MulRV(this.m_xf.q, polygonB.m_normals[i], this.m_polygonB.normals[i]);
	        }
	        ...
	        if (primaryAxis.type == b2EPAxisType.e_edgeA) {
	            ...
	            var bestIndex = 0;
	            var bestValue = b2Math_1.b2DotVV(this.m_normal, this.m_polygonB.normals[0]);
	            for (var i = 1, ict = this.m_polygonB.count; i < ict; ++i) {
	                var value = b2Math_1.b2DotVV(this.m_normal, this.m_polygonB.normals[i]);
	                if (value < bestValue) {
	                    bestValue = value;
	                    bestIndex = i;
	                }
	        ...
	        rf.sideOffset1 = b2Math_1.b2DotVV(rf.sideNormal1, rf.v1);
	        rf.sideOffset2 = b2Math_1.b2DotVV(rf.sideNormal2, rf.v2);
	        // Clip incident edge against extruded edge1 side edges.
	        var clipPoints1 = b2EPCollider.s_clipPoints1;
	        var clipPoints2 = b2EPCollider.s_clipPoints2;
	        var np = 0;
	        // Clip to box side 1
	        np = b2Collision_1.b2ClipSegmentToLine(clipPoints1, ie, rf.sideNormal1, rf.sideOffset1, rf.i1);
	        if (np < b2Settings_1.b2_maxManifoldPoints) {
	            return;
	        }
	        // Clip to negative box side 1
	        np = b2Collision_1.b2ClipSegmentToLine(clipPoints2, clipPoints1, rf.sideNormal2, rf.sideOffset2, rf.i2);
	        if (np < b2Settings_1.b2_maxManifoldPoints) {
	            return;
	        }
	        // Now clipPoints2 contains the clipped points.
	        ...
	        for (var i = 0, ict = b2Settings_1.b2_maxManifoldPoints; i < ict; ++i) {
	            var separation;
	            separation = b2Math_1.b2DotVV(rf.normal, b2Math_1.b2SubVV(clipPoints2[i].v, rf.v1, b2Math_1.b2Vec2.s_t0));
	            if (separation <= this.m_radius) {
	                var cp = manifold.points[pointCount];
	                if (primaryAxis.type == b2EPAxisType.e_edgeA) {
	                    b2Math_1.b2MulTXV(this.m_xf, clipPoints2[i].v, cp.localPoint);
	    ...
	    b2EPCollider.prototype.ComputeEdgeSeparation = function (out) {
	        ...
	        for (var i = 0, ict = this.m_polygonB.count; i < ict; ++i) {
	            var s = b2Math_1.b2DotVV(this.m_normal, b2Math_1.b2SubVV(this.m_polygonB.vertices[i], this.m_v1, b2Math_1.b2Vec2.s_t0));
	    ...
	    b2EPCollider.prototype.ComputePolygonSeparation = function (out) {
	        ...
	        for (var i = 0, ict = this.m_polygonB.count; i < ict; ++i) {
	            var n = b2Math_1.b2NegV(this.m_polygonB.normals[i], b2EPCollider.s_n);
	            var s1 = b2Math_1.b2DotVV(n, b2Math_1.b2SubVV(this.m_polygonB.vertices[i], this.m_v1, b2Math_1.b2Vec2.s_t0));
	            var s2 = b2Math_1.b2DotVV(n, b2Math_1.b2SubVV(this.m_polygonB.vertices[i], this.m_v2, b2Math_1.b2Vec2.s_t0));
	            ...
	            // Adjacency
	            if (b2Math_1.b2DotVV(n, perp) >= 0) {
	                if (b2Math_1.b2DotVV(b2Math_1.b2SubVV(n, this.m_upperLimit, b2Math_1.b2Vec2.s_t0), this.m_normal) < -b2Settings_1.b2_angularSlop) {
	                    continue;
	                }
	            }
	            else {
	                if (b2Math_1.b2DotVV(b2Math_1.b2SubVV(n, this.m_lowerLimit, b2Math_1.b2Vec2.s_t0), this.m_normal) < -b2Settings_1.b2_angularSlop) {
	                    continue;
	                }
	            }
	            if (s > axis.separation) {
	    ...
	    b2EPCollider.s_ie = b2Collision_1.b2ClipVertex.MakeArray(2);
	    b2EPCollider.s_rf = new b2ReferenceFace();
	    b2EPCollider.s_clipPoints1 = b2Collision_1.b2ClipVertex.MakeArray(2);
	    b2EPCollider.s_clipPoints2 = b2Collision_1.b2ClipVertex.MakeArray(2);
	...
	exports.b2EPCollider = b2EPCollider;
	...
	*/
	...
	var b2EdgeShape = (function (_super) {
	    ...
	    function b2EdgeShape() {
	        _super.call(this, b2Shape_1.b2ShapeType.e_edgeShape, b2Settings_1.b2_polygonRadius);
	    ...
	    b2EdgeShape.prototype.Copy = function (other) {
	        _super.prototype.Copy.call(this, other);
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(other instanceof b2EdgeShape);
	        }
	    ...
	    b2EdgeShape.prototype.RayCast = function (output, input, xf, childIndex) {
	        ...
	        var p1 = b2Math_1.b2MulTXV(xf, input.p1, b2EdgeShape.RayCast_s_p1);
	        var p2 = b2Math_1.b2MulTXV(xf, input.p2, b2EdgeShape.RayCast_s_p2);
	        var d = b2Math_1.b2SubVV(p2, p1, b2EdgeShape.RayCast_s_d);
	        var v1 = this.m_vertex1;
	        var v2 = this.m_vertex2;
	        var e = b2Math_1.b2SubVV(v2, v1, b2EdgeShape.RayCast_s_e);
	        var normal = output.normal.SetXY(e.y, -e.x).SelfNormalize();
	        // q = p1 + t * d
	        // dot(normal, q - v1) = 0
	        // dot(normal, p1 - v1) + t * dot(normal, d) = 0
	        var numerator = b2Math_1.b2DotVV(normal, b2Math_1.b2SubVV(v1, p1, b2Math_1.b2Vec2.s_t0));
	        var denominator = b2Math_1.b2DotVV(normal, d);
	        if (denominator == 0) {
	            return false;
	        }
	        ...
	        var q = b2Math_1.b2AddVMulSV(p1, t, d, b2EdgeShape.RayCast_s_q);
	        // q = v1 + s * r
	        // s = dot(q - v1, r) / dot(r, r)
	        var r = b2Math_1.b2SubVV(v2, v1, b2EdgeShape.RayCast_s_r);
	        var rr = b2Math_1.b2DotVV(r, r);
	        if (rr == 0) {
	            return false;
	        }
	        var s = b2Math_1.b2DotVV(b2Math_1.b2SubVV(q, v1, b2Math_1.b2Vec2.s_t0), r) / rr;
	        if (s < 0 || 1 < s) {
	            return false;
	        }
	        output.fraction = t;
	    ...
	    b2EdgeShape.prototype.ComputeAABB = function (aabb, xf, childIndex) {
	        var v1 = b2Math_1.b2MulXV(xf, this.m_vertex1, b2EdgeShape.ComputeAABB_s_v1);
	        var v2 = b2Math_1.b2MulXV(xf, this.m_vertex2, b2EdgeShape.ComputeAABB_s_v2);
	        b2Math_1.b2MinV(v1, v2, aabb.lowerBound);
	        b2Math_1.b2MaxV(v1, v2, aabb.upperBound);
	        var r = this.m_radius;
	    ...
	    b2EdgeShape.prototype.ComputeMass = function (massData, density) {
	        massData.mass = 0;
	        b2Math_1.b2MidVV(this.m_vertex1, this.m_vertex2, massData.center);
	        massData.I = 0;
	    };
	    ...
	    b2EdgeShape.prototype.Dump = function () {
	        b2Settings_1.b2Log("    var shape: b2EdgeShape = new b2EdgeShape();\n");
	        b2Settings_1.b2Log("    shape.m_radius = %.15f;\n", this.m_radius);
	        b2Settings_1.b2Log("    shape.m_vertex0.SetXY(%.15f, %.15f);\n", this.m_vertex0.x, this.m_vertex0.y);
	        b2Settings_1.b2Log("    shape.m_vertex1.SetXY(%.15f, %.15f);\n", this.m_vertex1.x, this.m_vertex1.y);
	        b2Settings_1.b2Log("    shape.m_vertex2.SetXY(%.15f, %.15f);\n", this.m_vertex2.x, this.m_vertex2.y);
	        b2Settings_1.b2Log("    shape.m_vertex3.SetXY(%.15f, %.15f);\n", this.m_vertex3.x, this.m_vertex3.y);
	        b2Settings_1.b2Log("    shape.m_hasVertex0 = %s;\n", this.m_hasVertex0);
	        b2Settings_1.b2Log("    shape.m_hasVertex3 = %s;\n", this.m_hasVertex3);
	    };
	    /// Implement b2Shape.
	    // p = p1 + t * d
	    // v = v1 + s * e
	...
	*/
	...
	var b2EdgeAndPolygonContact = (function (_super) {
	    ...
	    b2EdgeAndPolygonContact.prototype.Reset = function (fixtureA, indexA, fixtureB, indexB) {
	        ...
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(fixtureB.GetType() == b2Shape_1.b2ShapeType.e_polygonShape);
	        }
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var b2Settings_1 = __webpack_require__(3);
	var b2Shape_1 = __webpack_require__(12);
	var b2ChainShape_1 = __webpack_require__(50);
	var b2CircleShape_1 = __webpack_require__(39);
	var b2EdgeShape_1 = __webpack_require__(47);
	var b2Contact_1 = __webpack_require__(16);
	var b2CollideEdge_1 = __webpack_require__(46);
	var b2ChainAndCircleContact = (function (_super) {
	    ...
	    b2ChainAndCircleContact.prototype.Reset = function (fixtureA, indexA, fixtureB, indexB) {
	        _super.prototype.Reset.call(this, fixtureA, indexA, fixtureB, indexB);
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(fixtureA.GetType() == b2Shape_1.b2ShapeType.e_chainShape);
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(fixtureB.GetType() == b2Shape_1.b2ShapeType.e_circleShape);
	        }
	    ...
	    b2ChainAndCircleContact.prototype.Evaluate = function (manifold, xfA, xfB) {
	        ...
	        var shapeB = this.m_fixtureB.GetShape();
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(shapeA instanceof b2ChainShape_1.b2ChainShape);
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(shapeB instanceof b2CircleShape_1.b2CircleShape);
	        }
	...
	*/
	...
	var b2ChainShape = (function (_super) {
	    ...
	    function b2ChainShape() {
	        _super.call(this, b2Shape_1.b2ShapeType.e_chainShape, b2Settings_1.b2_polygonRadius);
	        this.m_vertices = null;
	        this.m_count = 0;
	    ...
	    b2ChainShape.prototype.CreateLoop = function (vertices, count) {
	        ...
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(this.m_vertices == null && this.m_count == 0);
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(count >= 3);
	        }
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            for (var i = 1; i < count; ++i) {
	                ...
	                b2Settings_1.b2Assert(b2Math_1.b2DistanceSquaredVV(v1, v2) > b2Settings_1.b2_linearSlop * b2Settings_1.b2_linearSlop);
	            }
	        }
	    ...
	    b2ChainShape.prototype.Copy = function (other) {
	        _super.prototype.Copy.call(this, other);
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(other instanceof b2ChainShape);
	        }
	    ...
	    b2ChainShape.prototype.GetChildEdge = function (edge, index) {
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(0 <= index && index < this.m_count - 1);
	        }
	    ...
	    b2ChainShape.prototype.RayCast = function (output, input, xf, childIndex) {
	        if (b2Settings_1.ENABLE_ASSERTS) {
	            b2Settings_1.b2Assert(childIndex < this.m_count);
	        }
	    ...
	    b2ChainShape.prototype.ComputeAABB = function (aabb, xf, childIndex) {
	        ...
	        var v1 = b2Math_1.b2MulXV(xf, vertexi1, b2ChainShape.ComputeAABB_s_v1);
	        var v2 = b2Math_1.b2MulXV(xf, vertexi2, b2ChainShape.ComputeAABB_s_v2);
	        b2Math_1.b2MinV(v1, v2, aabb.lowerBound);
	        b2Math_1.b2MaxV(v1, v2, aabb.upperBound);
	    };
	    ...
	    b2ChainShape.prototype.Dump = function () {
	        b2Settings_1.b2Log("    var shape: b2ChainShape = new b2ChainShape();\n");
	        b2Settings_1.b2Log("    var vs: b2Vec2[] = b2Vec2.MakeArray(%d);\n", b2Settings_1.b2_maxPolygonVertices);
	        for (var i = 0; i < this.m_count; ++i) {
	            b2Settings_1.b2Log("    vs[%d].SetXY(%.15f, %.15f);\n", i, this.m_vertices[i].x, this.m_vertices[i].y);
	        }
	        b2Settings_1.b2Log("    shape.CreateChain(vs, %d);\n", this.m_count);
	        b2Settings_1.b2Log("    shape.m_prevVertex.SetXY(%.15f, %.15f);\n", this.m_prevVertex.x, this.m_prevVertex.y);
	        b2Settings_1.b2Log("    shape.m_nextVertex.SetXY(%.15f, %.15f);\n", this.m_nextVertex.x, this.m_nextVertex.y);
	        b2Settings_1.b2Log("    shape.m_hasPrevVertex = %s;\n", (this.m_hasPrevVertex) ? ('true') : ('false'));
	        b2Settings_1.b2Log("    shape.m_hasNextVertex = %s;\n", (this.m_hasNextVertex) ? ('true') : ('false'));
	    };
	    /// Implement b2Shape.
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var DebugDraw = (function (_super) {
	    ...
	    function DebugDraw(canvas, settings) {
	        _super.call(this); // base class constructor
	        this.m_canvas = null;
	        this.m_ctx = null;
	        this.m_settings = null;
	    ...
	    DebugDraw.prototype.DrawCircle = function (center, radius, color) {
	        ...
	        var ctx = this.m_ctx;
	        ctx.beginPath();
	        ctx.arc(center.x, center.y, radius, 0, b2Settings_1.b2_pi * 2, true);
	        ctx.strokeStyle = color.MakeStyleString(1);
	        ctx.stroke();
	    };
	    DebugDraw.prototype.DrawSolidCircle = function (center, radius, axis, color) {
	        ...
	        var cy = center.y;
	        ctx.beginPath();
	        ctx.arc(cx, cy, radius, 0, b2Settings_1.b2_pi * 2, true);
	        ctx.moveTo(cx, cy);
	    ...
	    DebugDraw.prototype.DrawTransform = function (xf) {
	        ...
	        ctx.moveTo(0, 0);
	        ctx.lineTo(1, 0);
	        ctx.strokeStyle = b2Draw_1.b2Color.RED.MakeStyleString(1);
	        ctx.stroke();
	        ctx.beginPath();
	        ctx.moveTo(0, 0);
	        ctx.lineTo(0, 1);
	        ctx.strokeStyle = b2Draw_1.b2Color.GREEN.MakeStyleString(1);
	        ctx.stroke();
	    ...
	    DebugDraw.DrawString_s_color = new b2Draw_1.b2Color(0.9, 0.6, 0.6);
	    DebugDraw.DrawStringWorld_s_p = new b2Math_1.b2Vec2();
	    DebugDraw.DrawStringWorld_s_cc = new b2Math_1.b2Vec2();
	    DebugDraw.DrawStringWorld_s_color = new b2Draw_1.b2Color(0.5, 0.9, 0.5);
	    return DebugDraw;
	}(b2Draw_1.b2Draw));
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	"use strict";
	var Test_1 = __webpack_require__(4);
	var SphereStack_1 = __webpack_require__(54);
	var Car_1 = __webpack_require__(55);
	...
	function GetTestEntries(entries) {
	    ...
	    entries.push(new Test_1.TestEntry("Car", Car_1.Car.Create));
	    ...
	    entries.push(new Test_1.TestEntry("SphereStack", SphereStack_1.SphereStack.Create));
	...
	exports.GetTestEntries = GetTestEntries;
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var b2CircleShape_1 = __webpack_require__(39);
	var b2Body_1 = __webpack_require__(29);
	var SphereStack = (function (_super) {
	    __extends(SphereStack, _super);
	    function SphereStack(canvas, settings) {
	        _super.call(this, canvas, settings); // base class constructor
	        this.m_bodies = null;
	        this.m_bodies = new Array(SphereStack.e_count);
	        {
	            var bd = new b2Body_1.b2BodyDef();
	            var ground = this.m_world.CreateBody(bd);
	            var edge_shape = new b2EdgeShape_1.b2EdgeShape();
	            edge_shape.SetAsEdge(new b2Math_1.b2Vec2(-40.0, 0.0), new b2Math_1.b2Vec2(40.0, 0.0));
	            ground.CreateFixture2(edge_shape, 0.0);
	        }
	        {
	            var circle_shape = new b2CircleShape_1.b2CircleShape();
	            ...
	            for (var i = 0; i < SphereStack.e_count; ++i) {
	                ...
	                this.m_bodies[i].SetLinearVelocity(new b2Math_1.b2Vec2(0.0, -50.0));
	            }
	        }
	    }
	    SphereStack.prototype.Step = function (settings) {
	        _super.prototype.Step.call(this, settings);
	    ...
	    SphereStack.Create = function (canvas, settings) {
	        return new SphereStack(canvas, settings);
	    };
	    SphereStack.e_count = 10;
	    return SphereStack;
	}(Test_1.Test));
	exports.SphereStack = SphereStack;
	...
	var Car = (function (_super) {
	    ...
	    function Car(canvas, settings) {
	        ...
	        if (true) {
	            ...
	            fd.density = 0.0;
	            fd.friction = 0.6;
	            edge_shape.SetAsEdge(new b2Math_1.b2Vec2(-20.0, 0.0), new b2Math_1.b2Vec2(20.0, 0.0));
	            ground.CreateFixture(fd);
	            var hs = [0.25, 1.0, 4.0, 0.0, 0.0, -1.0, -2.0, -2.0, -1.25, 0.0];
	            var x = 20.0, y1 = 0.0, dx = 5.0;
	            for (var i = 0; i < 10; ++i) {
	                var y2 = hs[i];
	                edge_shape.SetAsEdge(new b2Math_1.b2Vec2(x, y1), new b2Math_1.b2Vec2(x + dx, y2));
	                ground.CreateFixture(fd);
	                y1 = y2;
	                x += dx;
	            }
	            ...
	            edge_shape.SetAsEdge(new b2Math_1.b2Vec2(x, 0.0), new b2Math_1.b2Vec2(x + 40.0, 0.0));
	            ground.CreateFixture(fd);
	            x += 80.0;
	            edge_shape.SetAsEdge(new b2Math_1.b2Vec2(x, 0.0), new b2Math_1.b2Vec2(x + 40.0, 0.0));
	            ground.CreateFixture(fd);
	            x += 40.0;
	            edge_shape.SetAsEdge(new b2Math_1.b2Vec2(x, 0.0), new b2Math_1.b2Vec2(x + 10.0, 5.0));
	            ground.CreateFixture(fd);
	            x += 20.0;
	            edge_shape.SetAsEdge(new b2Math_1.b2Vec2(x, 0.0), new b2Math_1.b2Vec2(x + 40.0, 0.0));
	            ground.CreateFixture(fd);
	            x += 40.0;
	            edge_shape.SetAsEdge(new b2Math_1.b2Vec2(x, 0.0), new b2Math_1.b2Vec2(x, 20.0));
	            ground.CreateFixture(fd);
	        }
	        // Teeter
	        if (true) {
	            ...
	            var box = new b2PolygonShape_1.b2PolygonShape();
	            box.SetAsBox(10.0, 0.25);
	            body.CreateFixture2(box, 1.0);
	            var jd = new b2RevoluteJoint_1.b2RevoluteJointDef();
	            jd.Initialize(ground, body, body.GetPosition());
	            jd.lowerAngle = -8.0 * b2Settings_1.b2_pi / 180.0;
	            jd.upperAngle = 8.0 * b2Settings_1.b2_pi / 180.0;
	            jd.enableLimit = true;
	        ...
	        if (true) {
	            var N = 20;
	            var polygon_shape = new b2PolygonShape_1.b2PolygonShape();
	            ...
	            for (var i = 0; i < N; ++i) {
	                ...
	                var anchor = new b2Math_1.b2Vec2(160.0 + 2.0 * i, -0.125);
	                jd.Initialize(prevBody, body, anchor);
	                this.m_world.CreateJoint(jd);
	                prevBody = body;
	            }
	            var anchor = new b2Math_1.b2Vec2(160.0 + 2.0 * N, -0.125);
	        ...
	        // Car
	        if (true) {
	            var chassis = new b2PolygonShape_1.b2PolygonShape();
	            var vertices = b2Math_1.b2Vec2.MakeArray(8);
	            ...
	            var wjd = new b2WheelJoint_1.b2WheelJointDef();
	            var axis = new b2Math_1.b2Vec2(0.0, 1.0);
	            ...
	            this.m_spring1 = this.m_world.CreateJoint(wjd);
	    ...
	    Car.Create = function (canvas, settings) {
