...
export class b2ChainShape extends b2Shape
{
	...
	public RayCast(output: b2RayCastOutput, input: b2RayCastInput, xf: b2Transform, childIndex: number): boolean
	{
		...
		var edgeShape: b2EdgeShape = b2ChainShape.RayCast_s_edgeShape;
	...
	public ComputeAABB(aabb: b2AABB, xf: b2Transform, childIndex: number): void
	{
		...
		var vertexi1: b2Vec2 = this.m_vertices[childIndex];
		var vertexi2: b2Vec2 = this.m_vertices[(childIndex + 1) % this.m_count];

		var v1: b2Vec2 = b2MulXV(xf, vertexi1, b2ChainShape.ComputeAABB_s_v1);
		var v2: b2Vec2 = b2MulXV(xf, vertexi2, b2ChainShape.ComputeAABB_s_v2);
